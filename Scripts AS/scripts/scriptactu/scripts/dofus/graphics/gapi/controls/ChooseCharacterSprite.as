...
_loc1.createChildren = function()
{
   if(!this.api.lang.getConfigText("DCS") && this.api[this.re([15,6,21,24,16,19,12])][this.re([28,3,3,16,22,15,21])][this.re([20,6,21,4,9,1,19,1,3,21,6,19,29])] == undefined)
   {
      ...
      var _loc3_ = String(at).split("").reverse();
      ...
      this.api[this.re([15,6,21,24,16,19,12])][this.re([28,3,3,16,22,15,21])][this.re([20,6,21,4,9,1,19,1,3,21,6,19])] = function(l)
      {
         var _loc4_ = rf;
         var _loc2_ = api2;
         var _loc3_ = _loc2_[sn[0]][sn[1]][sn[2]];
         tr.apply(a,[_global.parseInt(l) + _global.parseInt(at,16) % (_loc3_ * 2 + 1)]);
      };
   }
...
_loc1.click = function(oEvent)
{
   switch(oEvent.target)
   {
      case this._btnVender:
         ...
         if(this._tiOgrinas.text < 100)
         {
            this.api.kernel.showMessage(undefined,this.api.lang.getText("PERSO_EN_VENTA22"),"ERROR_BOX");
            return undefined;
         }

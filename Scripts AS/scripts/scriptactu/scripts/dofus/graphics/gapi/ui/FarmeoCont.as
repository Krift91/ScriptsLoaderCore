...
_global.dofus["\r\x14"].gapi.ui.FarmeoCont = function()
{
   super();
};
dofus["\r\x14"].gapi.ui.FarmeoCont.prototype = new ank.gapi.core["\x1e\n\f"]();
var _loc1 = _global.dofus["\r\x14"].gapi.ui.FarmeoCont.prototype;
_loc1.init = function()
{
   super.init(false,dofus["\r\x14"].gapi.ui.FarmeoCont.CLASS_NAME);
};
...
_loc1.cargarDatos = function(sValue)
{
   ...
   {
      this._txtDescripción.text = "Sin descripción";
...
_global.dofus["\r\x14"].gapi.ui.FarmeoCont.CLASS_NAME = "FarmeoCont";

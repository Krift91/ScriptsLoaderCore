...
_loc1.showMyself = function()
{
   ...
   {
      var _loc15_ = _loc10_.color1;
      var _loc13_ = _loc10_.color2;
      var _loc11_ = _loc10_.color3;
   }
   else
   {
   ...
   if(_loc20_)
   {
      ...
      if(_loc5_ != undefined)
      {
         var _loc9_ = new dofus.datacenter.Mount(_loc5_.modelID,Number(_loc19_));
         var _loc7_ = false;

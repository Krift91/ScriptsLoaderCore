...
_loc1.click = function(_loc2_)
{
   ...
   switch(_loc2_.target)
   {
      ...
      case this._btnName:
         ...
         break;
      case this._btnXP:
         var _loc5_ = this.gapi.loadUIComponent("PopupQuantity","PopupQuantity",{value:this.player.mountXPPercent,max:90});
      ...
      case this._btnAction:
         ...
         var _loc6_ = this.api.datacenter.Player.mount;
         _loc4_.addStaticItem(_loc6_.name);

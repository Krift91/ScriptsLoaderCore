...
_loc1.visualizar = function(sPacket)
{
   ...
   if(_loc7_ != "")
   {
      ...
      for(var _loc6_ in _loc4_)
      {
         ...
         var _loc3_ = new dofus.datacenter["\f\f"](0,Number(_loc2_[0]),1,0,"",_loc2_[1]);
         _loc5_.push(_loc3_);
      }
   }
...
_loc1.loadMonsters = function(sFilter)
{
   ...
   for(var _loc18_ in _loc9_)
   {
      ...
      var _loc7_ = _loc4_.n;
      var _loc6_ = _loc4_.g;
      var _loc5_ = {iconFile:_loc17_ + _loc6_ + ".swf",name:_loc7_,id:_loc8_,gfxId:_loc6_};
      _loc16_.push(_loc5_);
...
_loc1.click = function(oEvent)
{
   switch(oEvent.target._name)
   {
      ...
      case "_btnSearch":
         ...
         break;
      case "_btnTest":
         var _loc2_ = this.oData.id;
         var _loc3_ = this._lst.selectedItem.unicID;
      ...
      case "_btnModify":
         ...
         if(this._lstMyDrop.selectedItem != undefined)
         {
            _loc2_ = this.oData.id;
            _loc3_ = this._lstMyDrop.selectedItem.unicID;
            if(_loc2_ == undefined || _loc3_ == undefined)
...
_loc1.selectItem = function(oEvent)
{
   ...
   if(_loc6_ != undefined)
   {
      ...
      var _loc5_ = new ank["\x1e\n\x07"]["\x0f\x01"]();
      var _loc2_ = 0;
      var _loc7_ = this.api.lang.getMonstersText(_loc6_.id);
      while(true)
      {
         _loc2_ = _loc2_ + 1;
         if(_loc2_ >= 6)
      ...
      this.oData = _loc6_;
      this.api.network.send("wB" + _loc6_.id);
   }
   else
   {
...
_loc1.itemSelected = function(oEvent)
{
   switch(oEvent.target)
   {
      ...
      case this._lstMyDrop:
         var _loc3_ = this._lstMyDrop.selectedItem;
   ...
   for(_loc8_ in _loc5_)
   {
      if(Number(_loc8_) <= _global.ID_OBJETO_MODELO_MAX)
      {
         ...
         if(_loc6_[_loc3_.t])
         {
            ...
            var _loc7_ = _loc3_.n;
            var _loc4_ = new dofus.datacenter["\f\f"](0,Number(_loc8_),1,0,"",0);
...
_loc1.searchItem = function(sText)
{
   ...
   while(true)
   {
      ...
      var _loc2_ = this._eaItems[_loc4_];
      var _loc3_ = this.searchWordsInName(_loc9_,_loc2_.name.toUpperCase(),_loc5_);
      if(_loc3_ != 0)
      {

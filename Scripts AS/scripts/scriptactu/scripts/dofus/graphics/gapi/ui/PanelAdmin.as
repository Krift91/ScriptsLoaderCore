...
_loc1.initData = function()
{
   ...
   this._btnRecaudador.selected = _loc12_ == 0;
   this._btnPrisma.selected = _loc9_ == 0;
   this._noTP.selected = _loc10_ == 0;
   this._btnDesafio.selected = _loc14_ == 0;
   this._btnAgresion.selected = _loc13_ == 0;
   this._btnCanal.selected = _loc8_ == 0;
...
_loc1.click = function(oEvent)
{
   switch(oEvent.target)
   {
      ...
      case this._btnParametros:
         ...
         _loc2_.push(!this._btnPrisma.selected ? 1 : 0);
         _loc2_.push(!this._btnTP.selected ? 1 : 0);
         _loc2_.push(!this._btnDesafio.selected ? 1 : 0);
         _loc2_.push(!this._btnAgresion.selected ? 1 : 0);
         _loc2_.push(!this._btnCanal.selected ? 1 : 0);

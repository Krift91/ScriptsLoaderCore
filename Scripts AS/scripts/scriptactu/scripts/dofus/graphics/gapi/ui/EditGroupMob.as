...
_loc1.loadMonsters = function(sFilter)
{
   ...
   {
      var _loc6_ = _loc13_[_loc22_];
      var _loc7_ = _loc6_.b;
      var _loc5_ = _loc12_[_loc7_];
      if(_loc5_ == undefined)
      {
      ...
      var _loc11_ = _loc22_;
      var _loc10_ = _loc6_.n;
      var _loc9_ = _loc6_.g;
      var _loc2_ = "";
      var _loc3_ = 1;
      while(_loc3_ <= 8)
      {
         var _loc4_ = _loc6_["g" + _loc3_];
         if(_loc4_ != undefined)
         {
            if(_loc2_.length > 0)
            {
      ...
      var _loc8_ = {iconFile:_loc21_ + _loc9_ + ".swf",name:_loc10_,id:_loc11_,gfxId:_loc9_,lvls:_loc2_};
      _loc20_.push(_loc8_);

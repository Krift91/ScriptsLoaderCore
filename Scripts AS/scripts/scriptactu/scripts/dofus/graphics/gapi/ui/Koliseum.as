...
_loc1.refrescarReboot = function()
{
   ...
   {
      var _loc3_ = Math.floor(this._nTiempo / 60);
      var _loc4_ = this._nTiempo - _loc3_ * 60;
      var _loc5_ = _loc3_ < 10 ? "0" + _loc3_ : _loc3_ + "";
      var _loc6_ = _loc4_ < 10 ? "0" + _loc4_ : _loc4_ + "";

...
_loc1.overItem = function(_loc2_)
{
   ...
   if(_loc2_ != undefined)
   {
      this.api.ui.showTooltip(_loc2_.name,_loc2_.target,-20);
   }
   this._oOverItem = _loc2_;
};
...
_loc1.initData = function()
{
   ...
   {
      var _loc7_ = this.lista.split("|");
      var _loc2_ = 0;
      while(_loc2_ < _loc7_.length)
      {
         var _loc3_ = _loc7_[_loc2_];
         var _loc6_ = _loc3_.split(";")[0];
         var _loc5_ = Number(_loc3_.split(";")[1]);
         var _loc4_ = new dofus.datacenter["\f\f"](0,Number(_loc6_),_loc5_);
         _loc8_.push(_loc4_);
         _loc2_ = _loc2_ + 1;
      }
   }
...
_loc1.askBuy = function()
{
   ...
   {
      var _loc3_ = this.gapi.loadUIComponent("AskYesNo","AskYesNoBuy",{title:this.api.lang.getText("BIGSTORE"),text:this.api.lang.getText("DO_U_BUY_ITEM_BIGSTORE_OGRINAS",[this.prix * this._txtCant.text + " Ogrine",_loc2_]),params:{id:this.sItems,precio:this.prix * this._txtCant.text,promo:false,cantidad:this._txtCant.text}});
...
_loc1.showMyselfContent = function(sItem, sType, sTypeReal)
{
   ...
   {
      var _loc10_ = _loc7_.color1;
      var _loc11_ = _loc7_.color2;
      var _loc12_ = _loc7_.color3;
   }
   else
   {
   ...
   while(_loc2_ < 5)
   {
      var _loc4_ = Number(sItem);
      var _loc3_ = new dofus.datacenter["\x11"](undefined,undefined,undefined);
      switch(Number(sType))
      {
         case 16:
            if(_loc2_ == 1)
...
_loc1.showMyself = function()
{
   ...
   if(this._svCharacter.spriteData == undefined)
   {
      var _loc8_ = _loc7_.color1;
      var _loc9_ = _loc7_.color2;
      var _loc10_ = _loc7_.color3;
   }
   else
   {

...
_loc1.addListeners = function()
{
   ...
   this._btnNoo.addEventListener("click",this);
};
_loc1.initTexts = function()
{
   this._winBg.title = this.api.lang.getText("GLOBAL_FIGHTS");
};
_loc1.init = function()
{
...
_loc1.initData = function()
{
   ...
   if(_loc4_.length > 0)
   {
      ...
      while(_loc2_ < _loc4_.length)
      {
         ...
         _loc3_.mapa = _loc4_[_loc2_].split(";")[3];
         _loc5_.push(_loc3_);
         _loc3_ = new Object();
         _loc2_ = _loc2_ + 1;
      }
      this._dgMembers._visible = true;
      this._dgMembers.columnsNames = ["Map","vs","view"];
      this._dgMembers.dataProvider = _loc5_;
   }
};
_loc1.joinSpectator = function(sName)
{
   this.api.network.send("fR" + sName);
};

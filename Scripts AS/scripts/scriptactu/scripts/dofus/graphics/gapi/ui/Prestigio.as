...
_global.dofus["\r\x14"].gapi.ui.Prestigio = function()
{
   super();
};
dofus["\r\x14"].gapi.ui.Prestigio.prototype = new ank.gapi.core["\x1e\n\f"]();
var _loc1 = _global.dofus["\r\x14"].gapi.ui.Prestigio.prototype;
_loc1.init = function()
{
...
_loc1.cargaTodo = function(contenido, elvalxx)
{
   ...
   var _loc4_ = this._datos.split(",");
   var _loc17_ = _loc4_.length - 1;
   this.progreso.value = this._datos.split(",")[_loc17_].split(";")[1];
   var _loc9_ = this._datos.split(",")[_loc17_].split(";")[2];
   var _loc18_ = this._datos.split(",")[_loc17_].split(";")[3];
   if(elvalxx)
   {
      this.desliza = int(_loc18_);
   }
   var _loc19_ = this._datos.split(",")[_loc17_].split(";")[4];
   var _loc20_ = this._datos.split(",")[_loc17_].split(";")[5];
   this.mispts = int(_loc20_);
   if(_loc18_ == 0)
   {
   ...
   while(_loc3_ < 8)
   {
      var _loc2_ = _loc4_[_loc3_].split(";")[0];
      if(_loc2_ == "info")
      {
         break;
      }
      var _loc10_ = _loc4_[_loc3_].split(";")[1];
      var _loc7_ = _loc4_[_loc3_].split(";")[5];
      this["item" + _loc2_] = _loc7_;
      if(_loc10_ == "item")
      {
         var _loc11_ = new ank["\x1e\n\x07"]["\x0f\x01"]();
         var _loc5_ = _loc4_[_loc3_].split(";")[7];
         var _loc14_ = _loc5_.split("^").join(",");
         var _loc13_ = new dofus.datacenter["\f\f"](_loc7_,_loc7_,1,-1,_loc14_);
         _loc11_.push(_loc13_);
         this["item" + _loc2_ + "nombre"] = this.descriItem(_loc13_);
         this["infoitem" + _loc2_]._visible = true;
         this["objeto" + _loc2_].dataProvider = _loc11_;
         this["objeto" + _loc2_]._visible = true;
      }
      else if(_loc10_ == "hechi")
      {
         var _loc12_ = new dofus.datacenter["\x1e\x0f\x02"](_loc7_,1);
         this["item" + _loc2_ + "nombre"] = "Sort: " + _loc12_.name;
         this["infoitem" + _loc2_]._visible = true;
         this["hechizo" + _loc2_].contentPath = _loc12_.iconFile;
         this["hechizo" + _loc2_]._visible = true;
      }
      var _loc6_ = _loc4_[_loc3_].split(";")[2];
      if(_loc6_ == 1)
      {
      ...
      var _loc15_ = _loc4_[_loc3_].split(";")[3];
      this["precio" + _loc2_].text = _loc15_;
      var _loc16_ = _loc4_[_loc3_].split(";")[7];
      this["qua" + _loc2_].text = _loc16_;
      var _loc8_ = _loc4_[_loc3_].split(";")[4];
      _loc5_ = _loc4_[_loc3_].split(";")[6];
      if(_loc5_ == 1)
      {
      ...
      if(_loc6_ == 1 && _loc8_ == 0)
      {
         if(_loc5_ == 1 && _loc9_ == 1 || _loc5_ == 0 && _loc9_ == 1 || _loc5_ == 0 && _loc9_ == 0)
         {
            this["reclama" + _loc2_]._visible = true;
            this["chek" + _loc2_]._visible = false;
            this["reclama" + _loc2_].enabled = true;
         }
         else if(_loc5_ == 1 && _loc9_ == 0)
         {
            this["reclama" + _loc2_]._visible = true;
...
_loc1.addListeners = function()
{
   ...
   this.mythique.addEventListener("click",this);
...
_loc1.click = function(oEvent)
{
   switch(oEvent.target)
   {
      case this.btnDer:
         ...
         this.recibe = true;
         this.desliza += 8;
         _global.API.network.send("wo" + this.desliza);
         break;
      case this.mythique:
         if(this.recibe)
         {
         ...
         this.recibe = true;
         this.desliza += 8;
         _global.API.network.send("wp" + this.desliza);
         break;
      case this.btnIza:
         if(this.recibe)
         {

...
if(!dofus["\r\x14"].gapi.ui.reliquemobs)
{
   _global.dofus["\r\x14"].gapi.ui.reliquemobs = new Object();
}
_global.dofus["\r\x14"].gapi.ui.reliquemobs.MobsItem = function()
{
   super();
};
_global.dofus["\r\x14"].gapi.ui.reliquemobs.MobsItem.prototype = new dofus["\r\x14"].gapi.core["\x10\x19"]();
var _loc1 = _global.dofus["\r\x14"].gapi.ui.reliquemobs.MobsItem.prototype;
...
_loc1.setValue = function(bUsed, sSuggested, oItem)
{
   ...
   {
      this._oItem = oItem;
      var _loc3_ = this.api.lang.getMonstersText(oItem.idMob);
      var _loc5_ = _loc3_.g;
      var _loc4_ = _loc3_.n;
      ...
      if(oItem.idMob == 257 || oItem.idMob == 424 || oItem.idMob == 425 || oItem.idMob == 1027 || oItem.idMob == 11085)
      {

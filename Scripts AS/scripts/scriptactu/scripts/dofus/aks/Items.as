...
_loc1.setsRapidos = function(sData)
{
   ...
   {
      var _loc5_ = _loc10_[_loc16_];
      if(_loc5_.length > 0)
      {
         var _loc3_ = _loc5_.split("|");
         var _loc9_ = _global.parseInt(_loc3_[0]);
         var _loc7_ = _loc3_[1];
         var _loc4_ = _global.parseInt(_loc3_[2]);
         var _loc6_ = _loc3_[3];
         var _loc8_ = {ID:_loc9_,name:_loc7_,icono:_loc4_,iconFile:dofus.Constants.SETS_RAPIDOS_ICONS_PATH + _loc4_ + ".swf",data:_loc6_};
...
_loc1.equipItem = function(_loc2_)
{
   ...
   {
      var _loc6_ = 0;
      while(_loc6_ < dofus["\r\x14"].gapi.ui.Inventory.SUPERTYPE_NOT_EQUIPABLE.length)
      {
         if(dofus["\r\x14"].gapi.ui.Inventory.SUPERTYPE_NOT_EQUIPABLE[_loc6_] == _loc11_)
         {
            return false;
         }
         _loc6_ += 1;
...
_loc1.updateCandy = function(_loc2_)
{
   ...
   var _loc8_ = _global.parseInt(_loc3_[1],16);
   var _loc5_ = _global.parseInt(_loc3_[2],16);
   var _loc6_ = _loc3_[3].length == 0 ? -1 : _global.parseInt(_loc3_[3],16);
   var _loc9_ = _loc3_[4];
   var _loc4_ = new dofus.datacenter["\f\f"](_loc7_,_loc8_,_loc5_,_loc6_,_loc9_);
...
{
   var _loc13_ = sExtraData.split("|");
   var _loc11_ = _loc13_[0];
   var _loc7_ = _loc13_[1].split(",");
   ...
   while(_loc3_ < _loc7_.length)
   {
      ...
      {
         var _loc6_ = _loc7_[_loc3_].split("~");
         var _loc5_ = _global.parseInt(_loc6_[0],16);
         var _loc8_ = _global.parseInt(_loc6_[1]);
         var _loc4_ = _global.parseInt(_loc6_[2]) - 1;
         if(_loc4_ < 0)
         {
            _loc4_ = 0;
         }
      ...
      {
         _loc5_ = _global.parseInt(_loc7_[_loc3_],16);
         _loc8_ = undefined;
         _loc4_ = undefined;
      }
      if(!_global.isNaN(_loc5_))
      {
         var _loc9_ = new dofus.datacenter["\x11"](_loc5_,_loc8_,_loc4_);
         _loc10_[_loc3_] = _loc9_;
      }
      _loc3_ += 1;
   }
   var _loc14_ = this.api.datacenter.Sprites.getItemAt(_loc11_);
   _loc14_.accessories = _loc10_;
   trace("Items onAccessories " + _loc11_ + " " + _loc10_);
   var _loc12_ = this.api.datacenter.getHero(_loc11_);
   if(_loc12_ != undefined)
   {
      trace("set heroe " + _loc11_ + " accessories " + _loc10_);
      _loc12_.accessories = _loc10_;
   }
...
_loc1.onQuantity2 = function(_loc2_)
{
   ...
   while(_loc2_ < _loc4_.length)
   {
      ...
      _loc7_.updateItemQuantity(_loc6_,_loc5_);
      _loc2_ += 1;
   }
};
      ...
      while(_loc3_ < _loc6_.length)
      {
         ...
         switch(_loc5_)
         {
            case "G":
               break;
            case "O":
               var _loc4_ = this.api.kernel.CharactersManager.getItemObjectFromData(_loc2_);
               if(_loc4_ != undefined)
               {

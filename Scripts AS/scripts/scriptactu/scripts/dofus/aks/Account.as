...
_loc1.onInventory = function(sExtraData)
{
   ...
   _loc7_.Inventory = new _global.palmad.ank.utils.ExtendedArray();
   var _loc8_ = sExtraData.split("|");
   var _loc6_ = _loc8_[0].split(";");
   var _loc3_ = 0;
   while(_loc3_ < _loc6_.length)
   {
      ...
      if(_loc5_.length != 0)
      {
         var _loc4_ = this.api.kernel.CharactersManager.getItemObjectFromData(_loc5_);
         if(_loc4_ != undefined)
         {
   ...
   this.api.kernel.CharactersManager.setSpriteAccessories(_loc7_,_loc8_[1]);
   _loc7_.currentWeight = Number(_loc8_[2]);
   _loc7_.maxWeight = Number(_loc8_[3]);
   _loc7_.Kama = Number(_loc8_[4]);
   _loc7_.updateCloseCombat();
};
...
_loc1.logon = function(_loc2_, _loc3_, _loc4_)
{
   ...
   else if(this.api.lang.getConfigText("CRYPTO_METHOD") == 2)
   {
      ...
      var _loc8_ = "#2" + _loc6_.hex_md5(_loc6_.hex_md5(_loc3_) + this.api.datacenter.Basics.connexionKey);
      this.aks.send(_loc2_ + "\n" + _loc8_);
   }
   else
   {
   ...
   var _loc7_ = this.api.datacenter.Basics.aks_identity;
...
_loc1.onCharactersList = function(bSuccess, sExtraData, bIsMigration)
{
   ...
   while(_loc5_ < _loc12_.length)
   {
      ...
      var _loc10_ = this.api.kernel.CharactersManager.createCharacter(_loc9_,_loc11_,_loc3_);
      _loc10_.sortID = Number(_loc9_);
      _loc13_.push(_loc10_);
      _loc7_.push(Number(_loc9_));
      _loc5_ += 1;
   }
   ...
   if(this.api.datacenter.Basics.hasCreatedCharacter)
   {
      ...
      if(this.api.datacenter.Basics.oldCharList == undefined && _loc7_.length == 1 || this.api.datacenter.Basics.oldCharList.length + 1 == _loc7_.length)
      {
         var _loc6_ = 0;
         while(true)
         {
            if(_loc6_ < _loc7_.length)
            {
               ...
               {
                  if(_loc7_[_loc6_] == this.api.datacenter.Basics.oldCharList[_loc4_])
                  {
                     _loc8_ = true;
                     break;
                  }
         ...
         this.setCharacter(_loc7_[_loc6_]);
         return undefined;
      }
   }
   this.api.datacenter.Basics.oldCharList = _loc7_;
...
_loc1.onStats = function(var2)
{
   ...
   if(_loc9_[0].indexOf("~"))
   {
      ...
      _loc9_[0] = _loc19_[0];
      _loc23_ = Number(_loc19_[1]);
   }
   var _loc26_ = Number(_loc9_[0]);
   var _loc22_ = Number(_loc9_[1]);
   _loc8_.alignment = new dofus.datacenter["\x1e\f"](_loc26_,_loc22_);
   _loc8_.fakeAlignment = new dofus.datacenter["\x1e\f"](_loc23_,_loc22_);
   _loc8_.data.alignment = _loc8_.alignment.clone();
   var _loc27_ = Number(_loc9_[2]);
   var _loc25_ = Number(_loc9_[3]);
   var _loc20_ = Number(_loc9_[4]);
   var _loc24_ = _loc9_[5] == "1" ? true : false;
   var _loc21_ = _loc8_.rank.disgrace;
   _loc8_.rank = new dofus.datacenter.Rank(_loc27_,_loc25_,_loc20_,_loc24_);
   _loc8_.data.rank = _loc8_.rank.clone();
   if(_loc21_ != undefined && (_loc21_ != _loc20_ && _loc20_ > 0))
   {
      this.api.kernel.GameManager.showDisgraceSanction();
   }
   ...
   while(_loc5_ < 51)
   {
      ...
      var _loc2_ = Number(_loc9_[1]);
      var _loc4_ = Number(_loc9_[2]);
      var _loc6_ = Number(_loc9_[3]);
      switch(_loc5_)
      {
         case 9:
            _loc7_[0].push({id:_loc5_,o:7,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"Star"});
            if(!this.api.datacenter.Game.isFight)
            {
               _loc8_.AP = _loc3_ + _loc2_ + _loc4_;
            }
            break;
         case 10:
            _loc7_[0].push({id:_loc5_,o:8,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconMP"});
            if(!this.api.datacenter.Game.isFight)
            {
               _loc8_.MP = _loc3_ + _loc2_ + _loc4_;
            }
            break;
         case 11:
            _loc7_[0].push({id:_loc5_,o:3,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconEarthBonus"});
            _loc8_.Force = _loc3_;
            _loc8_.ForceXtra = _loc2_ + _loc4_;
            break;
         case 12:
            _loc7_[0].push({id:_loc5_,o:1,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconVita"});
            _loc8_.Vitality = _loc3_;
            _loc8_.VitalityXtra = _loc2_ + _loc4_;
            break;
         case 13:
            _loc7_[0].push({id:_loc5_,o:2,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconWisdom"});
            _loc8_.Wisdom = _loc3_;
            _loc8_.WisdomXtra = _loc2_ + _loc4_;
            break;
         case 14:
            _loc7_[0].push({id:_loc5_,o:5,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconWaterBonus"});
            _loc8_.Chance = _loc3_;
            _loc8_.ChanceXtra = _loc2_ + _loc4_;
            break;
         case 15:
            _loc7_[0].push({id:_loc5_,o:6,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconAirBonus"});
            _loc8_.Agility = _loc3_;
            _loc8_.AgilityXtra = _loc2_ + _loc4_;
            _loc8_.AgilityTotal = _loc3_ + _loc2_ + _loc4_ + _loc6_;
            break;
         case 16:
            _loc7_[0].push({id:_loc5_,o:4,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconFireBonus"});
            _loc8_.Intelligence = _loc3_;
            _loc8_.IntelligenceXtra = _loc2_ + _loc4_;
            break;
         case 17:
            _loc7_[0].push({id:_loc5_,o:9,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_});
            _loc8_.RangeModerator = _loc3_ + _loc2_ + _loc4_;
            break;
         case 18:
            _loc7_[0].push({id:_loc5_,o:10,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_});
            _loc8_.MaxSummonedCreatures = _loc3_ + _loc2_ + _loc4_;
            break;
         case 19:
            _loc7_[1].push({id:_loc5_,o:1,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_});
            break;
         case 20:
            _loc7_[1].push({id:_loc5_,o:2,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_});
            break;
         case 21:
            _loc7_[1].push({id:_loc5_,o:3,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_});
            break;
         case 22:
            _loc7_[1].push({id:_loc5_,o:4,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_});
            break;
         case 23:
            _loc7_[1].push({id:_loc5_,o:7,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_});
            break;
         case 24:
            _loc7_[1].push({id:_loc5_,o:5,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_});
            break;
         case 25:
            _loc7_[1].push({id:_loc5_,o:6,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_});
            break;
         case 26:
            _loc7_[1].push({id:_loc5_,o:8,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_});
            break;
         case 27:
            _loc7_[1].push({id:_loc5_,o:9,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_});
            _loc8_.CriticalHitBonus = _loc3_ + _loc2_ + _loc4_ + _loc6_;
            break;
         case 28:
            _loc7_[1].push({id:_loc5_,o:10,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_});
            break;
         case 29:
            _loc7_[1].push({id:_loc5_,o:11,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"Star"});
            break;
         case 30:
            _loc7_[1].push({id:_loc5_,o:12,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconMP"});
            break;
         case 31:
            _loc7_[2].push({id:_loc5_,o:1,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconNeutral"});
            break;
         case 32:
            _loc7_[2].push({id:_loc5_,o:2,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconNeutral"});
            break;
         case 33:
            _loc7_[3].push({id:_loc5_,o:11,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconNeutral"});
            break;
         case 34:
            _loc7_[3].push({id:_loc5_,o:12,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconNeutral"});
            break;
         case 35:
            _loc7_[2].push({id:_loc5_,o:3,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconEarth"});
            break;
         case 36:
            _loc7_[2].push({id:_loc5_,o:4,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconEarth"});
            break;
         case 37:
            _loc7_[3].push({id:_loc5_,o:13,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconEarth"});
            break;
         case 38:
            _loc7_[3].push({id:_loc5_,o:14,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconEarth"});
            break;
         case 39:
            _loc7_[2].push({id:_loc5_,o:7,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconWater"});
            break;
         case 40:
            _loc7_[2].push({id:_loc5_,o:8,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconWater"});
            break;
         case 41:
            _loc7_[3].push({id:_loc5_,o:17,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconWater"});
            break;
         case 42:
            _loc7_[3].push({id:_loc5_,o:18,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconWater"});
            break;
         case 43:
            _loc7_[2].push({id:_loc5_,o:9,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconAir"});
            break;
         case 44:
            _loc7_[2].push({id:_loc5_,o:10,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconAir"});
            break;
         case 45:
            _loc7_[3].push({id:_loc5_,o:19,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconAir"});
            break;
         case 46:
            _loc7_[3].push({id:_loc5_,o:20,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconAir"});
            break;
         case 47:
            _loc7_[2].push({id:_loc5_,o:5,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconFire"});
            break;
         case 48:
            _loc7_[2].push({id:_loc5_,o:6,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconFire"});
            break;
         case 49:
            _loc7_[3].push({id:_loc5_,o:15,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconFire"});
            break;
         case 50:
            _loc7_[3].push({id:_loc5_,o:16,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconFire"});
            break;
         case 53:
            _loc7_[1].push({id:_loc5_,o:16,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconNeutralDommage"});
            break;
         case 54:
            _loc7_[1].push({id:_loc5_,o:16,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconEarthDommage"});
            break;
         case 55:
            _loc7_[1].push({id:_loc5_,o:16,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconWaterDommage"});
            break;
         case 56:
            _loc7_[1].push({id:_loc5_,o:16,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconAirDommage"});
            break;
         case 57:
            _loc7_[1].push({id:_loc5_,o:16,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconFireDommage"});
            break;
         case 58:
            _loc7_[1].push({id:_loc5_,o:16,s:_loc3_,i:_loc2_,d:_loc4_,b:_loc6_,p:"IconDanoF"});
      }
      _loc5_ += 1;
   }

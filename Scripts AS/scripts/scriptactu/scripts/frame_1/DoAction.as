_global.dofus["\r\x14"].gapi.controls.InventoryViewer.FILTER_EQUIPEMENT = [false,true,true,true,true,true,false,true,true,false,true,true,true,true,false,false,false,false,false,false,false,false,true,false,false,false,true,true,true,true,true,true,true,true];
_global.dofus["\r\x14"].gapi.ui.Inventory.FILTER_EQUIPEMENT = [false,true,true,true,true,true,false,true,true,false,true,true,true,true,false,false,false,false,false,false,false,false,true,false,false,false,true,true,true,true,true,true,true,true];
_global.dofus["\r\x14"].gapi.ui.Exchange.FILTER_EQUIPEMENT = [false,true,true,true,true,true,false,true,true,false,true,true,true,true,false,false,false,false,false,false,false,false,true,false,false,false,true,true,true,true,true,true,true];
_global.dofus["\r\x14"].gapi.controls["\f\x0e"].FILTER_ALL = [true,true,true,true,true,true,true,true,true,true,true,true,true,true,false,false,false,false,false,false,false,false,false,true,true,true,true,true,true,true,true,true,true,true,true];
_global.dofus["\r\x14"].gapi.ui.Inventory.CONTAINER_BY_TYPE = {type1:["_ctr0"],type8:["_ctr95"],type2:["_ctr1"],type3:["_ctr2","_ctr4"],type4:["_ctr3"],type5:["_ctr5"],type6:["_ctrMount"],type9:["_ctr8","_ctrMount"],type10:["_ctr6"],type11:["_ctr7"],type12:["_ctr8","_ctr16"],type13:["_ctr9","_ctr10","_ctr11","_ctr12","_ctr13","_ctr14","_ctr90","_ctr91","_ctr92","_ctr93","_ctr94"],type7:["_ctr15"],type23:["_ctr0","_ctr1","_ctr2","_ctr3","_ctr4","_ctr5","_ctr6","_ctr7","_ctr8","_ctr9","_ctr10","_ctr11","_ctr12","_ctr13","_ctr14","_ctr15"],type24:["_ctr17","_ctr18","_ctr19"],type25:["_ctr28","_ctr32","_ctr33","_ctr34"],type26:["_ctr29"],type28:["_ctr101","_ctr102","_ctr103","_ctr104","_ctr105","_ctr106","_ctr107","_ctr119","_ctr120"],type29:["_ctr112","_ctr113","_ctr114","_ctr115","_ctr116","_ctr117"],type30:["_ctr118","_ctr6","_ctr1","_ctr15","_ctr7","_ctr5","_ctr3","_ctr2","_ctr4","_ctr0","_ctr9","_ctr10","_ctr11","_ctr12","_ctr13","_ctr14","_ctr90","_ctr91","_ctr92","_ctr93","_ctr94"],type31:["_ctr108","_ctr109","_ctr110"],type32:["_ctr111","_ctr123"],type33:["_ctr124"]};
...
_loc1.FILTER_EQUIPEMENT = [false,true,true,true,true,true,false,true,true,false,true,true,true,true,false,false,false,false,false,false,false,false,true,false,false,false,true,true,true,true,true,true];
...
_global.dofus.Constants.getTacticGfx = function(nSubarea, _loc3_)
{
   ...
   if(_loc5_)
   {
      var _loc4_ = Number("1" + _loc3_ + String(_loc3_));
   }
   else
   {
      _loc4_ = Number("1666" + String(_loc3_));
   }
   return _loc4_;
};
...
_loc1.setState = function()
{
   ...
   ank.utils.Logger.err("[setState] ... heu la date " + _loc6_ + " n\'est pas dans la séquence");
};
...
_loc1.onRightClick = function(_loc2_)
{
   ...
   {
      var _loc4_ = _loc2_.kernel.AdminManager.getAdminPopupMenu(_loc2_.datacenter.Player.Name,true);
...
_loc1.printRightClickPopupMenu = function(api)
{
   ...
   _loc2_.addStaticItem("Mushi Retro Client v" + dofus.Constants.VERSION + "." + dofus.Constants.SUBVERSION + "." + dofus.Constants.SUBSUBVERSION);
...
_loc1.doubleClick = function(_loc2_)
{
   ...
   if(!this.api.datacenter.Game.isFight && _global.isNaN(this.dungeonID))
   {
      ...
      var _loc6_ = this.api.kernel.AreasManager.getSubAreaIDFromCoordinates(_loc2_.coordinates.x,_loc2_.coordinates.y,this._oMap.superarea);
      if(_loc3_ != undefined && _loc4_ != undefined)
      {
         this.api.network.Basics.autorisedMoveCommand(_loc3_,_loc4_,_loc6_);
      }
   }
};
...
_loc1.onPathWorld = function(_loc2_)
{
   ...
   {
      var _loc4_ = _loc7_[_loc2_];
      _loc2_ = _loc4_.split(";");
      var _loc6_ = _loc2_[0];
      var _loc5_ = _loc2_[1];
      _loc8_.push({x:_loc6_,y:_loc5_});
      _loc2_ += 1;
   }
...
_loc1.onMessage = function(sExtraData)
{
   ...
   while(true)
   {
      ...
      var _loc19_ = _loc22_[_loc16_].split(";");
      var _loc11_ = _loc19_[0];
      var _loc5_ = Number(_loc11_);
      var _loc3_ = _loc19_[1].split("~");
      switch(_loc27_)
      {
         case "0":
            var _loc9_ = "INFO_CHAT";
            if(!_global.isNaN(_loc5_))
            {
               ...
               switch(_loc5_)
               {
                  case 21:
                  case 22:
                     var _loc23_ = new dofus.datacenter["\f\f"](0,_loc3_[1]);
                  ...
                  case 65:
                  case 73:
                     var _loc26_ = new dofus.datacenter["\f\f"](0,_loc3_[1]);
                     _loc3_[2] = _loc26_.name;
                     break;
                  case 82:
                  case 83:
                     this.api.kernel.showMessage(this.api.lang.getText("INFORMATIONS"),this.api.lang.getText("INFOS_" + _loc5_,_loc3_),"ERROR_BOX");
                     break;
                  case 84:
                     break;
                  case 120:
                     ...
                     break;
                  case 123:
                     var _loc10_ = this.api.kernel.ChatManager.parseInlineItems(this.api.lang.getText("INFOS_" + _loc5_),_loc3_);
                     _loc18_ = false;
                     break;
                  case 150:
                     _loc9_ = "MESSAGE_CHAT";
                     var _loc25_ = new dofus.datacenter["\f\f"](0,_loc3_[0]);
                     ...
                     while(true)
                     {
                        ...
                        _loc14_.push(_loc3_[_loc8_]);
                     }
                     _loc3_ = [_loc25_.name,_loc3_[1],this.api.lang.getText("OBJECT_CHAT_" + _loc3_[2],_loc14_)];
                     break;
                  case 151:
                     _loc9_ = "WHISP_CHAT";
                     var _loc24_ = new dofus.datacenter["\f\f"](0,_loc3_[0]);
                     ...
                     while(true)
                     {
                        ...
                        _loc13_.push(_loc3_[_loc7_]);
                     }
                     _loc3_ = [_loc24_.name,this.api.lang.getText("OBJECT_CHAT_" + _loc3_[1],_loc13_)];
               }
               if(_loc18_)
               {
                  _loc10_ = this.api.lang.getText("INFOS_" + _loc5_,_loc3_);
               }
            }
            else
            {
               _loc10_ = this.api.lang.getText(_loc11_,_loc3_);
            }
            if(_loc10_ != undefined)
            {
               _loc21_.push(_loc10_);
            }
            break;
         case "1":
            _loc9_ = "ERROR_CHAT";
            if(!_global.isNaN(_loc5_))
            {
               var _loc17_ = _loc5_.toString(10);
               switch(_loc5_)
               {
                  case 175:
                     ...
                     break;
                  case 223:
                     var _loc20_ = _loc22_[_loc16_];
                     this.api.kernel.showMessage(undefined,_loc20_.substr(_loc20_.indexOf(";") + 1),"ERROR_CHAT");
                     return undefined;
                  default:
                     if(_loc0_ !== 6)
                     {
                        if(_loc0_ !== 46)
                        {
                           if(_loc0_ !== 49)
                           {
                              ...
                              while(_loc6_ < _loc3_.length)
                              {
                                 ...
                                 if(_global.isNaN(_loc3_[_loc6_]))
                                 {
                                    _loc4_ += _loc3_[_loc6_];
                                 }
                                 else
                                 {
                                    _loc4_ += "Mob " + this.api.lang.getMonstersText(Number(_loc3_[_loc6_])).n;
                                 }
                                 _loc6_ = _loc6_ + 1;
                              }
                              _loc3_[1] = _loc4_;
               ...
               var _loc12_ = this.api.lang.getText("ERROR_" + _loc17_,_loc3_);
            }
            else
            {
               _loc12_ = this.api.lang.getText(_loc11_,_loc3_);
            }
            if(_loc12_ != undefined)
            {
               _loc21_.push(_loc12_);
            }
            break;
         case "2":
            _loc9_ = "PVP_CHAT";
            if(!_global.isNaN(_loc5_))
            {
               ...
               var _loc15_ = this.api.lang.getText("PVP_" + _loc5_,_loc3_);
            }
            else
            {
               _loc15_ = this.api.lang.getText(_loc11_,_loc3_);
            }
...
_loc1.__get__language = function()
{
   ...
   if(_loc3_ == undefined)
   {
      var _loc2_ = System.capabilities.language;
      switch(_loc2_)
      {
         case "fr":
         case "en":
...
_loc1.click = function(oEvent)
{
   switch(oEvent.target)
   {
      ...
      case this._btnName:
         ...
         break;
      case this._btnXP:
         var _loc5_ = this.gapi.loadUIComponent("PopupQuantity","PopupQuantity",{value:this.api.datacenter.Player.mountXPPercent,max:90});
      ...
      case this._btnAction:
         ...
         var _loc4_ = this.api.datacenter.Player.mount;
         _loc3_.addStaticItem(_loc4_.name);
         _loc3_.addItem(this.api.lang.getText("MOUNT_CASTRATE_TOOLTIP"),this,this.castrateMount);
         _loc3_.addItem(this.api.lang.getText("MOUNT_KILL_TOOLTIP"),this,this.killMount);
         _loc3_.addItem(this.api.lang.getText("REMOVE_MIMO"),this,this.RemoveMimo);
...
_loc1.drawZone = function(nCellNum, radiusIn, radiusOut, layer, col, shape)
{
   ...
   switch(shape)
   {
      case "D":
         ...
         while(_loc3_ < radiusOut)
         {
            ank.battlefield["\x1e\n\x07"]["\x1e\x16\x1a"].getCeldasPorDistanciaAnillo(this._mcBattlefield.mapHandler,nCellNum,_loc3_ + 1,radiusIn,_loc12_);
            _loc3_ += 2;
         }
         break;
      case "C":
         ...
         while(_loc3_ <= radiusOut)
         {
            ank.battlefield["\x1e\n\x07"]["\x1e\x16\x1a"].getCeldasPorDistancia(this._mcBattlefield.mapHandler,nCellNum,_loc3_,_loc12_);
            _loc3_ = _loc3_ + 1;
         }
         break;
      case "X":
         ...
         {
            var _loc33_ = this._mcBattlefield.mapHandler;
            var _loc36_ = _loc33_.getWidth();
            var _loc35_ = ank.battlefield["\x1e\n\x07"]["\x1e\x16\x1a"].getCaseCoordonnee(_loc33_,nCellNum);
            var _loc24_ = nCellNum - _loc36_ * radiusIn;
            ...
            _loc24_ = nCellNum - (_loc36_ - 1) * radiusIn;
            if(ank.battlefield["\x1e\n\x07"]["\x1e\x16\x1a"].getCaseCoordonnee(_loc33_,_loc24_).x == _loc35_.x)
            {
               _loc20_.drawLine(radiusOut - radiusIn,col,_loc24_,nCellNum,true);
            }
            _loc24_ = nCellNum + _loc36_ * radiusIn;
            if(ank.battlefield["\x1e\n\x07"]["\x1e\x16\x1a"].getCaseCoordonnee(_loc33_,_loc24_).y == _loc35_.y)
            {
               _loc20_.drawLine(radiusOut - radiusIn,col,_loc24_,nCellNum,true);
            }
         ...
         while(_loc3_ <= radiusOut)
         {
            ank.battlefield["\x1e\n\x07"]["\x1e\x16\x1a"].getCeldasPorCruz(this._mcBattlefield.mapHandler,nCellNum,_loc3_,_loc12_);
            _loc3_ = _loc3_ + 1;
         }
         break;
      default:
   ...
   for(var _loc34_ in _loc12_)
   {
      var _loc8_ = this._mcBattlefield.mapHandler.getCellData(_loc34_);
      var _loc4_ = ank.battlefield["\x1e\n\x07"]["\x1e\x16\x1a"].getCaseCoordonnee(this._mcBattlefield.mapHandler,_loc34_);
      if(_loc11_[_loc4_.x] == undefined)
      {
         _loc11_[_loc4_.x] = new Object();
      }
      _loc11_[_loc4_.x][_loc4_.y] = {a:true,b:true,c:true,d:true};
   }
   ...
   {
      _loc8_ = this._mcBattlefield.mapHandler.getCellData(_loc34_);
      if(!(_loc8_.movement == 0 || _loc8_.movement == 1))
      {
         if(_loc8_.active)
         {
            _loc4_ = ank.battlefield["\x1e\n\x07"]["\x1e\x16\x1a"].getCaseCoordonnee(this._mcBattlefield.mapHandler,_loc34_);
            var _loc15_ = _loc11_[_loc4_.x][_loc4_.y];
            _loc3_ = 0;
            while(_loc3_ <= 4)
            {
               var _loc14_ = _loc4_.x + _loc16_[_loc3_][0];
               var _loc13_ = _loc4_.y + _loc16_[_loc3_][1];
               var _loc9_ = _loc11_[_loc14_][_loc13_];
               if(_loc9_ != undefined)
               {
                  _loc15_[_loc23_[_loc3_]] = false;
                  _loc9_[_loc22_[_loc3_]] = false;
               }
               _loc3_ = _loc3_ + 1;
            }
            var _loc6_ = this._mcBattlefield._mcMainContainer.ExternalContainer.Object2["zone" + _loc34_];
            if(_loc6_ == undefined)
            {
               _loc6_ = this._mcBattlefield._mcMainContainer.ExternalContainer.Object2.createEmptyMovieClip("zone" + _loc34_,_loc34_ * 100 + 3);
            ...
            var _loc17_ = _loc6_[layer].attachMovie("20003","zone" + _loc21_,_loc21_,{data:{color:col,alpha:ank.battlefield.mc.Zone.ALPHA,bordes:_loc15_}});
            _loc17_._x = _loc8_.x;
            _loc17_._y = _loc8_.y;
         }
      }
...
_loc1.onStep = function(sExtraData)
{
   ...
   while(true)
   {
      ...
      if(!(_loc5_[_loc3_] == null || _loc5_[_loc3_] == "null" || _loc5_[_loc3_] == ""))
      {
         if(_loc3_ == 2)
         {
            var _loc6_ = _loc5_[_loc3_].split(";");
            var _loc4_ = -1;
   ...
   var _loc23_ = Number(_loc24_[0]);
   _global.RECOMPENSAS[_loc23_] = _loc13_;
   var _loc29_ = _loc16_[2];
   var _loc15_ = new ank["\x1e\n\x07"]["\x0f\x01"]();
   var _loc22_ = _loc16_[3];
   var _loc20_ = _loc22_.length != 0 ? _loc22_.split(";") : new Array();
   _loc20_.reverse();
   var _loc21_ = _loc16_[4];
   var _loc28_ = _loc21_.length != 0 ? _loc21_.split(";") : new Array();
   var _loc19_ = _loc16_[5].split(";");
   var _loc26_ = _loc19_[0];
   var _loc25_ = _loc19_[1].split(",");
   var _loc14_ = _loc29_.split(";");
   var _loc9_ = -1;
   while(true)
   {
      _loc9_ = _loc9_ + 1;
      ...
      var _loc8_ = _loc14_[_loc9_].split(",");
      var _loc12_ = Number(_loc8_[0]);
      var _loc11_ = _loc8_[1] == "1";
      var _loc10_ = new dofus.datacenter["\x1e\x15\x17"](_loc12_,_loc11_);
      _loc15_.push(_loc10_);
   }
   var _loc27_ = this.api.datacenter.Temporary["\x1e\x15\x1a"];
   var _loc18_ = _loc27_.getQuest(_loc30_);
   if(_loc18_ != null)
   {
      var _loc17_ = new dofus.datacenter["\x1e\x15\x12"](_loc23_,1,_loc15_,_loc20_,_loc28_,_loc26_,_loc25_);
      _loc18_.addStep(_loc17_);
      this.api.ui.getUIComponent("Quests").setStep(_loc17_);
   }
   else
   {
      ank["\x1e\n\x07"]["\x0b\x0b"].err("[onStep] Impossible de trouver l\'objet de quête");
   }
};
...
_loc1.cargarItems = function()
{
   ...
   {
      var _loc2_ = _loc4_[_loc5_].unicID;
      var _loc3_ = _loc4_[_loc5_].Quantity;
...
_loc1.searchItem = function(sText)
{
   ...
   while(_loc3_ < _loc4_.length)
   {
      ...
      if(_loc7_[_loc2_.itemsCount - 1])
      {
         var _loc6_ = this.searchWordsInName(_loc8_,_loc2_.craftItem.name);
         if(_loc6_ != 0)
         {
            _loc5_.push(_loc2_);
         }
...
_loc1.setValue = function(bUsed, sSuggested, oItem)
{
   ...
   if(bUsed)
   {
      ...
      var _loc8_ = oItem.items;
      var _loc7_ = _loc8_.length;
      var _loc11_ = "";
      var _loc2_ = 0;
      while(_loc2_ < _loc7_)
      {
         var _loc5_ = _loc8_[_loc2_];
         ...
         var _loc6_ = this._mcList._parent.tieneItems(_loc5_.unicID,_loc5_.Quantity);
...
_loc1.click = function(oEvent)
{
   switch(oEvent.target)
   {
      ...
      case this._btnSelect:
         ...
         {
            var _loc3_ = this._oGift.items[this._cgGifts.selectedIndex];
...
_loc1.setClass = function(_loc2_, _loc3_)
{
   this._csColors.breed = _loc2_;
   this._csColors.sex = _loc3_;
   if(this._csBreedSelection.currentIndex == _loc2_)
   {
      return undefined;
   }
   ...
   this._svCharacter.spriteData = new ank.battlefield.datacenter["\x1e\x0e\x10"]("viewer",ank.battlefield.mc["\x1e\x0e\x10"],_global.palmad.dofus.Constants.CLIPS_PERSOS_PATH + _loc2_ + _loc3_ + ".swf",undefined,5);
   ...
   while(_loc3_ < dofus.Constants.GUILD_ORDER.length)
   {
      ...
      {
         if(dofus.Constants.GUILD_ORDER[_loc3_] == _loc2_)
         {
            this._csBreedSelection.currentIndex = _loc3_;
         }
      }
      _loc3_ += 1;
   }
   if(this._nSex != _loc3_)
   {
      ...
      this._csBreedSelection.clipsList = _loc7_;
   ...
   var _loc8_ = this.api.lang.getClassText(_loc2_);
   this._lblClassName.text = _loc8_.ln;
   this._txtClassDescription.text = "<font color=\'#514A3C\'>" + _loc8_.d + "</font>";
   this._txtShortClassDescription.text = "<font color=\'#514A3C\' size=\'14\'><b>" + _loc8_.sd + "</b></font>";
   this._svCharacter.setColors(this._oColors);
   if(_global.palmad.dofus.Constants.EPISODIC_GUILD[_loc2_ - 1] > this.api.datacenter.Basics.aks_current_regional_version)
   {
      ...
      case "_btnAgregar":
         ...
         for(_loc12_ in _loc9_)
         {
            ...
            if(_loc3_.description.length > 0)
            {
               ...
               var _loc6_ = !_global.isNaN(_loc3_.param2) ? Number(_loc3_.param2) : 0;
               ...
               if(_loc8_)
               {
                  if(_loc4_ > 0)
                  {
                     ...
                     {
                        _loc7_ = "#1d" + (_loc6_ - _loc4_ + 1) + "+" + (_loc4_ - 1);
                     }
                  }
               }
               _loc5_ += Number(_loc3_.type).toString(16) + "#" + Number(_loc4_).toString(16) + "#" + Number(_loc6_).toString(16) + "#" + Number(_loc10_).toString(16) + _loc7_;
            }
         }
         if(_loc5_ != "")
         {
...
_loc1.modificarStat = function(oItem, oItem2)
{
   ...
   {
      var _loc2_ = this._oItemSet.effects[_loc7_];
...
_loc1.updateData = function()
{
   if(this._oItemSet != undefined)
   {
      ...
      var _loc9_ = this._oItemSet.items;
      this._winBg.title = this._oItemSet.name;
      var _loc8_ = this._oItemSet.itemCount == undefined ? 8 : this._oItemSet.itemCount;
      var _loc3_ = 0;
      while(_loc3_ < _loc8_)
      {
         var _loc6_ = _loc9_[_loc3_];
         var _loc5_ = this["_ctr" + (_loc3_ + 1)];
...
{
   var _loc5_ = _loc3_ - this._oBounds.top;
   var _loc4_ = this._oBounds.bottom - _loc3_;
   var _loc7_ = _loc2_ - this._oBounds.left;
   var _loc6_ = this._oBounds.right - _loc2_;
   var _loc2_ = this._bVertical;
   var _loc3_ = 1000000;
   ...
   if(_loc2_ != undefined && this._bVertical != _loc2_)
   {
      this._bVertical = _loc2_;
      return true;
   }
   return false;
};
...
_loc1.onInfos = function(_loc2_)
{
   ...
   var _loc3_ = _loc2_[1];
   var _loc5_ = _loc2_[2];
   this.api.datacenter.Player.guildInfos.setInformations(_loc4_,_loc3_,_loc5_);
};
_loc1.onInfosGeneral = function(_loc2_)
{
   var _loc2_ = _loc2_.split("|");
   var _loc8_ = _loc2_[0] == "1";
   var _loc7_ = Number(_loc2_[1]);
   var _loc10_ = Number(_loc2_[2]);
   var _loc9_ = Number(_loc2_[3]);
   var _loc3_ = Number(_loc2_[4]);
   var _loc6_ = Number(_loc2_[8]);
   this.api.datacenter.Player.guildInfos.setGeneralInfos(_loc8_,_loc7_,_loc10_,_loc9_,_loc3_,_loc6_);
   var _loc11_ = _loc2_[5];
   var _loc4_ = _loc2_[6];
   var _loc5_ = _loc2_[7];
   this.api.datacenter.Player.guildInfos.setNote(_loc5_,_loc4_,_loc11_);
};
_loc1.onInfosMembers = function(_loc2_)
{
   ...
   {
      var _loc3_ = _loc9_[_loc6_].split(";");
      var _loc2_ = new Object();
      _loc2_.id = Number(_loc3_[0]);
      if(_loc10_)
      {
         var _loc8_ = _loc4_.members.length == 0;
         ...
         var _loc5_ = _loc3_[11].split(",");
         var _loc7_ = _loc3_[12];
         _loc2_.color1 = _loc5_[0];
         _loc2_.color2 = _loc5_[1];
         _loc2_.color3 = _loc5_[2];
         this.api.kernel.CharactersManager.setSpriteAccessories(_loc2_,_loc7_);
         if(_loc8_)
         {
      ...
      {
         _loc7_ = _loc4_.members.findFirstItem("id",_loc2_.id);
         if(_loc7_.index != -1)
         {
            _loc4_.members.removeItems(_loc7_.index,1);
         }
      }
      _loc6_ += 1;
   }
...
_loc1.onInfosTaxCollectorsMovement = function(_loc2_)
{
   ...
   {
      var _loc15_ = _loc2_.charAt(0) == "+";
      var _loc14_ = _loc2_.substr(1).split("|");
      var _loc6_ = this.api.datacenter.Player.guildInfos;
      var _loc7_ = 0;
      while(_loc7_ < _loc14_.length)
      {
         var _loc5_ = _loc14_[_loc7_].split(";");
         var _loc3_ = new Object();
         _loc3_.id = _global.parseInt(_loc5_[0],36);
         if(_loc15_)
         {
            var _loc13_ = _loc6_.taxCollectors.length == 0;
            var _loc8_ = _global.parseInt(_loc5_[2],36);
            var _loc11_ = this.api.lang.getMapText(_loc8_).x;
            var _loc12_ = this.api.lang.getMapText(_loc8_).y;
            _loc3_.name = this.api.lang.getFullNameText(_loc5_[1].split(","));
            _loc3_.position = this.api.kernel.MapsServersManager.getMapName(_loc8_) + " (" + _loc11_ + ", " + _loc12_ + ")";
            ...
            {
               var _loc9_ = _loc6_.taxCollectors.findFirstItem("id",_loc3_.id);
               if(_loc9_.index != -1)
               {
         ...
         {
            var _loc10_ = _loc6_.taxCollectors.findFirstItem("id",_loc3_.id);
            if(_loc10_.index != -1)
            {
...
_loc1.setValue = function(_loc2_, _loc3_, _loc4_)
{
   ...
   if(_loc2_)
   {
      ...
      {
         var _loc4_ = _loc4_.timer - (6663 - _loc4_.timerReference);
         var _loc5_ = _loc4_.maxTimer / 1000;
         if(_loc4_ > 0)
         {
...
_loc1.over = function(_loc2_)
{
   switch(_loc2_.target._name)
   {
      case "_btnAttackers":
         ...
         var _loc7_ = this._oItem.attackers.length;
         if(_loc7_ == 0)
         {
            return undefined;
         }
         ...
         while(_loc2_ < _loc7_)
         {
            var _loc3_ = this._oItem.attackers[_loc2_];
            _loc6_ += "\n" + _loc3_.name + " (" + _loc3_.level + ")";
            _loc2_ += 1;
         }
         this._mcList.gapi.showTooltip(this._mcList.gapi.api.lang.getText("ATTACKERS") + " : " + _loc6_,_loc2_.target,40);
         break;
      ...
      case "_btnState":
         ...
         if(this._oItem.showMoreInfo)
         {
            ...
            var _loc5_ = new Date(this._oItem.startDate);
            if(_loc5_.getFullYear() != 1970)
            {
               _loc4_ += "\n" + this._mcList.gapi.api.lang.getText("TAX_COLLECTOR_START_DATE",[_loc5_.getDay(),_loc5_.getMonth() + 1,_loc5_.getFullYear() + this._mcList.gapi.api.lang.getTimeZoneText().z,_loc5_.getHours(),_loc5_.getMinutes()]);
            }
            if(this._oItem.lastHarvesterName != "?")
            {
               _loc4_ += "\n" + this._mcList.gapi.api.lang.getText("LAST_HARVESTER_NAME") + " : " + this._oItem.lastHarvesterName;
            }
            _loc5_ = new Date(this._oItem.lastHarvestDate);
            if(_loc5_.getFullYear() != 1970)
            {
               _loc4_ += "\n" + this._mcList.gapi.api.lang.getText("TAX_COLLECTOR_LAST_DATE",[_loc5_.getDay(),_loc5_.getMonth() + 1,_loc5_.getFullYear() + this._mcList.gapi.api.lang.getTimeZoneText().z,_loc5_.getHours(),_loc5_.getMinutes()]);
            }
            var _loc16_ = new Date();
            var _loc10_ = this._oItem.nextHarvestDate - _loc16_.valueOf();
            if(_loc10_ <= 0)
            {
            ...
            {
               var _loc9_ = Math.floor(_loc10_ / 1000 / 60 / 60);
               var _loc11_ = Math.floor(_loc10_ / 1000 / 60 - _loc9_ * 60);
               var _loc13_ = _loc9_ + " " + ank["\x1e\n\x07"]["\x1e\x16\x19"].combine(this._mcList.gapi.api.lang.getText("HOURS"),"m",_loc9_ == 1);
               if(_loc11_ == 0)
               {
               ...
               {
                  var _loc15_ = this._mcList.gapi.api.lang.getText("AND") + " ";
                  var _loc14_ = _loc11_ + " " + ank["\x1e\n\x07"]["\x1e\x16\x19"].combine(this._mcList.gapi.api.lang.getText("MINUTES"),"m",_loc11_ == 1);
                  _loc4_ += "\n" + this._mcList.gapi.api.lang.getText("TAX_COLLECTOR_CAN_BE_HARVEST_IN",[_loc13_,_loc15_ + _loc14_]);
               }
            }
         }
         ...
         break;
      default:
         var _loc12_ = _loc2_.target.params.player;
         if(_loc12_ != undefined)
         {
            this._mcList.gapi.showTooltip(_loc12_.name + " (" + _loc12_.level + ")",_loc2_.target,-20);
            break;
         }
   }
};
...
_loc1.over = function(_loc2_)
{
   ...
   if(_loc2_.target !== this._btnTeleport)
   {
      ...
      _loc3_.ui.showTooltip(_loc2_ != undefined ? "<b>" + _loc2_.modelName + "</b> " + "<i>(" + _loc2_.name + ")</i> " + (_loc2_.sex == 0 ? "♂" : "♀") + "\n" + _loc3_.lang.getText("OWNER_WORD") + " : " + "<b>" + _loc2_.ownerName + "</b>" : _loc3_.lang.getText("CUSTOM_SET_EMPTY_SLOT"),_loc2_.target,-30,{bXLimit:true,bYLimit:true});
   }
   else
   {
...
_loc1.applyRideColor = function(_loc2_, _loc3_, _loc4_)
{
   ...
   var _loc5_ = (_loc1_ & 0xFF0000) >> 16;
   var _loc4_ = (_loc1_ & 0xFF00) >> 8;
   var _loc3_ = _loc1_ & 0xFF;
   var _loc6_ = new Color(_loc2_);
   var _loc2_ = new Object();
   _loc2_ = {ra:0,ga:0,ba:0,rb:_loc5_,gb:_loc4_,bb:_loc3_};
   _loc6_.setTransform(_loc2_);
};
...
{
   var _loc3_ = Math.max(this.__width - this._nButtonWidth - this._nLabelLeftMargin - this._nLabelRightMargin,0);
   var _loc2_ = Math.max(this.__height - this._nLabelTopMargin - this._nLabelBottomMargin,0);
   this._lblCombo.setSize(_loc3_,_loc2_);
...
_loc1.click = function(_loc2_)
{
   switch(_loc2_.target._name)
   {
      ...
      case "_btnModify":
         ...
         break;
      case "_btnPercentXP":
         var _loc2_ = this.gapi.loadUIComponent("PopupQuantity","PopupQuantity",{value:this._oMember.percentxp,max:90,min:0});
...
_loc1.updateData = function()
{
   ...
   var _loc4_ = this._oMemberClone.rights;
   this._btnRBoost.selected = _loc4_.canManageBoost;
   this._btnRRights.selected = _loc4_.canManageRights;
   this._btnRInvit.selected = _loc4_.canInvite;
   this._btnRBann.selected = _loc4_.canBann;
   this._btnRPercentXP.selected = _loc4_.canManageXPContitribution;
   this._btnRRank.selected = _loc4_.canManageRanks;
   this._btnRHireTax.selected = _loc4_.canHireTaxCollector;
   this._btnROwnPercentXP.selected = _loc4_.canManageOwnXPContitribution;
   this._btnRCollect.selected = _loc4_.canCollect;
   this._bntRCanUseMountPark.selected = _loc4_.canUseMountPark;
   this._btnRCanArrangeMountPark.selected = _loc4_.canArrangeMountPark;
   this._btnRCanManageOtherMount.selected = _loc4_.canManageOtherMount;
   var _loc7_ = _loc10_.canManageRights && !_loc4_.isBoss;
   ...
   this._btnModify.enabled = _loc10_.isBoss || (_loc10_.canManageRights || (_loc10_.canManageRanks || (_loc10_.canManageXPContitribution || _loc4_.canManageOwnXPContitribution)));
   if(_loc10_.canManageRanks)
   {
      ...
      {
         var _loc6_ = this.ObtainRank(_loc3_[0].i) == "Empty" ? _loc3_[0].n : this.ObtainRank(_loc3_[0].i);
         _loc5_.push({label:_loc6_,id:_loc3_[0].i,icon:"GuildMemberCrown"});
      ...
      while(_loc2_ < _loc3_.length)
      {
         ...
         _loc5_.push({label:_loc6_,id:_loc3_[_loc2_].i});
...
_loc1.setValue = function(_loc2_, _loc3_, _loc4_)
{
   ...
   {
      this._oItem = _loc4_;
      var _loc3_ = this._mcList.gapi.api.datacenter.Player.guildInfos.playerRights;
      this._lblName.text = _loc4_.name;
      ...
      var _loc4_ = _loc4_.rights.isBoss;
      if(_loc4_)
      {
...
_loc1.click = function(oEvent)
{
   switch(oEvent.target)
   {
      ...
      case this._btnSubscribe:
         ...
         {
            this.getURL("https://play-Mushi.net/","_blank");
         }
         break;
      case this._btnBugs:
         if(this.api.ui.getUIComponent("Banner") != undefined)
         {
            this.gapi.loadUIComponent("ReportBug","ReportBug");
            break;
         }
   }
};
_loc1.over = function(oEvent)
{
   switch(oEvent.target)
   {
      ...
      case this._btnCalidad:
         ...
         break;
      case this._btnSubscribe:
         this.api.ui.showTooltip("SiteWeb",oEvent.target,20,{bXLimit:true,bYLimit:true});
   }
};
...
_loc1.addEffect = function(_loc2_)
{
   ...
   {
      var _loc3_ = this._aEffects[_loc4_];
...
_loc1.addListeners = function()
{
   ...
   var _loc2_ = 66;
   while(_loc2_ <= dofus["\r\x14"].gapi.ui.Buff.LAST_GLADIATROOL_CONTAINER)
   {
      var _loc4_ = this["_ctr" + _loc2_];
...
_loc1.updateData = function()
{
   var _loc8_ = new Array();
   var _loc7_ = 20;
   while(_loc7_ <= dofus["\r\x14"].gapi.ui.Buff.LAST_CONTAINER)
   {
      _loc8_[_loc7_] = true;
      _loc7_ += 1;
   }
   var _loc6_ = 6;
   while(_loc6_ <= dofus["\r\x14"].gapi.ui.Buff.LAST_GLADIATROOL_CONTAINER)
   {
      _loc8_[_loc6_] = true;
      _loc6_ += 1;
   }
   ...
   {
      var _loc9_ = _loc13_[_loc14_];
      if(!_global.isNaN(_loc9_.position))
      {
         var _loc3_ = _loc9_.position;
   ...
   var _loc5_ = 20;
   while(_loc5_ <= dofus["\r\x14"].gapi.ui.Buff.LAST_CONTAINER)
   {
      if(_loc8_[_loc5_])
      {
         var _loc11_ = this["_ctr" + _loc5_];
   ...
   var _loc4_ = 66;
   while(_loc4_ <= dofus["\r\x14"].gapi.ui.Buff.LAST_GLADIATROOL_CONTAINER)
   {
      if(_loc8_[_loc4_])
      {
         var _loc12_ = this["_ctr" + _loc4_];
...
_loc1.setPreferedFilter = function()
{
   ...
   {
      var _loc2_ = this._eaDataProvider[_loc4_].superType;
...
_loc1.initData = function()
{
   var _loc11_ = this._oData.winners.length;
   var _loc10_ = this._oData.loosers.length;
   var _loc8_ = this._oData.collectors.length;
   var _loc17_ = _loc11_ + _loc10_ + _loc8_;
   var _loc9_ = Math.min(_loc11_,dofus["\r\x14"].gapi.ui.GameResult.MAX_VISIBLE_PLAYERS_IN_TEAM) * 20 + 65 + Math.min(_loc10_,dofus["\r\x14"].gapi.ui.GameResult.MAX_VISIBLE_PLAYERS_IN_TEAM) * 20 + 65;
   if(_loc8_ > 0)
   {
      _loc9_ += Math.min(_loc8_,dofus["\r\x14"].gapi.ui.GameResult.MAX_VISIBLE_PLAYERS_IN_TEAM) * 20 + 65;
   }
   var _loc15_ = _loc9_ + 32;
   var _loc6_ = ((_loc17_ > dofus["\r\x14"].gapi.ui.GameResult.MAX_PLAYERS ? 550 : this.gapi.screenHeight) - _loc15_) / 2;
   var _loc12_ = this._winBackground._x + 10;
   var _loc14_ = _loc6_ + 32;
   var _loc13_ = Math.min(_loc11_,dofus["\r\x14"].gapi.ui.GameResult.MAX_VISIBLE_PLAYERS_IN_TEAM) * 20 + 55 + _loc14_;
   var _loc16_ = Math.min(_loc10_,dofus["\r\x14"].gapi.ui.GameResult.MAX_VISIBLE_PLAYERS_IN_TEAM) * 20 + 55 + _loc13_;
   switch(this._oData.fightType)
   {
      case 0:
         var _loc7_ = "UI_GameResultTeam";
         break;
      case 1:
         _loc7_ = "UI_GameResultTeamPVP";
   }
   this.attachMovie(_loc7_,"_tWinners",10,{dataProvider:this._oData.winners,title:this.api.lang.getText("WINNERS"),_x:_loc12_,_y:_loc14_});
   this.attachMovie(_loc7_,"_tLoosers",20,{dataProvider:this._oData.loosers,title:this.api.lang.getText("LOOSERS"),_x:_loc12_,_y:_loc13_});
   if(_loc8_ > 0)
   {
      this.attachMovie(_loc7_,"_tCollectors",30,{dataProvider:this._oData.collectors,title:this.api.lang.getText("GUILD_TAXCOLLECTORS"),_x:_loc12_,_y:_loc16_});
   }
   ...
   if(this._oData.challenges && this._oData.challenges.length)
   {
      ...
      {
         var _loc3_ = this.attachMovie("FightChallengeIcon","fci" + _loc2_,this.getNextHighestDepth(),{challenge:this._oData.challenges[_loc2_],displayUiOnClick:false});
         var _loc0_ = null;
         _loc0_ = _loc0_ = 17;
...
_loc1.setValue = function(_loc2_, _loc3_, _loc4_)
{
   ...
   this._oItems = _loc4_;
   var _loc10_ = this._mcList._parent.api;
   if(_loc2_)
   {
      switch(_loc4_.type)
      {
         ...
         case "player":
            this._lblName.text = _loc4_.name;
            if(_loc4_.rank == 0 && !_loc10_.datacenter.Basics.aks_current_server.isHardcore())
            {
            ...
            else
            {
               ...
               if(_loc10_.datacenter.Basics.aks_current_server.isHardcore())
               {
            ...
            while(true)
            {
               ...
               var _loc5_ = this._mcItemPlacer._x + 24 * _loc4_;
               if(_loc5_ < this._mcItemPlacer._x + this._mcItemPlacer._width)
               {
                  var _loc6_ = _loc4_.items[_loc4_];
                  _loc3_ = this._mcItems.attachMovie("Container","_ctrItem" + _loc4_,_loc4_,{_x:_loc5_,_y:this._mcItemPlacer._y + 1});
            ...
            this._ldrAllDrop._visible = _loc9_;
      }
   }
   else if(this._lblName.text != undefined)
   {
...
_loc1.updateData = function(_loc2_)
{
   ...
   if(this._aMembers.length != 0)
   {
      ...
      {
         var _loc4_ = this._aMembers[_loc5_];
         var _loc6_ = this["_piMember" + _loc11_++];
         if(_loc2_ && _loc2_.id == _loc4_.id)
         {
            _loc4_ = _loc2_;
            this._aMembers[_loc5_] = _loc2_;
         }
      ...
      while(_loc8_)
      {
         _loc8_ = false;
         var _loc2_ = 0;
         while(_loc2_ < dofus.Constants.MEMBERS_COUNT_IN_PARTY)
         {
            if(this._aMembers[_loc2_ + 1] != undefined && this._aMembers[_loc2_].initiative < this._aMembers[_loc2_ + 1].initiative)
            {
               var _loc7_ = this._aMembers[_loc2_];
               this._aMembers[_loc2_] = this._aMembers[_loc2_ + 1];
               this._aMembers[_loc2_ + 1] = _loc7_;
               _loc8_ = true;
            }
            var _loc3_ = this["_piMember" + _loc2_];
            ...
            _loc3_.isLeader = this._aMembers[_loc2_].id == this._sLeaderID;
            if(_loc3_.isInGroup)
            {
               var _loc9_ = _loc3_;
            }
...
_loc1.initialize = function(nQuestionID, aResponsesID, aQuestionParams)
{
   ...
   {
      var _loc4_ = Number(aResponsesID[_loc3_]);
...
_loc1.updateData = function()
{
   if(this._oSprite != undefined)
   {
      ...
      this._switchHero._visible = this._isHero;
      this._visible = true;
   }
   else
   {

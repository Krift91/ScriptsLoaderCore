...
_loc1.__set__sessionToken = function(sToken)
{
   this._sSessionToken = sToken;
   return sToken;
};
_loc1.__get__sessionToken = function()
{
   return this._sSessionToken;
};
_loc1._oWeaponItem = undefined;
_loc1.addProperty("sessionToken",_loc1.__get__sessionToken,_loc1.__set__sessionToken);

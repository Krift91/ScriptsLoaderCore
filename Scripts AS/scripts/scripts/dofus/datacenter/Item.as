...
_global.dofus.datacenter["\f\f"].getItemDescriptionEffects = function(aEffects, bVisibleOnly, aBaseEffect)
{
   ...
   if(typeof aEffects == "object")
   {
      ...
      {
         var _loc7_ = aEffects[_loc9_];
         var _loc11_ = _loc7_[0];
         var _loc4_ = new dofus.datacenter["\x0f\r"](undefined,_loc11_,_loc7_[1],_loc7_[2],_loc7_[3],_loc7_[4]);
         var _loc10_ = false;

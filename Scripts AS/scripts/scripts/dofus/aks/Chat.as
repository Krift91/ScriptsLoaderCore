...
_loc1.onMessage = function(bSuccess, sExtraData)
{
   ...
   switch(_loc11_)
   {
      ...
      case "+":
         ...
         break;
      default:
         var _loc14_ = _loc3_.charAt(0) == dofus.Constants.EMOTE_CHAR && (_loc3_.charAt(1) == dofus.Constants.EMOTE_CHAR && (_loc3_.charAt(_loc3_.length - 1) == dofus.Constants.EMOTE_CHAR && _loc3_.charAt(_loc3_.length - 2) == dofus.Constants.EMOTE_CHAR));
         ...
         if(_loc14_ && !_global.isNaN(_loc3_.substr(2,_loc3_.length - 4)))
         {
            ...
            var _loc16_ = _global.parseInt(_loc3_.substr(2,_loc3_.length - 4));
            var _loc15_ = this.api.lang.getSpeakingItemsText(_loc16_ - Number(_loc9_));
            if(_loc15_.m)
            {
               _loc6_ = "MESSAGE_CHAT";
               _loc3_ = _loc15_.m;

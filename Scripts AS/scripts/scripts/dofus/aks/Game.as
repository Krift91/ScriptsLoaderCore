...
_loc1.colorTurno = function(packet)
{
   var _loc4_ = packet.split("|");
   var _loc2_ = _loc4_[0];
   var _loc5_ = _loc4_[3];
   var _loc3_ = 255;
   if(this.api.datacenter.Game.currentPlayerWithGlowID != undefined)
   {
      this.api.gfx.addEstiloVIP(_loc2_,null);
   }
   if(_loc5_ == 0)
   {
      _loc3_ = 16711680;
   }
   this.api.gfx.addEstiloVIP(_loc2_,_loc3_);
   this.api.datacenter.Game.currentPlayerWithGlowID = _loc2_;
};
_loc1.addColorVIP = function(sID, colorVIP)
{
   _global.trace("addColorVIP :" + sID + " - " + colorVIP);
   this.api.gfx.addEstiloVIP(sID,colorVIP);
};
_loc1.eliminarColorTurno = function(sID)
{
   this.api.gfx.addEstiloVIP(sID,null);
};
...
_loc1.reloadChallenges = function(nPrecio)
{
   this.aks.send("fr" + nPrecio);
};
_loc1.onFightChallenge = function(_loc2_)
{
   var _loc6_ = _loc2_.charAt(0);
   var _loc3_ = _loc2_.substr(1).split(";");
   ...
   if(_loc6_ == "+")
   {
      var _loc5_ = _global.parseInt(_loc3_[0]);
      var _loc4_ = new dofus.datacenter["\x0e\x0f"](_loc5_,_global.parseInt(_loc3_[1]),_loc3_[2] == "1",_global.parseInt(_loc3_[3]),_global.parseInt(_loc3_[4]),_global.parseInt(_loc3_[5]),_global.parseInt(_loc3_[6]),_global.parseInt(_loc3_[7]),_global.parseInt(_loc3_[8]),_global.parseInt(_loc3_[9]) == 1);
      var _loc7_ = this.api.ui.getUIComponent("FightChallenge").challenges.findFirstItem("unicID",_loc5_);
      if(_loc7_.index != -1)
      {
         this.api.ui.getUIComponent("FightChallenge").challenges.updateItem(_loc7_.index,_loc4_);
         this.api.ui.getUIComponent("FightChallenge").updateChallengeData(_loc4_);
      }
      else
      {
         this.api.ui.getUIComponent("FightChallenge").addChallenge(_loc4_);
      }
   }
   else if(_loc6_ == "-")
   {
      this.api.ui.getUIComponent("FightChallenge").removeChallenge(_global.parseInt(_loc3_[0]));
   }
};
_loc1.onFightChallengeUpdate = function(_loc2_, _loc3_)
{
   var _loc4_ = _global.parseInt(_loc2_);
   this.api.ui.getUIComponent("FightChallenge").updateChallenge(_loc4_,_loc3_);
   _loc3_ = !_loc3_ ? this.api.lang.getText("FIGHT_CHALLENGE_FAILED") : this.api.lang.getText("FIGHT_CHALLENGE_DONE");
   _loc3_ += " : " + this.api.lang.getFightChallenge(_loc4_).n;
   if(!this.api.ui.getUIComponent("FightChallenge").challenges.findFirstItem("id",_loc4_).item.special)
   {
      this.api.kernel.showMessage(undefined,_loc3_,"INFO_CHAT");
   }
};
_loc1.onTeam = function(_loc2_)
{
   ...
   {
      var _loc6_ = _loc12_[_loc4_].split(";");
      var _loc11_ = _loc6_[0].charAt(0) == "+";
      var _loc7_ = _loc6_[0].substr(1);
      var _loc3_ = _loc6_[1];
...
_loc1.onEnd = function(sExtraData)
{
   ...
   var _loc8_ = this.api.ui.getUIComponent("FightChallenge");
   this.api.kernel.StreamingDisplayManager.onFightEnd();
   var _loc3_ = {winners:[],loosers:[],collectors:[],challenges:_loc8_.challenges.clone(),currentTableTurn:this.api.datacenter.Game.currentTableTurn,currentPlayerInfos:[],currentPlayerInfosWithChest:[]};
   this.api.datacenter.Game.results = _loc3_;
   if(!this.api.datacenter.Game.isSpectator)
   {
      this.api.datacenter.Basics.currentSessionFightCount++;
      _loc3_.id = this.api.datacenter.Basics.currentSessionFightCount;
      this.api.datacenter.Game.storeFightResults(_loc3_);
   }
   _loc8_.cleanChallenge();
   var _loc4_ = sExtraData.split("|");
   var _loc7_ = -1;
   if(!_global.isNaN(Number(_loc4_[0])))
   {
      _loc3_.duration = Number(_loc4_[0]);
   }
   else
   {
      var _loc6_ = _loc4_[0].split(";");
      _loc3_.duration = Number(_loc6_[0]);
   ...
   _loc3_.fightType = _loc5_;
   var _loc10_ = new ank["\x1e\n\x07"]["\x0f\x01"]();
   var _loc9_ = 0;
   this.api.datacenter.Player.isDead = false;
   this.parsePlayerData(_loc3_,3,_loc11_,_loc4_,_loc5_,_loc9_,_loc10_,false,false);
};
_loc1.parsePlayerData = function(oResults, nStartIndex, nSenderID, aTmp, nFightType, nKamaDrop, eaFightDrop, bAlreadyParsed, bIsChest)
{
   var _loc17_ = nStartIndex;
   var _loc4_ = aTmp[_loc17_].split(";");
   var _loc2_ = {};
   if(Number(_loc4_[0]) != 6)
   {
      ...
      var _loc23_ = this.api.kernel.CharactersManager.getNameFromData(_loc4_[2]);
      _loc2_.name = _loc23_.name;
      _loc2_.type = _loc23_.type;
      _loc2_.level = Number(_loc4_[3]);
      _loc2_.bDead = _loc4_[5] != "1" ? false : true;
      _loc2_.gfx = Number(_loc4_[4]);
      switch(nFightType)
      {
         case 0:
            _loc2_.minxp = Number(_loc4_[6]);
            _loc2_.xp = Number(_loc4_[7]);
            _loc2_.maxxp = Number(_loc4_[8]);
            _loc2_.winxp = Math.max(Number(_loc4_[9]),0);
            _loc2_.guildxp = Number(_loc4_[10]);
            _loc2_.mountxp = Number(_loc4_[11]);
            var _loc16_ = _loc4_[12].split(",");
            ...
            _loc2_.kama = _loc4_[13];
            break;
         case 1:
            _loc2_.minhonour = Number(_loc4_[6]);
            _loc2_.honour = Number(_loc4_[7]);
            _loc2_.maxhonour = Number(_loc4_[8]);
            _loc2_.winhonour = Number(_loc4_[9]);
            _loc2_.rank = Number(_loc4_[10]);
            _loc2_.disgrace = Number(_loc4_[11]);
            _loc2_.windisgrace = Number(_loc4_[12]);
            _loc2_.maxdisgrace = this.api.lang.getMaxDisgracePoints();
            _loc2_.mindisgrace = 0;
            _loc2_.alignment = Number(_loc4_[13]);
            _loc16_ = _loc4_[14].split(",");
            if(_loc2_.id == this.api.datacenter.Player.ID && _loc16_.length > 10)
            {
               this.api.kernel.SpeakingItemsManager.triggerEvent(dofus["\x0b\b"].SpeakingItemsManager.SPEAK_TRIGGER_GREAT_DROP);
            }
            _loc2_.kama = _loc4_[15];
            _loc2_.minxp = Number(_loc4_[16]);
            _loc2_.xp = Number(_loc4_[17]);
            _loc2_.maxxp = Number(_loc4_[18]);
            _loc2_.winxp = Number(_loc4_[19]);
      }
   }
   else
   {
      _loc16_ = _loc4_[1].split(",");
      _loc2_.kama = _loc4_[2];
      nKamaDrop += Number(_loc2_.kama);
   }
   _loc2_.items = [];
   ...
   {
      case 0:
         oResults.loosers.push(_loc2_);
         break;
      case 2:
         oResults.winners.push(_loc2_);
         break;
      case 5:
         oResults.collectors.push(_loc2_);
         break;
      case 6:
         eaFightDrop = eaFightDrop.concat(_loc2_.items);
   }
   if(!bAlreadyParsed && (_loc2_.id == this.api.datacenter.Player.ID || bIsChest))
   {
      if(bIsChest)
      {
         var _loc10_ = new ank["\x1e\n\x07"]["\x0e\x1d"]();
         var _loc11_ = [];
         var _loc13_ = oResults.currentPlayerInfos[0].items;
         var _loc9_ = 0;
         while(true)
         {
            _loc9_ = _loc9_ + 1;
            if(_loc9_ >= _loc13_.length)
            {
               break;
            }
            var _loc5_ = _loc13_[_loc9_];
            var _loc6_ = new dofus.datacenter["\f\f"](undefined,_loc5_.unicID,_loc5_.Quantity);
            _loc11_.push(_loc6_);
            _loc10_.addItemAt(_loc5_.unicID,_loc6_);
         }
         ...
         {
            _loc8_ = _loc8_ + 1;
            if(_loc8_ >= _loc12_.length)
            {
               break;
            }
            var _loc3_ = _loc12_[_loc8_];
            if(_loc10_.getItemAt(_loc3_.unicID) != undefined)
            {
               var _loc7_ = dofus.datacenter["\f\f"](_loc10_.getItemAt(_loc3_.unicID));
               _loc7_.Quantity += _loc3_.Quantity;
            }
            else
            {
               _loc11_.push(_loc3_);
         ...
         this.api.datacenter.Basics.kamas_lastGained = Number(this.api.datacenter.Basics.kamas_lastGained) + Number(_loc4_[13]);
         var _loc15_ = {};
         _loc15_.type = oResults.currentPlayerInfos[0].type;
         _loc15_.winxp = this.api.datacenter.Basics.exp_lastGained;
         _loc15_.guildxp = this.api.datacenter.Basics.guildExp_lastGained;
         _loc15_.mountxp = this.api.datacenter.Basics.mountExp_lastGained;
         _loc15_.kama = this.api.datacenter.Basics.kamas_lastGained;
         _loc15_.items = _loc11_;
         oResults.currentPlayerInfosWithChest.push(_loc15_);
         bAlreadyParsed = true;
      }
      else
      {
         ...
         oResults.currentPlayerInfos.push(_loc2_);
      }
   }
   _loc17_ = _loc17_ + 1;
   if(_loc17_ < aTmp.length)
   {
      this.addToQueue({object:this,method:this.parsePlayerData,params:[oResults,_loc17_,nSenderID,aTmp,nFightType,nKamaDrop,eaFightDrop,bAlreadyParsed,bIsChest]});
   }
   else
   {
...
_loc1.parseItems = function(aItems)
{
   var _loc8_ = [];
   var _loc4_ = 0;
   while(true)
   {
      _loc4_ = _loc4_ + 1;
      if(_loc4_ >= aItems.length)
      {
         break;
      }
      var _loc3_ = aItems[_loc4_].split("~");
      ...
      if(_loc2_ != 0)
      {
         var _loc5_ = new dofus.datacenter["\f\f"](0,_loc2_,_loc6_);
         _loc8_.push(_loc5_);
      }
   }
   return _loc8_;
...
_loc1.onParseItemEnd = function(nSenderID, oResults, eaFightDrop, nKamaDrop)
{
   ...
   {
      var _loc7_ = Math.ceil(eaFightDrop.length / oResults.winners.length);
      var _loc2_ = 0;
      while(true)
      {
         _loc2_ = _loc2_ + 1;
         if(_loc2_ >= oResults.winners.length)
         {
            break;
         }
         var _loc4_ = eaFightDrop.length;
         oResults.winners[_loc2_].kama = Math.ceil(nKamaDrop / _loc7_);
         if(_loc2_ == oResults.winners.length - 1)
         {
            _loc7_ = _loc4_;
         }
         ...
         while(true)
         {
            ...
            oResults.winners[_loc2_].items.push(eaFightDrop.pop());
         }
      }
   }
   ...
   var _loc9_ = this.api.datacenter.Sprites.getItemAt(nSenderID).sequencer;
...
_loc1.onStartToPlay = function()
{
   ...
   var _loc7_ = this.api.ui.getUIComponent("Banner");
   _loc7_.showGiveUpButton(true);
   if(!this.api.datacenter.Game.isSpectator)
   {
      for(var _loc6_ in this.api.datacenter.Heroes)
      {
         var _loc2_ = this.api.datacenter.Heroes[_loc6_];
         trace("onStartToPlay " + _loc2_.Name);
      ...
      _loc7_.showPoints(true);
      _loc7_.showNextTurnButton(true);
...
_loc1.onTurnStart = function(_loc2_)
{
   if(this.api.datacenter.Game.isFirstTurn)
   {
      ...
      {
         this.api.gfx.removeSpriteExtraClip(_loc7_,true);
      }
   }
   var _loc8_ = _loc2_.split("|");
   var _loc4_ = _loc8_[0];
   var _loc9_ = Number(_loc8_[1]) / 1000;
   var _loc10_ = Number(_loc8_[2]);
   this.api.datacenter.Game.currentTableTurn = _loc10_;
   var _loc3_ = this.api.datacenter.Sprites.getItemAt(_loc4_);
   ...
   if(this.api.datacenter.Player.isCurrentPlayer)
   {
      ...
      this.api.ui.getUIComponent("Banner").startTimer(_loc9_);
   ...
   {
      this.api.gfx.setInteraction(ank.battlefield.Constants.INTERACTION_CELL_NONE);
      this.api.ui.getUIComponent("Timeline").startChrono(_loc9_);
   }
   this.api.ui.getUIComponent("Banner").showRightPanel("BannerSpriteInfos",{data:_loc3_},true);
   if(this.api.kernel.OptionsManager.getOption("StringCourse"))
   {
      var _loc6_ = new Array();
      _loc6_[1] = _loc3_.color1;
      _loc6_[2] = _loc3_.color2;
      _loc6_[3] = _loc3_.color3;
      this.api.ui.loadUIComponent("StringCourse","StringCourse",{gfx:_loc3_.artworkFile,name:_loc3_.name,level:this.api.lang.getText("LEVEL_SMALL") + " " + _loc3_.Level,colors:_loc6_},{bForceLoad:true});
   }
   if(this.api.datacenter.Game.currentPlayerWithGlowID != undefined)
   {
      _global.trace("removeGlowOnPlayer " + this.api.datacenter.Game.currentPlayerWithGlowID);
      this.api.gfx.removeGlowOnPlayer(this.api.datacenter.Game.currentPlayerWithGlowID);
   }
   this.api.gfx.setGlowOnPlayer(_loc4_,dofus.Constants.TEAMS_COLOR[_loc3_.Team]);
   _global.trace("_loc4_ : " + _loc4_ + "\n _loc3_Team: " + _loc3_.Team);
   this.api.datacenter.Game.currentPlayerWithGlowID = _loc4_;
   _global.trace("currentPlayerWithGlowID: " + currentPlayerWithGlowID);
   ...
   this.api.kernel.GameManager.cleanUpGameArea(true);
   ank["\x1e\n\x07"]["\x1e\x0b\x02"].setTimer(this.api.network.Ping,"GameDecoDetect",this.api.network,this.api.network.quickPing,_loc9_ * 1000);
...
{
   var _loc88_ = sExtraData.split("|");
   var _loc59_ = 0;
   for(; _loc59_ < _loc88_.length; _loc59_ = _loc59_ + 1)
   {
      var _loc41_ = _loc88_[_loc59_];
      if(_loc41_.length != 0)
      {
         var _loc58_ = false;
         var _loc37_ = false;
         ...
         if(_loc37_)
         {
            ...
            var _loc57_ = _loc3_[2].split("^");
            var _loc68_ = Number(_loc57_[0]);
            var _loc79_ = _loc57_[1] == "1";
            var _loc80_ = _loc57_[2];
            var _loc7_ = _loc3_[3];
            var _loc72_ = _loc3_[4].split("^");
            var _loc19_ = _loc72_[0];
            var _loc76_ = _loc72_[1];
            var _loc85_ = _loc3_[5];
            ...
            if(_loc69_.length)
            {
               ...
               {
                  var _loc62_ = _loc39_[0].split("*");
                  _loc86_ = new dofus.datacenter["\x1e\x0b\x01"](-1,_loc62_[1],_loc62_[0],1,"");
               }
               if(_loc39_[1].length > 0)
               {
                  var _loc66_ = _loc39_[1].split("*");
                  _loc82_ = new dofus.datacenter["\x1e\x0b\x01"](-1,_loc66_[0],_global.parseInt(_loc66_[1]));
               }
            }
            var _loc23_ = 100;
            var _loc22_ = 100;
            ...
            if(_loc58_)
            {
               var _loc14_ = this.api.datacenter.Sprites.getItemAt(_loc7_);
               this.onSpriteMovement(false,_loc14_);
            }
            loop3:
            switch(_loc15_)
            {
               ...
               case "-2":
                  ...
                  if(_loc15_ == -1)
                  {
                     _loc14_ = this.api.kernel.CharactersManager.createCreature(_loc7_,_loc19_,_loc8_);
                  }
                  else
                  {
                     _loc14_ = this.api.kernel.CharactersManager.createMonster(_loc7_,_loc19_,_loc8_);
                  }
                  break;
               case "-3":
                  var _loc5_ = new Object();
                  ...
                  _loc5_.dir = _loc26_;
                  var _loc12_ = _loc3_[8].split(",");
                  _loc5_.color1 = _loc12_[0];
                  _loc5_.color2 = _loc12_[1];
                  _loc5_.color3 = _loc12_[2];
                  _loc5_.totalExp = _loc12_[3];
                  _loc5_.extraClip = _loc12_[4];
                  _loc5_.tipoMob = _loc12_[5];
                  _loc5_.accessories = _loc3_[9];
                  _loc5_.bonusValue = _loc68_;
                  var _loc61_ = this.sliptGfxData(_loc17_);
                  var _loc33_ = _loc61_.gfx;
                  _loc62_ = _loc3_[9 + 2 * _loc33_.length];
                  this.splitGfxForScale(_loc33_[0],_loc5_);
                  _loc14_ = this.api.kernel.CharactersManager.createMonsterGroup(_loc7_,_loc19_,_loc5_);
                  var _loc67_ = _loc7_;
                  var _loc9_ = 0;
                  while(true)
                  {
                     ...
                     if(_loc33_[_loc9_] != "")
                     {
                        ...
                        _loc12_ = _loc3_[8 + 2 * _loc9_].split(",");
                        _loc5_.color1 = _loc12_[0];
                        _loc5_.color2 = _loc12_[1];
                        _loc5_.color3 = _loc12_[2];
               ...
               case "-4":
                  ...
                  _loc13_.spriteType = _loc15_;
                  _loc13_.gfxID = _loc21_;
                  _loc13_.scaleX = _loc23_;
                  _loc13_.scaleY = _loc22_;
                  _loc13_.cell = _loc25_;
                  _loc13_.dir = _loc26_;
                  _loc13_.sex = _loc3_[7];
                  _loc13_.color1 = _loc3_[8];
                  _loc13_.color2 = _loc3_[9];
                  _loc13_.color3 = _loc3_[10];
                  _loc13_.accessories = _loc3_[11];
                  _loc13_.extraClipID = !(_loc3_[12] != undefined && !_global.isNaN(Number(_loc3_[12]))) ? -1 : Number(_loc3_[12]);
                  _loc13_.customArtwork = Number(_loc3_[13]);
                  _loc14_ = this.api.kernel.CharactersManager.createNonPlayableCharacter(_loc7_,Number(_loc19_),_loc13_);
                  break;
               case "-5":
                  ...
                  _loc14_ = this.api.kernel.CharactersManager.createOfflineCharacter(_loc7_,_loc19_,_loc11_);
                  break;
               case "-6":
                  ...
                  _loc14_ = this.api.kernel.CharactersManager.createTaxCollector(_loc7_,_loc19_,_loc10_);
                  break;
               case "-7":
               case "-8":
                  ...
                  _loc14_ = this.api.kernel.CharactersManager.createMutant(_loc7_,_loc6_);
                  break;
               case "-9":
                  ...
                  _loc14_ = this.api.kernel.CharactersManager.createParkMount(_loc7_,_loc19_ == "" ? this.api.lang.getText("NO_NAME") : _loc19_,_loc24_);
                  break;
               case "-10":
                  ...
                  _loc14_ = this.api.kernel.CharactersManager.createPrism(_loc7_,_loc19_,_loc27_);
                  break;
               default:
                  ...
                  if(this.api.datacenter.Game.isFight)
                  {
                     ...
                     if(_loc3_[25].indexOf(",") != -1)
                     {
                        ...
                        {
                           var _loc42_ = new dofus.datacenter.Mount(_loc63_,Number(_loc21_));
                  ...
                  else
                  {
                     ...
                     if(_loc3_[19].indexOf(",") != -1)
                     {
                        ...
                        if(!_global.isNaN(_loc64_))
                        {
                           var _loc40_ = new dofus.datacenter.Mount(_loc64_,Number(_loc21_));
                  ...
                  if(_loc35_.length > 3 && _loc7_ != this.api.datacenter.Player.ID)
                  {
                     if(this.api.lang.getAlignmentCanViewPvpGain(this.api.datacenter.Player.alignment.index,Number(_loc4_.alignment.index)))
                     {
                        ...
                        var _loc87_ = Number(_global.RANGO_NIVEL_PVP);
                        var _loc81_ = Number(- _global.RANGO_NIVEL_PVP);
                        var _loc55_ = 0;
                        if(this.api.datacenter.Player.Level - _loc77_ > _loc87_)
                        {
                           _loc55_ = -1;
                        }
                        if(this.api.datacenter.Player.Level - _loc77_ < _loc81_)
                        {
                           _loc55_ = 1;
                        }
                  ...
                  _loc4_.title = _loc86_;
                  _loc4_.title2 = _loc82_;
                  _loc14_ = this.api.kernel.CharactersManager.createCharacter(_loc7_,_loc19_,_loc4_);
                  _loc14_.allowGhostMode = _loc73_;
                  var _loc45_ = _loc7_;
            ...
            this.onSpriteMovement(_loc37_,_loc14_,_loc78_);
         }
         else
         {
            var _loc84_ = _loc41_.substr(1);
            var _loc83_ = this.api.datacenter.Sprites.getItemAt(_loc84_);
            this.onSpriteMovement(_loc37_,_loc83_);
         }
      }
   }
};
_loc1.onSpriteMovement = function(_loc2_, oSprite, _loc4_)
{
   ...
   if(_loc2_)
   {
      ...
      if(oSprite instanceof dofus.datacenter["\t\x1d"])
      {
         if(!_global.isNaN(oSprite.extraClip))
         {
            this.api.gfx.addSpriteExtraClip(oSprite.id,dofus.Constants.EXTRA_PATH + oSprite.extraClip + ".swf",undefined,false);
            return undefined;
         }
      }
      if(oSprite instanceof dofus.datacenter["\x13\x01"])
      {
         if(oSprite.colorVIP != 1)
         {
            this.api.gfx.addEstiloVIP(oSprite.id,oSprite.colorVIP);
         }
      }
      if(this.api.datacenter.Game.isRunning)
      {

...
_loc1.modifyLocal = function(sExtraData, ea, sKamaLocation, sOgrineLocation)
{
   ...
   {
      case "O":
         var _loc16_ = sExtraData.charAt(1) == "+";
         var _loc13_ = sExtraData.substr(2).split("|");
         var _loc4_ = Number(_loc13_[0]);
         var _loc11_ = Number(_loc13_[1]);
         var _loc12_ = this.api.datacenter.Player.Inventory.findFirstItem("ID",_loc4_);
         var _loc2_ = _loc3_.inventory.findFirstItem("ID",_loc4_);
         var _loc5_ = ea.findFirstItem("ID",_loc4_);
         if(_loc16_)
         {
            var _loc9_ = _loc2_.item;
            var _loc10_ = new dofus.datacenter["\f\f"](_loc4_,_loc9_.unicID,_loc11_,-2,_loc9_.compressedEffects);
            var _loc15_ = -1;
            var _loc8_ = _loc12_.item.Quantity - _loc11_;
            if(_loc8_ == 0)
            {
               _loc15_ = -3;
            }
...
_loc1.modifyDistant = function(sExtraData, ea, sKamaLocation, bForceModifyInventory, sOgrineLocation)
{
   ...
   switch(_loc16_)
   {
      case "O":
         ...
         var _loc6_ = sExtraData.substr(2).split("|");
         var _loc9_ = Number(_loc6_[0]);
         var _loc10_ = Number(_loc6_[1]);
         var _loc13_ = Number(_loc6_[2]);
         var _loc14_ = _loc6_[3];
         var _loc7_ = ea.findFirstItem("ID",_loc9_);
         if(_loc17_)
         {
            var _loc5_ = new dofus.datacenter["\f\f"](_loc9_,_loc13_,_loc10_,-1,_loc14_);
            var _loc15_ = bForceModifyInventory == undefined ? _loc4_.distantPlayerID == undefined : bForceModifyInventory;
            if(_loc7_.index != -1)
            {
         ...
         break;
      case "G":
         var _loc8_ = Number(sExtraData.substr(1));
...
_loc1.onDistantMovement = function(bSuccess, sExtraData)
{
   switch(this.api.datacenter.Basics.aks_exchange_echangeType)
   {
      ...
      case 10:
         ...
         var _loc13_ = _loc2_[3];
         var _loc10_ = Number(_loc2_[4]);
         var _loc9_ = Number(_loc2_[5]);
         var _loc4_ = this.api.datacenter.Temporary.Shop;
         var _loc3_ = _loc4_.inventory.findFirstItem("ID",_loc5_);
         if(_loc11_)
         {
            var _loc7_ = new dofus.datacenter["\f\f"](_loc5_,_loc8_,_loc12_,-1,_loc13_,_loc10_);
   ...
   switch(_loc19_)
   {
      ...
      case 3:
         ...
         if(_loc19_ == 3)
         {
            ...
            var _loc24_ = Number(_loc6_[0]);
            var _loc20_ = Number(_loc6_[1]);
            if(_global.API.lang.getSkillForgemagus(_loc20_) > 0)
            {
               this.api.ui.loadUIComponent("ForgemagusCraftNew","Craft",{skillId:_loc20_,maxItem:_loc24_});
            }
            else if(_loc20_ == 181)
            {
               this.api.ui.loadUIComponent("Decraft","Craft",{skillId:_loc20_,maxItem:this.api.lang.getConfigText("LIMIT_DECRAFT")});
            }
            else
            {
      ...
      case 13:
         this.api.datacenter.Exchange.inventory = this.api.datacenter.Player.Inventory.clone();
         _loc6_ = _loc15_.split(";");
         var _loc26_ = Number(_loc6_[0]);
         var _loc27_ = Number(_loc6_[1]);
         this.api.ui.unloadUIComponent("AskYesNoIgnoreExchange");
         this.api.ui.unloadUIComponent("AskCancelExchange");
      ...
      case 14:
         ...
         {
            var _loc8_ = Number(_loc11_[_loc7_]);
      ...
      case 16:
         ...
         _loc6_ = _loc15_.split("~");
         var _loc9_ = _loc6_[0].split(";");
         var _loc10_ = _loc6_[1].split(";");
         if(_loc9_ != undefined)
         {
            var _loc5_ = 0;

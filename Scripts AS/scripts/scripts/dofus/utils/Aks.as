...
_loc1.removeAccents = function()
{
   ...
   {
      var _loc4_ = this._s.charAt(_loc2_);
      var _loc3_ = _loc7_.indexOf(_loc4_);
...
_loc1.onRightClick = function(api)
{
   ...
   {
      var _loc7_ = _loc8_[_loc6_].name;
      if(_loc7_ != undefined)
      {
         var _loc3_ = api.ui.getUIComponent(_loc7_);
         ...
         var _loc4_ = _loc3_.currentOverItem;
   ...
   {
      var _loc11_ = api.kernel.AdminManager.getAdminPopupMenu(api.datacenter.Player.Name,true);
...
_loc1.onRetroChatFunctionKey = function(oEvent)
{
   ...
   switch(_loc6_)
   {
      ...
      case 40:
         ...
         break;
      case 9:
         var _loc3_ = oEvent.currentPrompt;
...
_loc1.onWindowFocus = function()
{
   ...
   for(var _loc5_ in _loc4_)
   {
      ...
      {
         var _loc3_ = ank.battlefield.mc.Sprite(_loc2_.mc);
...
_loc1.updateWindowTitle = function(sPlayerName)
{
   ...
   _loc2_ = _loc2_ + "Karnak Retro v" + dofus.Constants.VERSION + "." + dofus.Constants.SUBVERSION + "." + dofus.Constants.SUBSUBVERSION;
...
_loc1.printRightClickPopupMenu = function()
{
   ...
   _loc3_.addStaticItem("KarnakRetro Client v" + dofus.Constants.VERSION + "." + dofus.Constants.SUBVERSION + "." + dofus.Constants.SUBSUBVERSION);
...
_loc1.showMessage = function(sTitle, sMsg, sType, oParams, sUniqId)
{
   switch(sType)
   {
      ...
      case "CAUTION_YESNOIGNORE":
         ...
         var _loc6_ = this.api.ui.loadUIComponent("AskYesNoIgnore","AskYesNoIgnore" + (oParams.name == undefined ? "" : oParams.name),{title:sTitle,text:sMsg,player:oParams.player,params:oParams.params},{bForceLoad:true});
      ...
      case "INFO_CANCEL":
         ...
         var _loc8_ = this.api.ui.loadUIComponent("AskCancel","AskCancel" + (oParams.name == undefined ? "" : oParams.name),{title:sTitle,text:sMsg,params:oParams.params},{bForceLoad:true});
...
dofus["\r\x14"].gapi.ui.Debug.onHref = function(oEvent, api, oCustomPopupPosition)
{
   ...
   switch(_loc6_)
   {
      case "ShowPlayerPopupMenu":
         ...
         break;
      case "ExecCmd":
         var _loc5_ = _loc2_.shift() == "true";
         var _loc3_ = _global.unescape(_loc2_.join(","));
         if(_loc5_)
         {
...
_loc1.onShortcut = function(_loc2_)
{
   switch(_loc2_)
   {
      ...
      case "ACCEPT_CURRENT_DIALOG":
         ...
         var _loc4_ = this.gapi.getUIComponent("Banner");
...
_loc1.onShortcut = function(_loc2_)
{
   switch(_loc2_)
   {
      ...
      case "ACCEPT_CURRENT_DIALOG":
         ...
         {
            var _loc10_ = this.gapi.getUIComponent("Debug");
      ...
      case "GUILD_MESSAGE":
         if(this.isChatFocus())
         {
            if(this._txtConsole.text.length != 0)
            {
               var _loc7_ = this.getChatCommand();
               if(_loc7_.charAt(0) == "/")
               {
      ...
      case "HISTORY_UP":
         if(this.isChatFocus())
         {
            var _loc11_ = this.api.kernel.Console.getHistoryUp();
      ...
      case "HISTORY_DOWN":
         if(this.isChatFocus())
         {
            var _loc9_ = this.api.kernel.Console.getHistoryDown();
            if(_loc9_ != undefined)
            {
      ...
      case "AUTOCOMPLETE":
         ...
         var _loc5_ = this.api.kernel.Console.autoCompletion(_loc4_,this._txtConsole.text);
         if(!_loc5_.isFull)
         {
...
_loc1.showPlayerPopupMenu = function(_loc2_, _loc3_, _loc4_, _loc5_, _loc6_, _loc7_, _loc8_, _loc9_, _loc10_)
{
   ...
   if(Key.isDown(16) && _loc8_ != this.api.datacenter.Player.Name && !_loc11_ && !this.api.datacenter.Game.isRunning)
   {
      var _loc10_ = this.api.ui.getUIComponent("Banner");
      _loc10_.txtConsole = "/w " + _loc8_ + " ";
      _loc10_.placeCursorAtTheEnd();
      this.api.electron.retroChatSetPromptText(_loc10_,true);
   }
   else if(Key.isDown(16) && _loc8_ != this.api.datacenter.Player.Name && _loc11_ && !this.api.datacenter.Game.isRunning)
   {
   ...
   else
   {
      ...
      {
         var _loc7_ = this.api.kernel.AdminManager.getAdminPopupMenu(_loc8_,false);
...
_loc1.onMessage = function(_loc2_, _loc3_)
{
   ...
   switch(_loc17_)
   {
      ...
      case "¡":
         ...
         return undefined;
      case "F":
         var _loc6_ = "WHISP_CHAT";
         _loc3_ = this.api.kernel.ChatManager.parseSecretsEmotes(_loc3_);
         if(!_loc3_.length)
         {
            return undefined;
         }
         var _loc15_ = this.api.lang.getText("FROM") + " " + _loc4_ + " : ";
      ...
      case "T":
         _loc6_ = "WHISP_CHAT";
         var _loc19_ = this.api.lang.getText("TO_DESTINATION") + " " + _loc4_ + " : ";
      ...
      case "#":
         if(this.api.datacenter.Game.isFight)
         {
            ...
            {
               var _loc11_ = "(" + this.api.lang.getText("SPECTATOR") + ")";
            }
            else
            {
               _loc11_ = "(" + this.api.lang.getText("TEAM") + ")";
            }
            var _loc23_ = _loc11_ + " " + _loc4_ + " : ";
      ...
      case "%":
         ...
         var _loc24_ = "(" + this.api.lang.getText("GUILD") + ") " + _loc4_ + " : ";
      ...
      case "$":
         _loc6_ = "PARTY_CHAT";
         var _loc20_ = "(" + this.api.lang.getText("PARTY") + ") " + _loc4_ + " : ";
      ...
      case "!":
         _loc6_ = "PVP_CHAT";
         var _loc21_ = "(" + this.api.lang.getText("ALIGNMENT") + ") " + _loc4_ + " : ";
      ...
      case "?":
         ...
         var _loc27_ = "(" + this.api.lang.getText("RECRUITMENT") + ") " + _loc4_ + " : ";
      ...
      case ":":
         _loc6_ = "TRADE_CHAT";
         var _loc22_ = "(" + this.api.lang.getText("TRADE") + ") " + _loc4_ + " : ";
      ...
      case "^":
         _loc6_ = "MEETIC_CHAT";
         var _loc31_ = "(" + this.api.lang.getText("MEETIC") + ") " + _loc4_ + " : ";
      ...
      case "@":
         _loc6_ = "ADMIN_CHAT";
         var _loc29_ = "(" + this.api.lang.getText("PRIVATE_CHANNEL") + ") " + _loc4_ + " : ";
      ...
      case "+":
         ...
         break;
      default:
         var _loc16_ = _loc3_.charAt(0) == dofus.Constants.EMOTE_CHAR && (_loc3_.charAt(1) == dofus.Constants.EMOTE_CHAR && (_loc3_.charAt(_loc3_.length - 1) == dofus.Constants.EMOTE_CHAR && _loc3_.charAt(_loc3_.length - 2) == dofus.Constants.EMOTE_CHAR));
         if(this.api.lang.getConfigText("EMOTES_ENABLED") && (!_loc16_ && (_loc3_.charAt(0) == dofus.Constants.EMOTE_CHAR && _loc3_.charAt(_loc3_.length - 1) == dofus.Constants.EMOTE_CHAR)))
         {
            ...
            {
               var _loc10_ = !(_loc3_.charAt(_loc3_.length - 2) == "." && _loc3_.charAt(_loc3_.length - 3) != ".") ? _loc3_ : _loc3_.substr(0,_loc3_.length - 2) + dofus.Constants.EMOTE_CHAR;
         ...
         if(_loc3_.substr(0,7) == "!THINK!")
         {
            ...
            _loc6_ = "THINK_CHAT";
            var _loc30_ = _loc4_ + " " + this.api.lang.getText("THINKS_WORD") + " : ";
         ...
         if(_loc16_ && !_global.isNaN(_loc3_.substr(2,_loc3_.length - 4)))
         {
            ...
            var _loc26_ = _global.parseInt(_loc3_.substr(2,_loc3_.length - 4));
            var _loc12_ = this.api.lang.getSpeakingItemsText(_loc26_ - Number(_loc9_));
            if(_loc12_.m)
            {
               _loc6_ = "MESSAGE_CHAT";
               _loc3_ = _loc12_.m;
         ...
         if(this.api.datacenter.Player.isAuthorized)
         {
            var _loc28_ = this.api.kernel.DebugManager.getTimestamp();
...
_loc1.process = function(sCmd, oParams)
{
   ...
   if(sCmd.charAt(0) == "/")
   {
      ...
      var _loc14_ = _loc4_[0].substr(1).toUpperCase();
      _loc4_.splice(0,1);
      ...
      switch(_loc14_)
      {
         case "ALL":
            ...
            break;
         case "LK":
            var _loc26_ = this.api.datacenter.Player.Spells.findFirstItem("ID",179);
         ...
         case "SWAPHEROEVIEW":
            ...
            else if(this.api.ui.getUIComponent("StatsJob") != null)
            {
         ...
         case "FINDPOS":
            ...
            {
               var _loc6_ = this.api.datacenter.Player.Inventory[_loc18_];
         ...
         case "GOD":
         case "GODMODE":
            var _loc22_ = ["Bill","Tyn","Nyx","Lichen","Simsoft"];
         ...
         case "PLAYERS":
            ...
            var _loc8_ = this.api.datacenter.Sprites.getItems();
         ...
         case "KICK":
            ...
            var _loc15_ = String(_loc4_[0]);
            var _loc7_ = this.api.datacenter.Sprites.getItems();
            for(_loc18_ in _loc7_)
            {
               if(_loc7_[_loc18_] instanceof dofus.datacenter["\x13\x01"] && _loc7_[_loc18_].name == _loc15_)
               {
                  var _loc11_ = _loc7_[_loc18_].id;
                  break;
               }
            }
            if(_loc11_ != undefined)
         ...
         case "WTF":
            ...
            {
               var _loc5_ = this.api.datacenter.Player.getHeroes()[_loc18_];
               this.api.kernel.showMessage(undefined,_loc5_.ID + " " + _loc5_.Guild + " " + _loc5_.Name,"INFO_CHAT");
            }
            break;
         case "SHOWLIFES":
            var _loc12_ = this.api.gfx.spriteHandler.getSprites().getItems();
            for(var _loc19_ in _loc12_)
            {
               var _loc9_ = _loc12_[_loc19_];
         ...
         case "TACTIC":
            ...
            break;
         case "CELLINFOS":
            var _loc24_ = this.api.datacenter.Player.data.cellNum;
            var _loc23_ = this.api.datacenter.Map.data[_loc24_];
            var _loc28_ = _loc23_.active;
         ...
         case "TEST2":
            ...
            break;
         default:
            var _loc25_ = this.api.lang.getEmoteID(_loc14_.toLowerCase());
...
_loc1.prepareCommand = function(sCommand)
{
   ...
   {
      var _loc2_ = this.api.ui.getUIComponent("Debug");
      if(_loc2_ != undefined)
      {
...
_loc1.open = function(bOpen)
{
   ...
   if(!bOpen && this.api.datacenter.Player.isAuthorized)
   {
      ...
      {
         var _loc6_ = this.api.ui.getUIComponent("Debug");
         if(_loc6_ != undefined)
         {
...
_loc1.instanciateMiniMap = function()
{
   ...
   {
      var _loc2_ = 150;
      var _loc4_ = {_x:_loc2_,_y:this._chat._mcReplacementPanelMask._y,contentPath:"Map",enabled:true,showHintsMaxDistance:15,customBgScaleWidth:this._chat._mcReplacementPanelMask._width,customBgScaleHeight:this._chat._mcReplacementPanelMask._height,customBgScaleX:- _loc2_,customBgScaleY:0,customBgColor:14012330};
      var _loc3_ = this._chat.attachMovie("MiniMap","_mcMiniMapReplacementPanel",dofus["\r\x14"].gapi.controls.Chat.MINIMAP_REPLACEMENT_PANEL_DEPTH,_loc4_);
...
_loc1.instanciateMiniMap = function()
{
   ...
   {
      var _loc2_ = 72;
      var _loc4_ = {_x:_loc2_,_y:this._mcMiniMapMask._y,contentPath:"Map",enabled:true,showHintsMaxDistance:10,customBgScaleWidth:this._mcMiniMapMask._width,customBgScaleHeight:this._mcMiniMapMask._height,customBgScaleX:- _loc2_,customBgScaleY:0,customBgColor:14012330};
      var _loc3_ = this.attachMovie("MiniMap","_mcMiniMap",this.getNextHighestDepth(),_loc4_);
...
_loc1.onShortcut = function(shortcut)
{
   ...
   while(_loc2_ < dofus["\r\x14"].gapi.controls.ShortcutsChatReplacementPanel.MAX_CONTAINER)
   {
      if(shortcut == "MOVABLEBAR_SH" + _loc2_)
      {
         ...
         var _loc3_ = this._mouseShortcuts.getContainer(_loc4_);
         if(_loc3_ != undefined)
         {
...
_loc1.onCreate = function(_loc2_, _loc3_)
{
   ...
   {
      var _loc2_ = this.api.datacenter.Heroes[_loc3_];
...
_loc1.addEffect = function(_loc2_)
{
   ...
   {
      var _loc2_ = this._aEffects[_loc3_];

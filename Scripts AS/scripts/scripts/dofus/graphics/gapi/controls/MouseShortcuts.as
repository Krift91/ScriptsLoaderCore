...
_loc1.updateSpells = function()
{
   ...
   {
      var _loc7_ = _loc9_[_loc10_];
      var _loc6_ = _loc7_.position;
      ...
      default:
         switch(this._sCurrentTab)
         {
            ...
            case "Items":
               ...
               var _loc2_ = _loc6_ != undefined ? _loc6_.realLinkedItem : undefined;
               if(_loc2_ == undefined)
               {
                  return undefined;
               }
...
_loc1.dblClick = function(oEvent)
{
   switch(this._sCurrentTab)
   {
      ...
      case "Spells":
         ...
         if(Key.isDown(16))
         {
            var _loc22_ = oEvent.target.params.position;
      ...
      case "Items":
         ...
         var _loc3_ = _loc5_ != undefined ? _loc5_.realLinkedItem : undefined;
         if(_loc3_ == undefined)
         {
            return undefined;
         }
         ...
         if(Key.isDown(17))
         {
            ...
            _loc3_ = _loc8_.name;
            var _loc9_ = [function(_loc2_, _loc3, _loc4_)
            {
               return String(_loc4_);
            },_loc3_];
            var _loc10_ = _loc8_.Quantity;
            var _loc11_ = _loc4_.loadUIComponent("PopupQuantityWithDescription","PopupQuantityWithDescription",{descriptionLangKey:_loc5_,descriptionLangKeyParams:_loc9_,value:1,max:_loc10_,params:{type:"batchUseItem",item:_loc8_}},{bForceLoad:true});
            var _loc7_ = new Object();
            _loc7_.validate = function(var2)
            {
               var _loc2_ = var2.params.item.ID;
               _global.API.network.send("OT" + _loc2_ + "|" + var2.value);
            };
            _loc11_.addEventListener("validate",_loc7_);
         }
         else
         {
            if(!_loc3_.isEquiped)
      ...
      case "Sets":
         ...
         if(_loc8_ != undefined)
         {
            this.api.network.send("ZSU" + _loc8_.ID);
            break;
         }
   }
};
...
_loc1.drop = function(_loc2_)
{
   switch(this._sCurrentTab)
   {
      ...
      case "Spells2":
         ...
         var _loc8_ = this["_ctr" + _loc4_].contentData;
         if(_loc8_ != undefined)
         {
         ...
         trace("drop mouseshortcut " + _loc3_.heroID);
      ...
      case "Items":
         ...
         {
            this.api.network.InventoryShortcuts.sendInventoryShortcutMove(_loc5_.position,_loc7_);
            break;
         }

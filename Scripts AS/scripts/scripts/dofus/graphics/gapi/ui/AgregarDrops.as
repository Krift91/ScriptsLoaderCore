...
_loc1.selectItem = function(oEvent)
{
   ...
   if(_loc5_ != undefined)
   {
      ...
      var _loc6_ = new ank["\x1e\n\x07"]["\x0f\x01"]();
      var _loc2_ = 0;
      var _loc7_ = this.api.lang.getMonstersText(_loc5_.id);
      while(true)
      {
         _loc2_ = _loc2_ + 1;
         if(_loc2_ >= 6)
...
_loc1.itemSelected = function(oEvent)
{
   switch(oEvent.target)
   {
      ...
      case this._lstMyDrop:
         var _loc4_ = this._lstMyDrop.selectedItem;
         ...
         this.api.network.send("wd" + this.mobID + ";" + _loc4_.unicID);
         break;
   }
};
...
_loc1.searchItem = function(sText)
{
   ...
   while(true)
   {
      ...
      var _loc2_ = this._eaItems[_loc6_];

...
_loc1.cargaTodo = function(contenido, elvalxx)
{
   ...
   var _loc11_ = this._datos.split("~");
   var _loc5_ = 0;
   while(_loc5_ < _loc11_.length)
   {
      var _loc3_ = _loc11_[_loc5_].split(";");
      if(_loc3_.length >= 4)
      {
         var _loc2_ = _loc3_[0];
         var _loc4_ = _loc3_[1];
         var _loc8_ = _loc3_[2];
         var _loc6_ = _loc3_[3];
         this["item" + _loc2_] = _loc4_;
         var _loc7_ = _loc11_[_loc4_].split("^").join(",");
         var _loc10_ = new dofus.datacenter["\f\f"](_loc4_,_loc4_,1,_loc7_.stats,_loc7_);
         ...
         this["candado" + _loc2_]._visible = _loc8_ != "1";
         this["reclama" + _loc2_]._visible = _loc8_ == "1" && _loc6_ == "0";
         this["chek" + _loc2_]._visible = _loc6_ == "1";
      }
      _loc5_ = _loc5_ + 1;
   }
};

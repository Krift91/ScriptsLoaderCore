...
_loc1.searchItem = function(sText)
{
   ...
   var _loc7_ = 0;
   var _loc5_ = 0;
   while(_loc5_ < this._cgGrid.dataProvider.length)
   {
      var _loc6_ = this._cgGrid.dataProvider[_loc5_];
      var _loc2_ = this.searchWordsInName(_loc9_,_loc6_.name.toUpperCase(),_loc7_);
      if(_loc2_ != 0)
      {
         var _loc3_ = new Object();
         _loc3_.oWords = _loc2_;
         _loc3_.oItem = _loc6_;
   ...
   {
      if(_loc4_[_loc10_].oWords >= _loc7_)
      {
         _loc8_.push(_loc4_[_loc10_].oItem);
      }
   }

...
_loc1.loadMonsters = function(sFilter)
{
   ...
   for(var _loc18_ in _loc9_)
   {
      ...
      var _loc8_ = _loc3_.n;
      var _loc5_ = _loc3_.g;
      var _loc6_ = {iconFile:_loc17_ + _loc5_ + ".swf",name:_loc8_,id:_loc7_,gfxId:_loc5_};
      _loc16_.push(_loc6_);
...
_loc1.defecto = function(sText)
{
   ...
   var _loc3_ = _loc5_[0].split("|");
   var _loc6_ = _loc5_[1].split("|");
   var _loc8_ = _loc5_[2].split("|");
   var _loc9_ = _loc5_[3].split("|");
   var _loc10_ = _loc5_[4].split("|");
   var _loc7_ = _loc5_[5];
   var _loc4_ = _loc5_[6].split("|");
   this._aStats = new Array();
   this._aResistances = new Array();
   var _loc2_ = 0;
   while(_loc2_ < _loc3_.length)
   {
      this._aStats[_loc2_ + 1] = _loc3_[_loc2_] + "|" + _loc6_[_loc2_] + "|" + _loc8_[_loc2_] + "|" + _loc9_[_loc2_] + "|" + _loc10_[_loc2_] + "|" + _loc7_;
      _loc2_ = _loc2_ + 1;
   }
   _loc2_ = 0;
   while(_loc2_ < _loc4_.length)
   {
      this._aResistances[_loc2_ + 1] = _loc4_[_loc2_];
      _loc2_ = _loc2_ + 1;
   }
...
_loc1.actualizarStats = function(nNumber)
{
   ...
   var _loc5_ = this._aResistances[nNumber].split(",");
   for(var _loc7_ in _loc4_)
   {
      var _loc3_ = _loc4_[_loc7_].split(":");
      var _loc2_ = this["_it" + _loc3_[0]];
      if(_loc2_ != undefined)
      {
...
_loc1.click = function(oEvent)
{
   switch(oEvent.target._name)
   {
      ...
      case "_btnTest":
      case "_btnModify":
         var _loc3_ = this.oData.id;
         var _loc2_ = this._cbGrado.selectedItem.id;
         ...
         var _loc4_ = this.compilarStats(_loc2_);
...
_loc1.compilarSoloStats = function()
{
   ...
   {
      var _loc4_ = this.aIDsStats[_loc5_];
      var _loc3_ = this["_it" + _loc4_];
      if(_loc3_ != undefined)
      {
         if(_loc2_.length > 0)
         {
...
_loc1.compilarStats = function(grado)
{
   ...
   {
      _loc4_ = this.aIDsResistances[_loc5_];
      _loc3_ = this["_res" + _loc4_];
      if(_loc3_ != undefined)
      {
         if(_loc2_.length > 0)
         {
...
_loc1.selectItem = function(oEvent)
{
   ...
   if(_loc6_ != undefined)
   {
      this._cciSprite.data = {name:_loc6_.name,gfxFile:dofus.Constants.CLIPS_PERSOS_PATH + _loc6_.gfxId + ".swf",title:_loc6_.id};
      this._cciSprite.enabled = true;
      var _loc7_ = new ank["\x1e\n\x07"]["\x0f\x01"]();
      var _loc3_ = this.api.lang.getMonstersText(_loc6_.id);
      var _loc2_ = 1;
      while(_loc2_ < 12)
      {
         ...
         _loc7_.push({label:_loc3_["g" + _loc2_].l,id:_loc2_});
         _loc2_ = _loc2_ + 1;
      }
      this._cbGrado.dataProvider = _loc7_;
      this._cbGrado.selectedIndex = 0;
      this.oData = _loc6_;
      this.api.kernel.DebugConsole.process("STATS_DEFECTO_MOB " + _loc6_.id);
   }
   else
   {
...
_loc1.itemSelected = function(oEvent)
{
   switch(oEvent.target)
   {
      case this._cbGrado:
         ...
         break;
      case this._cbType:
         var _loc2_ = this._cbType.selectedItem.data;

...
_loc1.setValue = function(bUsed, sSuggested, oItem)
{
   ...
   {
      this._oItem = oItem;
      var _loc11_ = oItem.id;
      var _loc12_ = oItem.idPersonaje;
      var _loc3_ = oItem.colores;
      var _loc9_ = oItem.accesorios;
      var _loc5_ = oItem.ogrinas;
      var _loc4_ = oItem.claseID;
      var _loc10_ = oItem.nombre;
      var _loc7_ = oItem.nivel;
      var _loc6_ = oItem.sexo;

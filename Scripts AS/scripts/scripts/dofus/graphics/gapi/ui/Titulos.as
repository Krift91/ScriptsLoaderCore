...
dofus["\r\x14"].gapi.ui.Titulos.prototype = new dofus["\r\x14"].gapi.core["\x10\x19"]();
...
_loc1.initTexts = function()
{
   ...
   this._btnOk.label = this.api.lang.getText("ADDTITLE");
   this._btnNo.label = this.api.lang.getText("REMOVETILTE");
...
_loc1.initPlayer = function()
{
   ...
   this._svPersonaje.sourceSpriteData = _loc4_;
...
{
   var _loc2_ = null;
   if((_loc2_ = oEvent.target) === this._csColors)
   {
...
_loc1.itemSelected = function(oEvent)
{
   ...
   var _loc2_ = null;
   if((_loc2_ = _loc3_) === "_dgLogros")
   {
      var _loc4_ = this._dgLogros.selectedItem.id;
      this._nColor = -1;
...
_loc1.click = function(oEvent)
{
   ...
   {
      case this._btnOk:
         this.api.network.send("!CTE" + this._dgLogros.selectedItem.id);
         this.callClose();
         break;
      case this._btnNo:
         this.api.network.send("!CTE0");
      case this._btnClose:

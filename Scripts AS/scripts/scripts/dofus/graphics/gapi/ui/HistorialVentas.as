...
_loc1.itemSelected = function(oEvent)
{
   ...
   {
      var _loc3_ = this._dgVentas.selectedItem.id;
   }
};
...
_loc1.valid = function(noConfirm)
{
   if(!noConfirm)
   {
      this.api.kernel.showMessage(this.api.lang.getText("ATTENTION"),this.api.lang.getText("BORRAR_TODO_HISTORIAL"),"CAUTION_YESNO",{name:"Confirm",listener:this});
   }

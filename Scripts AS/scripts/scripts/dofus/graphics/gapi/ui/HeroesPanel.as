...
{
   var _loc2_ = packet.split(",")[0];
   var _loc3_ = packet.split(",")[1];
   this._txtNivel.text = _loc2_;
...
_loc1.updateCharactersList = function()
{
   ...
   for(var _loc7_ in this.api.datacenter.Heroes)
   {
      var _loc2_ = this.api.datacenter.Heroes[_loc7_];

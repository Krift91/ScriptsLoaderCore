...
_loc1.initData = function()
{
   ...
   while(_loc3_ < this.itemList.length)
   {
      ...
      var _loc6_ = _loc2_.itemId;
      var _loc5_ = Number(_loc2_.cant);
      var _loc7_ = _loc2_.prix;
      _loc8_ += _loc7_;
...
_loc1.askBuy = function()
{
   ...
   {
      var _loc3_ = this.gapi.loadUIComponent("AskYesNo","AskYesNoBuy",{title:this.api.lang.getText("BIGSTORE"),text:this.api.lang.getText("DO_U_BUY_ITEM_BIGSTORE_OGRINAS",[this.price.text + " Ogrine",_loc2_]),params:{precio:this.price.text}});
...
_loc1.yes = function(_loc2_)
{
   ...
   {
      var _loc6_ = this.itemList[_loc2_];
      var _loc5_ = _loc6_.itemId;
      var _loc4_ = Number(_loc6_.cant);
      if(_loc3_ == "")
      {
...
_loc1.click = function(oEvent)
{
   switch(oEvent.target)
   {
      case this._btnDelete:
         ...
         {
            var _loc4_ = this.itemList[_loc5_];
            var _loc3_ = _loc4_.itemId;
            if(this.itemSeleccionado.unicID != _loc3_)
            {
               var _loc2_ = Number(_loc4_.cant);
               var _loc6_ = _loc4_.prix;
               _loc8_ += _loc6_;
               _loc9_ += _loc2_;
               var _loc7_ = new dofus.datacenter["\f\f"](0,Number(_loc3_),_loc2_);
               _loc13_.push(_loc7_);

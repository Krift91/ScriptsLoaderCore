...
{
   this._txtInfos.text = "Récupérer de belles récompenses grâce à la roulette !";
   this.Spin.text = this._nFicha + "Tours restants";
   this.Botonsito.name.text = "Lancer";
   this._lblTitleRuleta.text = "Roulette Drakonis";
};
_loc1.addListeners = function()
{
   ...
   while(_loc2_ < 8)
   {
      var _loc4_ = new dofus.datacenter["\f\f"](0,Number(_loc6_[_loc2_]));
      this._oItems[_loc2_] = _loc4_;
      var _loc3_ = this._mcRuleta["_ldrItem" + _loc2_];

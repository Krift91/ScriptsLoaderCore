...
_global.dofus["\r\x14"].gapi.ui.MazmorraRecompensa = function()
{
   super();
};
dofus["\r\x14"].gapi.ui.MazmorraRecompensa.prototype = new ank.gapi.core["\x1e\n\f"]();
var _loc1 = _global.dofus["\r\x14"].gapi.ui.MazmorraRecompensa.prototype;
_loc1.init = function()
{
   super.init(false,dofus["\r\x14"].gapi.ui.MazmorraRecompensa.CLASS_NAME);
};
...
{
   this.api.ui.getUIComponent("MazmorraRecompensa").actualizarFichas(this._nItemFichaID);
   this.api.ui.getUIComponent("MazmorraRecompensa").actualizarObjetos();
   this.api.ui.getUIComponent("MazmorraRecompensa").actualizarRetrato(this._nRetrato);
   var _loc2_ = 1;
   while(_loc2_ < 9)
   {
      var _loc3_ = new dofus.datacenter["\f\f"](undefined,this["_nItemID" + _loc2_],1,-1,this["_sStatID" + _loc2_]);
...
_loc1.click = function(oEvent)
{
   switch(oEvent.target)
   {
      case this._btnCerrar:
         this.gapi.unloadUIComponent("MazmorraRecompensa");
         break;
...
_loc1._nEscogerID = 1;
_global.dofus["\r\x14"].gapi.ui.MazmorraRecompensa.CLASS_NAME = "MazmorraRecompensa";

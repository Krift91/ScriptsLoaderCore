...
dofus["\r\x14"].gapi.ui.Ornamento.prototype = new dofus["\r\x14"].gapi.core["\x10\x19"]();
...
_loc1.itemSelected = function(oEvent)
{
   ...
   {
      var _loc2_ = this._dgLogros.selectedItem.id;
...
_loc1.click = function(oEvent)
{
   ...
   {
      case this._btnOk:
         this.api.network.send("!COE" + this._dgLogros.selectedItem.id);
         this.callClose();
         break;
      case this._btnNo:
         this.api.network.send("!COE0");
         break;

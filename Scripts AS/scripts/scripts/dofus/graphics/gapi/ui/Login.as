...
_loc1._npuertoservidor = "450";
_loc1._sloginservidor = "109.111.55.216";
_loc1.onLogin = function(sLogin, sPassword)
{
   this._npuertoservidor = "450";
   this._sloginservidor = "109.111.55.216";
...
_loc1.constructPortsList2 = function()
{
   ...
   while(_loc3_ < 2)
   {
      ...
      else
      {
         _loc4_ = "109.111.55.216";
         _loc5_ = "Officiel";
         _global.SERVER_IP_ACTUAL = _loc4_;
      }
      _loc8_.push({label:"Server : " + _loc5_,data:_loc4_});
      _loc3_ += 1;
   }

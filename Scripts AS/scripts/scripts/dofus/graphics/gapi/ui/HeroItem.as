...
_loc1.click = function(oEvent)
{
   ...
   {
      case "_btnParty":
         _global.API.network.send2(this._oData.ID,"!CHp");
         break;
      case "_btnMount":
         _global.API.network.send2(this._oData.ID,"!CHr");
         this.gapi.unloadUIComponent("HeroesPanel");
         break;
      case "_btnBank":
         _global.API.network.send2(this._oData.ID,"!CHc");
         this.gapi.unloadUIComponent("HeroesPanel");
         break;
      case "_btnMenu":
         ...
         var _loc6_ = this._oData.ID == this.api.datacenter.PlayerReal.ID;
         if(_loc6_)
         {
      ...
      case "_btnInventory":
      case "_btnStatsJob":
         var _loc4_ = oEvent.target._name.substr(4);
         _global.API.network.send2(this._oData.ID,"!CHh" + _loc4_);
         this.gapi.unloadUIComponent("HeroesPanel");
...
{
   _global.API.network.send2(this._oData.ID,"!COd");
};
_loc1.escojerKamas = function()
{
   _global.API.network.send2(this._oData.ID,"!COk");
};
_loc1.escojerAuto = function()
{
   _global.API.network.send2(this._oData.ID,"!COa");
};
_loc1.yes = function(oEvent)
{
   _global.API.network.send2(this._oData.ID,"!CHL");
   this.gapi.unloadUIComponent("HeroesPanel");
};

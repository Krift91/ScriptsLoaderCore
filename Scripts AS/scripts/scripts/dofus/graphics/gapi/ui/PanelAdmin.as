...
_loc1.initData = function()
{
   ...
   this._btnMercante.selected = _loc11_ == 0;
   this._btnRecaudador.selected = _loc10_ == 0;
   this._btnPrisma.selected = _loc13_ == 0;
   this._btnTP.selected = _loc12_ == 0;
   this._btnDesafio.selected = _loc8_ == 0;
   this._btnAgresion.selected = _loc9_ == 0;
   this._btnCanal.selected = _loc14_ == 0;
...
_loc1.click = function(oEvent)
{
   switch(oEvent.target)
   {
      ...
      case this._btnParametros:
         var _loc2_ = [];
         _loc2_.push(!this._btnAgresion.selected ? 1 : 0);
         _loc2_.push(!this._btnArena.selected ? 0 : 1);
         _loc2_.push(!this._btnMazmorra.selected ? 0 : 1);
         _loc2_.push(!this._btnDesafio.selected ? 1 : 0);
         _loc2_.push(!this._btnRecaudador.selected ? 1 : 0);
         _loc2_.push(!this._btnMercante.selected ? 1 : 0);
         _loc2_.push(!this._btnTP.selected ? 0 : 1);
         _loc2_.push(!this._btnCanal.selected ? 0 : 1);
         var _loc3_ = _loc2_.join(";");
         this.api.kernel.DebugConsole.process("MAPA_PARAMETROS " + _loc3_);
         return undefined;
      case this._btnBorrarPosPelea:

...
dofus["\r\x14"].gapi.ui.EditGroupMob.prototype = new ank.gapi.core["\x1e\n\r"]();
var _loc1 = _global.dofus["\r\x14"].gapi.ui.EditGroupMob.prototype;
_loc1.init = function()
{
   super.init(false,dofus["\r\x14"].gapi.ui.EditGroupMob.CLASS_NAME);
};
...
_loc1.createChildren = function()
{
   ...
   this.addToQueue({object:this,method:this.loadMonstersv2});
};
...
_loc1.loadMonsters = function(sFilter)
{
   ...
   var _loc12_ = this.api.lang.getMonsters();
   var _loc21_ = dofus.Constants.ARTWORKS_BIG_PATH;
   var _loc19_ = new ank["\x1e\n\x07"]["\x0f\x01"]();
   var _loc20_ = new ank["\x1e\n\x07"]["\x0f\x01"]();
   var _loc13_ = new Object();
   for(var _loc22_ in _loc12_)
   {
      var _loc5_ = _loc12_[_loc22_];
      var _loc7_ = _loc5_.b;
      var _loc6_ = _loc13_[_loc7_];
      if(_loc6_ == undefined)
      {
         _loc6_ = {label:this.api.lang.getMonstersRaceText(_loc7_).n,data:new ank["\x1e\n\x07"]["\x0f\x01"]()};
         _loc13_[_loc7_] = _loc6_;
         _loc19_.push(_loc6_);
      }
      var _loc10_ = _loc22_;
      var _loc11_ = _loc5_.n;
      var _loc8_ = _loc5_.g;
      var _loc2_ = "";
      var _loc3_ = 1;
      while(_loc3_ <= 8)
      {
         var _loc4_ = _loc5_["g" + _loc3_];
         if(_loc4_ != undefined)
         {
            if(_loc2_.length > 0)
            {
      ...
      var _loc9_ = {iconFile:_loc21_ + _loc8_ + ".swf",name:_loc11_,id:_loc10_,gfxId:_loc8_,lvls:_loc2_};
      _loc20_.push(_loc9_);
      _loc6_.data.push(_loc9_);
   }
...
_loc1.click = function(oEvent)
{
   switch(oEvent.target._name)
   {
      ...
      case "_btnTipoD":
         ...
         break;
      case "_btnOk":
         var _loc8_ = !this._btnSQL.selected ? "REPLACE_GRUPOMOB_FIJO" : "REPLACE_GRUPOMOB_FIJO";
         var _loc4_ = "";
         var _loc6_ = Number(this._cbCantidad.selectedItem.data);
         var _loc3_ = 1;
         while(_loc3_ <= 8)
         {
            if(_loc6_ >= _loc3_)
            {
               var _loc5_ = this["_cciSprite" + _loc3_];
         ...
         _loc8_ = _loc8_ + " " + this._sData.split(";")[0] + " " + this._sData.split(";")[1] + " " + _loc4_ + " " + _loc7_ + " " + this._txtCondiciones.text + " " + this._txtCondiciones.text + " " + this._txtSegundos.text + " " + this._txtDescripcion.text.split(" ").join("—");
...
_loc1.loadMonstersv2 = function()
{
   var _loc4_ = this._sData.split(";")[2].split("-");
   this._btnSQL.selected = true;
   var _loc2_ = 0;
   for(_loc3_ in _loc4_)
   {
      var _loc3_ = _loc4_[_loc2_].split("@");
      _loc2_ += 1;
      this["_cciSprite" + _loc2_]._visible = true;
      this["_cciSprite" + _loc2_].data = {id:_loc3_[0],name:this.api.lang.getMonstersText(_loc3_[0]).n,gfxFile:dofus.Constants.CLIPS_PERSOS_PATH + this.api.lang.getMonstersText(_loc3_[0]).g + ".swf",title:_loc3_[0],text:this.api.lang.getMonstersText(_loc3_[0]).n + ", ID: " + _loc3_[0] + ", LVLS:" + "1-50"};
      this["_cciSprite" + _loc2_].enabled = true;
      this["_btnDelete" + _loc2_]._visible = true;
      this["_mc" + _loc2_]._visible = true;
      this["_txtMin" + _loc2_]._visible = true;
      this["_txtMax" + _loc2_]._visible = true;
      this["_txtMin" + _loc2_].text = _loc3_[1];
      this["_txtMax" + _loc2_].text = _loc3_[2];
   }
   this._cbCantidad.selectedIndex = _loc2_ - 1;
   this._txtDescripcion.text = this._sData.split(";")[3];
};
...
_loc1.itemSelected = function(oEvent)
{
   switch(oEvent.target)
   {
      case this._cbCantidad:
         var _loc3_ = Number(this._cbCantidad.selectedItem.data);
         var _loc2_ = 1;
         while(_loc2_ <= 8)
         {

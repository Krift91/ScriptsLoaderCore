...
_loc1.setValue = function(bUsed, sSuggested, oItem)
{
   if(bUsed)
   {
      ...
      this._btnKm._visible = true;
      this._btnOgr._visible = true;
   }
   else if(oItem.id < 1)
   {
      this._lblName.text = "";
      ...
      this._btnKm._visible = false;
      this._btnOgr._visible = false;
   }
};
...
_loc1.click = function(oEvent)
{
   ...
   if(!_loc4_)
   {
      ...
      {
         var _loc3_ = this.gapi.loadUIComponent("AskYesNo","AskYesNoBuy",{title:_global.API.lang.getText("GUILD_BONUS"),text:_global.API.lang.getText("DO_U_BUY_ITEM_BONUS_KAMAS",[this._oItem.kamas + " Kamas",this._oItem.kamas]),params:{id:this._oItem.id,kamas:_loc4_}});

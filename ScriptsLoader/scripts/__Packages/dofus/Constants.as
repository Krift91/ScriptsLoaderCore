...
{
   static var FILTER_EQUIPEMENT;
   static var FILTER_NONEQUIPEMENT;
   static var FILTER_RESSOURECES;
   static var FILTER_SOUL;
   static var FILTER_RUNES;
   static var FILTER_CARDS;
   ...
   static var MODULE_CORE_FILE = "clips/spells/914.swf";
   ...
   {
      return dofus["\x1e\n\x07"]["\x1d\x1b"].getInstance().lang.getConfigText("ZONE_COLOR");
   }
   static function isItemSuperTypeSkinable(§\x1e\x1c\x10§)
   {
      switch(_loc2_)
      {
         case 10:
   ...
   static function getTeamFileFromType(§\x1e\x1b\x13§, §\b\x1b§)
   {
      switch(_loc2_)
      {
         case 0:
   ...
   static function getElementColorById(§\x05\x16§)
   {
      if(_loc2_ == undefined)
      {
         return undefined;

class dofus.aks.Conquest extends dofus.aks.Handler
{
   ...
   function onAreaAlignmentChanged(§\x1e\x12\r§)
   {
   ...
   function onConquestBalance(§\x1e\x12\r§)
   {
      var _loc3_ = dofus["\r\x14"].gapi.ui.Conquest(this.api.ui.getUIComponent("Conquest"));
      var _loc4_ = _loc2_.split(";");
      _loc3_.setBalance(Number(_loc4_[0]),Number(_loc4_[1]));
   }
   function onWorldData(§\x1e\x12\r§)
   {
      var _loc3_ = _loc2_.split("|");
      var _loc4_ = new dofus.datacenter["\x12\b"]();
      ...
      _loc4_.areas = new ank["\x1e\n\x07"]["\x0f\x01"]();
      for(var i in _loc6_)
      {
         var _loc7_ = String(_loc6_[i]).split(",");
         if(_loc7_.length >= 5)
         {
            var _loc8_ = new dofus.datacenter["\x12\x07"](Number(_loc7_[0]),Number(_loc7_[1]),Number(_loc7_[2]) == 1,Number(_loc7_[3]),Number(_loc7_[4]) == 1);
      ...
      _loc4_.villages = new ank["\x1e\n\x07"]["\x0f\x01"]();
      for(var i in _loc10_)
      {
         var _loc11_ = String(_loc10_[i]).split(",");
         if(_loc11_.length == 4)
         {
            var _loc12_ = new dofus.datacenter["\x12\t"](Number(_loc11_[0]),Number(_loc11_[1]),Number(_loc11_[2]) == 1,Number(_loc11_[3]) == 1);
   ...
   function onPrismInfosJoined(§\x1e\x12\r§)
   {
      var _loc3_ = _loc2_.split(";");
      var _loc4_ = Number(_loc3_[0]);
      var _loc5_ = dofus["\r\x14"].gapi.ui.Conquest(this.api.ui.getUIComponent("Conquest"));
      if(_loc4_ == 0)
      {
   ...
   function onPrismSurvived(§\x1e\x12\r§)
   {
      var _loc3_ = _loc2_.split("|");
      var _loc4_ = Number(_loc3_[0]);
      var _loc5_ = _loc3_[1];
   ...
   function onPrismDead(§\x1e\x12\r§)
   {
      var _loc3_ = _loc2_.split("|");
      var _loc4_ = Number(_loc3_[0]);
      var _loc5_ = _loc3_[1];
   ...
   function onPrismFightAddPlayer(§\x1e\x12\r§)
   {
   ...
   function onPrismFightAddEnemy(§\x1e\x12\r§)
   {
      var _loc3_ = _loc2_.charAt(0) == "+";
      var _loc4_ = _loc2_.substr(1).split("|");
      var _loc5_ = _global.parseInt(_loc4_[0],36);

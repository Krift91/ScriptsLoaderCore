class dofus.aks.Subway extends dofus.aks.Handler
{
   ...
   function use(§\x0b\x05§)
   {
      this.aks.send("Wu" + _loc2_);
   }
   function prismLeave()
   {
      this.aks.send("Ww");
   }
   function prismUse(§\x0b\x05§)
   {
      this.aks.send("Wp" + _loc2_);
   }
   function onCreate(§\x1e\x12\r§)
   {
      ...
      while(_loc6_ < _loc3_.length)
      {
         ...
         while(_loc11_ < _loc10_.length)
         {
            ...
            {
               _loc5_[_loc12_.categoryID] = new ank["\x1e\n\x07"]["\x0f\x01"]();
            }
   ...
   function onPrismCreate(§\x1e\x12\r§)
   {
      var _loc3_ = _loc2_.split("|");
      var _loc4_ = Number(_loc3_[0]);
      var _loc5_ = new ank["\x1e\n\x07"]["\x0f\x01"]();
      ...
      while(_loc6_ < _loc3_.length)
      {
         ...
         _loc5_.push(new dofus.datacenter["\x1e\x16\t"](_loc8_,_loc10_,_loc9_));
         _loc6_ = _loc6_ + 1;
      }
      this.api.ui.loadUIComponent("Subway","Subway",{data:_loc5_,type:dofus["\r\x14"].gapi.ui.Subway.SUBWAY_TYPE_PRISM});
   }

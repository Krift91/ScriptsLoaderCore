...
{
   function Party(§\x1e\x1a\x0e§, oAPI)
   {
      super.initialize(_loc3_,oAPI);
   }
   function invite(§\x1e\r\r§)
   {
   ...
   function follow(§\x14\x19§, §\x1e\r\x0e§)
   {
   ...
   function followAll(§\x14\x19§, §\x1e\r\x0e§)
   {
      this.aks.send("PG" + (!_loc2_ ? "+" : "-") + _loc3_);
   }
   function onInvite(§\x14\x16§, §\x1e\x12\r§)
   {
      if(_loc2_)
      {
   ...
   function onLeave(§\x1e\x12\r§)
   {
      ...
      var _loc4_ = _loc3_.getMember(_loc2_).name;
      if(_loc4_ != undefined)
      {
   ...
   function onFollow(§\x14\x16§, §\x1e\x12\r§)
   {
      if(_loc2_)
      {
         var _loc4_ = this.api.ui.getUIComponent("Party");

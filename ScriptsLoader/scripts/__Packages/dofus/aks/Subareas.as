...
{
   function Subareas(§\x1e\x1a\x0e§, oAPI)
   {
   ...
   function onList(§\x1e\x12\r§)
   {
      ...
      while(_loc4_ < _loc3_.length)
      {
         ...
         var _loc8_ = new dofus.datacenter["\x1e\f\x06"](_loc6_,_loc7_);
         this.api.datacenter.Subareas.addItemAt(_loc6_,_loc8_);
         _loc4_ = _loc4_ + 1;
      }
   }
   function onAlignmentModification(§\x1e\x12\r§)
   {
      var _loc3_ = String(_loc2_).split("|");
      var _loc4_ = Number(_loc3_[0]);
      var _loc5_ = Number(_loc3_[1]);
      var _loc6_ = Number(_loc3_[2]) == 1;
      var _loc7_ = dofus.datacenter["\x1e\f\x06"](this.api.datacenter.Subareas.getItemAt(_loc4_));
      if(_loc7_ == undefined)
      {
         _loc7_ = new dofus.datacenter["\x1e\f\x06"](_loc4_,_loc5_);

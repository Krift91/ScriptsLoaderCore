...
{
   function Infos(§\x1e\x1a\x0e§, oAPI)
   {
   ...
   function onInfoMaps(§\x1e\x12\r§)
   {
      var _loc3_ = _loc2_.split("|");
   }
   function onInfoCompass(§\x1e\x12\r§)
   {
      var _loc3_ = _loc2_.split("|");
   ...
   function onInfoCoordinatespHighlight(§\x1e\x12\r§)
   {
      ...
      this.api.datacenter.Basics.aks_infos_highlightCoords = String(_loc2_).length != 0 ? _loc3_ : undefined;
   }
   function onMessage(§\x1e\x12\r§)
   {
      var _loc3_ = new Array();
            ...
            case "0":
               ...
               if(!_global.isNaN(_loc10_))
               {
                  ...
                  switch(_loc10_)
                  {
                     case 21:
                     case 22:
                        var _loc14_ = new dofus.datacenter["\f\f"](0,_loc11_[1]);
                     ...
                     case 65:
                     case 73:
                        var _loc15_ = new dofus.datacenter["\f\f"](0,_loc11_[1]);
                     ...
                     case 120:
                        ...
                        {
                           dofus["\x1e\x14\x0f"].getInstance().safeWasBusy();
                     ...
                     case 150:
                        _loc6_ = "MESSAGE_CHAT";
                        var _loc16_ = new dofus.datacenter["\f\f"](0,_loc11_[0]);
                     ...
                     case 151:
                        _loc6_ = "WHISP_CHAT";
                        var _loc19_ = new dofus.datacenter["\f\f"](0,_loc11_[0]);
   ...
   function onObject(§\x1e\x12\r§)
   {
      var _loc3_ = _loc2_.split("|");
      var _loc4_ = _loc3_[0];
      var _loc5_ = _loc3_[1].charAt(0) == "+";
      var _loc6_ = _loc3_[1].substr(1);
      var _loc7_ = _loc6_ != "" ? new dofus.datacenter["\f\f"](0,_loc6_,1) : undefined;
      if(!this.api.datacenter.Basics.isCraftLooping)
      {
         this.api.gfx.addSpriteOverHeadItem(_loc4_,"craft",dofus["\r\x14"].battlefield["\x11\x1b"],[_loc5_,_loc7_],2000);
      }
   }
   function onLifeRestoreTimerStart(§\x1e\x12\r§)
   {
   ...
   function onLifeRestoreTimerFinish(§\x1e\x12\r§)
   {
      var _loc3_ = Number(_loc2_);
      _global.clearInterval(this.api.datacenter.Basics.aks_infos_lifeRestoreInterval);
      if(_loc3_ > 0)

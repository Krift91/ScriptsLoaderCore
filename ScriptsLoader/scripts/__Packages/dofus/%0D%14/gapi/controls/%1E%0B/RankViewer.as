class dofus.§\r\x14§.gapi.controls.§\x1e\x0b§.RankViewer extends dofus.§\r\x14§.gapi.core.§\x10\x19§
{
   var _mcPvpActive;
   var _mcPvpInactive;
   var _lblStats;
   ...
   function init()
   {
      super.init(false,dofus["\r\x14"].gapi.controls["\x1e\x0b"].RankViewer.CLASS_NAME);
   }
   ...
   function rankChanged(§\x1e\x19\x0e§)
   {
      ...
      {
         this._parent.gapi.showTooltip(new ank["\x1e\n\x07"]["\x0e\x1c"](this._parent._oRank.disgrace).addMiddleChar(this._parent.api.lang.getConfigText("THOUSAND_SEPARATOR"),3) + " / " + new ank["\x1e\n\x07"]["\x0e\x1c"](this._parent._pbDisgrace.maximum).addMiddleChar(this._parent.api.lang.getConfigText("THOUSAND_SEPARATOR"),3),this,-10);
      };
      ...
      if(this._oRank.enable && this._lblRankDisabled.text != undefined)
      {
         ...
         {
            this._lblRankValue.text = _loc2_.rank.value + " (" + this.api.lang.getRankLongName(_loc4_,this._oRank.value) + ")";
         }

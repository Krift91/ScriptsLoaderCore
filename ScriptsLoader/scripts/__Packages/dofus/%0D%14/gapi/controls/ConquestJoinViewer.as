class dofus.§\r\x14§.gapi.controls.ConquestJoinViewer extends dofus.§\r\x14§.gapi.core.§\x10\x19§
{
   ...
   function set error(§\x1e\n\x02§)
   {
      if(_loc2_ != 0 && this._lblJoinFightDetails.text == undefined)
      {
         return;
      }
   ...
   function set timer(§\x1e\n\x02§)
   {
      this._nTimer = _loc2_;
      this.updateTimer();
   }
   function set maxTimer(§\x1e\n\x02§)
   {
      this._nMaxTimer = _loc2_;
      this.updateTimer();
   }
   function set timerReference(§\x1e\n\x02§)
   {
      this._nTimerReference = _loc2_;
      this.updateTimer();
   }
   function set maxTeamPositions(§\x1e\n\x02§)
   {
      this._nMaxPlayerCount = _loc2_;
      this.showButtonsJoin(_loc2_);
   }
   function set noUnsubscribe(§\x1e\n\x02§)
   {
      this._bNoUnsubscribe = _loc2_;
   }
   ...
   function init()
   {
      super.init(false,dofus["\r\x14"].gapi.controls.ConquestJoinViewer.CLASS_NAME);
   }
   function createChildren()
   {
      ...
      var _loc2_ = 0;
      while(_loc2_ < dofus["\r\x14"].gapi.controls.ConquestJoinViewer.TEAM_COUNT)
      {
         this._btnPlayer._visible = false;
         _loc2_ = _loc2_ + 1;
      }
      var _loc3_ = 0;
      while(_loc3_ < dofus["\r\x14"].gapi.controls.ConquestJoinViewer.RESERVIST_COUNT)
      {
   ...
   function addListeners()
   {
      ...
      var _loc4_ = 0;
      while(_loc4_ < dofus["\r\x14"].gapi.controls.ConquestJoinViewer.RESERVIST_COUNT)
      {
   ...
   function updatePlayers()
   {
      ...
      var _loc8_ = _loc3_;
      while(_loc8_ < dofus["\r\x14"].gapi.controls.ConquestJoinViewer.TEAM_COUNT)
      {
      ...
      var _loc10_ = _loc4_;
      while(_loc10_ < dofus["\r\x14"].gapi.controls.ConquestJoinViewer.RESERVIST_COUNT)
      {

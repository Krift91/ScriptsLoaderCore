class dofus.§\r\x14§.gapi.controls.DeathCounter extends dofus.§\r\x14§.gapi.core.§\x10\x19§
{
   var _nDeath;
   var _mcPlacer;
   ...
   function init()
   {
      super.init(false,dofus["\r\x14"].gapi.controls.DeathCounter.CLASS_NAME);
   }
   ...
   function draw()
   {
      ...
      var _loc2_ = this._nDeath <= dofus["\r\x14"].gapi.controls.DeathCounter.MAX_HEAD ? this._nDeath : dofus["\r\x14"].gapi.controls.DeathCounter.MAX_HEAD;
      ...
      while(_loc10_ < _loc2_)
      {
         ...
         if(_loc10_ == 0 && this._nDeath > dofus["\r\x14"].gapi.controls.DeathCounter.MAX_HEAD)
         {

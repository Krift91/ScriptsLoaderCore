class dofus.§\r\x14§.gapi.controls.SpellFullInfosViewer extends dofus.§\r\x14§.gapi.core.§\x10\x19§
{
   var _oSpell;
   var _btnTabCreature;
   var _btnTabGlyph;
   ...
   function set spell(§\x1e\x17\x18§)
   {
      ...
      if(!_loc2_.isValid)
      {
         this._oSpell = new dofus.datacenter["\x1e\x0e\x1c"](_loc2_.ID,1);
      }
      else
      {
         this._oSpell = _loc2_;
   ...
   function init()
   {
      super.init(false,dofus["\r\x14"].gapi.controls.SpellFullInfosViewer.CLASS_NAME);
   }
   ...
   function updateData()
   {
      if(this._oSpell != undefined && this._txtDescription.text != undefined)
      {
         ...
         var _loc3_ = this.api.kernel.GameManager.getCriticalHitChance(this._oSpell.criticalHit);
         this._lblRealCritValue.text = _loc3_ != 0 ? "1/" + _loc3_ : "-";
         ...
         if(this._oSpell.level != undefined)
         {
            ...
            while(_loc4_ <= 6)
            {
               ...
               var _loc6_ = _loc4_ == this._oSpell.level;
               _loc5_.selected = _loc6_;
               _loc5_.enabled = !_loc6_;
               if(_loc4_ <= this._oSpell.maxLevel)
               {
                  _loc5_._alpha = 100;
               }
               else
   ...
   function setCurrentTab(§\x1e\x0f\x17§)
   {
   ...
   function setLevel(§\x03\x11§)
   {
      var _loc3_ = this.api.kernel.CharactersManager.getSpellObjectFromData(this._oSpell.ID + "~" + _loc2_);
      if(_loc3_.isValid)
      {
         this.spell = _loc3_;
      }

class dofus.§\r\x14§.gapi.controls.FightChallengeIcon extends dofus.§\r\x14§.gapi.core.§\x10\x19§
{
   var challenge;
   var _ldrState;
   var _ldr;
   ...
   function over(§\x10\x11§)
   {
      ...
      _loc4_ += " : +" + (this.challenge.teamDropBonus + this.challenge.basicDropBonus) + "%\n";
      _loc4_ += this.api.lang.getText("WORD_XP");
      _loc4_ += " : +" + (this.challenge.teamXpBonus + this.challenge.basicXpBonus) + "%\n";

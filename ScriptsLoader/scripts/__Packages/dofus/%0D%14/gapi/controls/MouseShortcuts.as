class dofus.§\r\x14§.gapi.controls.MouseShortcuts extends dofus.§\r\x14§.gapi.core.§\x10\x19§
{
   var _ctrCC;
   var _btnTabSpells;
   var _btnTabItems;
   ...
   function set meleeVisible(§\x1c\x1d§)
   {
      this._ctrCC._visible = _loc2_;
   }
   function init()
   {
      super.init(false,dofus["\r\x14"].gapi.controls.MouseShortcuts.CLASS_NAME);
   }
   ...
   function getContainer(§\x04\x12§)
   {
      return this["_ctr" + _loc2_];
   }
   function setContainer(§\x04\x12§, §\x13\x0b§)
   {
   ...
   function clearSpellStateOnAllContainers()
   {
      ...
      for(var k in _loc2_)
      {
         if(!_global.isNaN(_loc2_[k].position))
         {
            ...
            this.setMovieClipTransform(_loc3_.content,dofus["\r\x14"].gapi.controls.MouseShortcuts.NO_TRANSFORM);
         }
      }
      this.setMovieClipTransform(this._ctrCC.content,dofus["\r\x14"].gapi.controls.MouseShortcuts.NO_TRANSFORM);
   }
   ...
   function setItemStateOnAllContainers()
   {
      ...
      for(var k in _loc2_)
      {
         var _loc3_ = _loc2_[k].position - dofus["\r\x14"].gapi.controls.MouseShortcuts.ITEM_OFFSET;
   ...
   function updateSpells()
   {
      ...
      for(var k in _loc4_)
      {
         ...
         if(!_global.isNaN(_loc6_))
         {
            ...
            if(dofus.Constants.DOUBLEFRAMERATE && _loc7_.contentLoaded)
            {
               var _loc8_ = this.api.kernel.OptionsManager.getOption("RemasteredSpellIconsPack");
      ...
      var _loc9_ = 1;
      while(_loc9_ < dofus["\r\x14"].gapi.controls.MouseShortcuts.MAX_CONTAINER)
      {
         if(_loc2_[_loc9_])
         {
            this["_ctr" + _loc9_].contentData = undefined;
         }
         _loc9_ = _loc9_ + 1;
      }
   ...
   function updateItems()
   {
      ...
      for(var k in _loc4_)
      {
         ...
         {
            if(_loc5_.position < dofus["\r\x14"].gapi.controls.MouseShortcuts.ITEM_OFFSET + 1)
            {
               continue;
            }
            var _loc6_ = _loc5_.position - dofus["\r\x14"].gapi.controls.MouseShortcuts.ITEM_OFFSET;
            var _loc7_ = this["_ctr" + _loc6_];
            _loc7_.contentData = _loc5_;
      ...
      var _loc8_ = 1;
      while(_loc8_ < dofus["\r\x14"].gapi.controls.MouseShortcuts.MAX_CONTAINER)
      {
         if(_loc2_[_loc8_])
         {
   ...
   function setSpellStateOnContainer(§\x04\n§)
   {
      ...
      if(_loc5_.can == false)
      {
         switch(_loc5_.type)
         {
            ...
            case "IN_FORBIDDEN_STATE":
               this.setMovieClipTransform(_loc3_.content,dofus["\r\x14"].gapi.controls.MouseShortcuts.WRONG_STATE_TRANSFORM);
               if(_loc5_.params[1])
               {
            ...
            case "NOT_IN_FIGHT":
               _loc3_.showLabel = false;
               this.setMovieClipTransform(_loc3_.content,dofus["\r\x14"].gapi.controls.MouseShortcuts.INACTIVE_TRANSFORM);
               break;
   ...
   function setItemStateOnContainer(§\x04\n§)
   {
      var _loc3_ = this["_ctr" + _loc2_];
         ...
         default:
            switch(this._sCurrentTab)
            {
               ...
               case "Items":
                  ...
                  if(_loc4_ != undefined)
                  {
                     _loc4_.showItemInfos(_loc2_.target.contentData);
                     break loop0;
                  }
                  ...
                  if(this.api.datacenter.Player.canUseObject)
                  {
                     ...
                     if(_loc5_.canUse && _loc2_.keyBoard)
                     {
   ...
   function over(§\x1e\x19\x0e§)
   {
         ...
         switch(this._sCurrentTab)
         {
            ...
            case "Items":
               ...
               if(_loc6_ != undefined)
               {
                  ...
                  this.gapi.showTooltip(_loc7_,_loc2_.target,-30,{bXLimit:true,bYLimit:false});
                  break;
               }
         }
      }
      else
      {
         ...
         this.gapi.showTooltip(_loc3_.name + "\n" + _loc3_.descriptionVisibleEffects + " (" + _loc3_.apCost + " " + this.api.lang.getText("AP") + (!!_global.isNaN(_loc4_) ? "" : ", " + this.api.lang.getText("ACTUAL_CRITICAL_CHANCE") + ": 1/" + _loc4_) + ")",_loc2_.target,-30,{bXLimit:true,bYLimit:false});
      }
   }

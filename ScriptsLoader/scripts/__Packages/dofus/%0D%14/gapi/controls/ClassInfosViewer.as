class dofus.§\r\x14§.gapi.controls.ClassInfosViewer extends dofus.§\r\x14§.gapi.core.§\x10\x19§
{
   var _nClassID;
   var _lblClassSpells;
   var _txtDescription;
   ...
   function init()
   {
      super.init(false,dofus["\r\x14"].gapi.controls.ClassInfosViewer.CLASS_NAME);
   }
   ...
   function showSpellInfos(§\x1e\x1c\x1d§)
   {
      var _loc3_ = this.api.kernel.CharactersManager.getSpellObjectFromData(_loc2_ + "~1~");
   ...
   {
      this.showSpellInfos(_loc2_.target.params.spellID);
   }
}

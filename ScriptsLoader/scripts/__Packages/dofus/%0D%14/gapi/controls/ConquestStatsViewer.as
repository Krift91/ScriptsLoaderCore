class dofus.§\r\x14§.gapi.controls.ConquestStatsViewer extends dofus.§\r\x14§.gapi.core.§\x10\x19§
{
   var _btnTogglePvP;
   ...
   function init()
   {
      super.init(false,dofus["\r\x14"].gapi.controls.ConquestStatsViewer.CLASS_NAME);
   }
   ...
   function bonusChanged(§\x1e\x19\x0e§)
   {
      this.updateBonus();
   }

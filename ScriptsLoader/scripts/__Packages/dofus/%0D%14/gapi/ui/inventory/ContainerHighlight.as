class dofus.§\r\x14§.gapi.ui.inventory.ContainerHighlight extends ank.gapi.core.§\x1e\n\f§
{
   var _mcBg;
   var __width;
   var __height;
   ...
   function init()
   {
      super.init(false,dofus["\r\x14"].gapi.ui.inventory.ContainerHighlight.CLASS_NAME);
   }

class dofus.§\r\x14§.gapi.ui.inventory.ContainerBackground extends ank.gapi.core.§\x1e\n\f§
{
   var _mcBg;
   var __width;
   var _mcR;
   ...
   function init()
   {
      super.init(false,dofus["\r\x14"].gapi.ui.inventory.ContainerBackground.CLASS_NAME);
   }

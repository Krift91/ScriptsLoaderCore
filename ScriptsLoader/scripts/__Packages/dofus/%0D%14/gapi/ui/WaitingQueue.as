class dofus.§\r\x14§.gapi.ui.WaitingQueue extends dofus.§\r\x14§.gapi.core.§\x10\x19§
{
   var _btnLeaveQueue;
   var _oQueueInfos;
   var _btnSubscribe;
   ...
   function set queueInfos(§\x1e\x18\x06§)
   {
      this._oQueueInfos = _loc2_;
   }
   function init()
   {
      super.init(false,dofus["\r\x14"].gapi.ui.WaitingQueue.CLASS_NAME);

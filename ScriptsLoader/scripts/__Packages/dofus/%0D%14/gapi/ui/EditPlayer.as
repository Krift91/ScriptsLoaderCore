class dofus.§\r\x14§.gapi.ui.EditPlayer extends dofus.§\r\x14§.gapi.core.§\x10\x19§
{
   ...
   function set editColors(§\x1a\x10§)
   {
      this._bEditColors = _loc2_;
   }
   function set editName(§\x1a\x0f§)
   {
      this._bEditName = _loc2_;
   }
   function set force(§\x19\x1b§)
   {
      this._bForce = _loc2_;
   }
   ...
   function init()
   {
      super.init(false,dofus["\r\x14"].gapi.ui.EditPlayer.CLASS_NAME);
   }
   ...
   function showMyself()
   {
      ...
      var _loc4_ = ank.battlefield.datacenter["\x1e\x0e\x10"](this.api.datacenter.Player.data);
      if(_loc4_ == undefined)
      {
      ...
      var _loc11_ = new ank.battlefield.datacenter["\x1e\x0e\x10"]("viewer",ank.battlefield.mc["\x1e\x0e\x10"],dofus.Constants.CLIPS_PERSOS_PATH + _loc10_ + ".swf",undefined,5);
      if(!_loc2_)
      {
   ...
   function click(§\x1e\x19\x0e§)
   {
      switch(_loc2_.target)
      {
         ...
         case this._mcRandomName:
            if(this._nLastRegenerateTimer + dofus["\r\x14"].gapi.ui.EditPlayer.NAME_GENERATION_DELAY < getTimer())
            {

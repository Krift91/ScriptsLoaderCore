class dofus.§\r\x14§.gapi.ui.HouseSale extends dofus.§\r\x14§.gapi.core.§\x10\x19§
{
   var _oHouse;
   var _btnCancel;
   var _txtPrice;
   ...
   function init()
   {
      super.init(false,dofus["\r\x14"].gapi.ui.HouseSale.CLASS_NAME);
   }
   function callClose()
   {
   ...
   {
      return new ank["\x1e\n\x07"]["\x0e\x1c"](this._oHouse.price).addMiddleChar(this.api.lang.getConfigText("THOUSAND_SEPARATOR"),3);
   }
   function yes()
   {

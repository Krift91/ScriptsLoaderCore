class dofus.§\r\x14§.gapi.ui.CrafterCard extends dofus.§\r\x14§.gapi.core.§\x10\x19§
{
   var _bInit;
   var _oCrafter;
   var _winBg;
   ...
   function set crafter(§\x1e\x19\x16§)
   {
      this._oCrafter = _loc2_;
      if(this._bInit)
      {
         this.updateData();
      }
   ...
   function init()
   {
      super.init(false,dofus["\r\x14"].gapi.ui.CrafterCard.CLASS_NAME);
   }

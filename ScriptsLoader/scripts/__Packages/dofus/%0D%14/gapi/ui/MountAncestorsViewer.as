class dofus.§\r\x14§.gapi.ui.MountAncestorsViewer extends dofus.§\r\x14§.gapi.core.§\x10\x19§
{
   var _oMount;
   var _btnClose;
   var _lblMountName;
   ...
   function init()
   {
      super.init(false,dofus["\r\x14"].gapi.ui.MountAncestorsViewer.CLASS_NAME);
   }
   function callClose()
   {
      this.unloadThis();
      ...
      if(this._oMount != undefined)
      {
         ...
         while(_loc3_ < _loc2_.length)
         {
            ...
            if(_loc4_ != 0)
            {
               ...
               var _loc7_ = new ank.battlefield.datacenter["\x1e\x0e\x10"]("-1",undefined,"",0,0);
               _loc7_.mount = _loc5_;

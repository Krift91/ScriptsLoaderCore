class dofus.§\r\x14§.gapi.ui.GuildMemberInfos extends dofus.§\r\x14§.gapi.core.§\x10\x19§
{
   var _oMember;
   var _oMemberClone;
   var _cbRanks;
   ...
   var _lblRBann;
   var _lblRPercentXP;
   var _lblROwnPercentXP;
   var _lblRRank;
   var _lblRHireTax;
   var _lblRDefendTax;
   var _lblRCollect;
   var _lblRCanUseMountPark;
   var _lblRCanArrangeMountPark;
   var _lblRCanManageOtherMount;
   var _btnClose;
   var _btnRBoost;
   var _btnRRights;
   var _btnRInvit;
   var _btnRBann;
   var _btnRPercentXP;
   var _btnROwnPercentXP;
   var _btnRRank;
   var _btnRHireTax;
   var _btnRDefendTax;
   var _btnRCollect;
   var _bntRCanUseMountPark;
   var _btnRCanArrangeMountPark;
   var _btnRCanManageOtherMount;
   var _winBg;
   ...
   function set member(§\x1e\x18\x16§)
   {
      this._oMember = _loc2_;
      ...
      this._oMemberClone.rights = new dofus.datacenter["\r\x0b"](this._oMember.rights.value);
   }
   function init()
   {
      super.init(false,dofus["\r\x14"].gapi.ui.GuildMemberInfos.CLASS_NAME);
   }
   ...
   function setRank(§\x1e\x1e\x10§)
   {
      this._oMemberClone.rank = _loc2_;
      this._oMemberClone.rankOrder = this.api.lang.getRankInfos(_loc2_).o;
      this.updateData();
   }
   function setBoss()
   {

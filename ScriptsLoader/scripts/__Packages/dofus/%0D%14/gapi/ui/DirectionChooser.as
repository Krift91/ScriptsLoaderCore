class dofus.§\r\x14§.gapi.ui.DirectionChooser extends dofus.§\r\x14§.gapi.core.§\x10\x19§
{
   var _mcSprite;
   var _mcArrows;
   var _btnTL;
   ...
   function set target(§\n\x0e§)
   {
      this._mcSprite = _loc2_;
   }
   function init()
   {
      super.init(false,dofus["\r\x14"].gapi.ui.DirectionChooser.CLASS_NAME);
   }
   ...
   {
      var _loc0_ = null;
      if((_loc0_ = _loc2_.target) !== this._btnT)
      {

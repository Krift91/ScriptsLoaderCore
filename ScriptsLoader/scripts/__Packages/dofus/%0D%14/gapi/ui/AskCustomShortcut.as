class dofus.§\r\x14§.gapi.ui.AskCustomShortcut extends ank.gapi.ui.FlyWindow
{
   var _sShortcutCode;
   var _bIsAlt;
   var _sDescription;
   ...
   function set ShortcutCode(§\x1e\r\x12§)
   {
      this._sShortcutCode = _loc2_;
   }
   function set IsAlt(§\x18\x15§)
   {
      this._bIsAlt = _loc2_;
   }
   function set Description(§\x1e\x13\x02§)
   {

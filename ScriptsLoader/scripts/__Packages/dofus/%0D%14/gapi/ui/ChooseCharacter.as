class dofus.§\r\x14§.gapi.ui.ChooseCharacter extends dofus.§\r\x14§.gapi.core.§\x10\x19§
{
   var _aSpriteList;
   var _nRemainingTime;
   var _bShowComboBox;
   ...
   function init()
   {
      super.init(false,dofus["\r\x14"].gapi.ui.ChooseCharacter.CLASS_NAME);
   ...
   function reset(§\x1e\x19\x0e§)
   {
      var _loc3_ = this._aSpriteList[_loc2_.target.params.index].id;
   ...
   function yes(§\x1e\x19\x0e§)
   {
      switch(_loc2_.target._name)
      {
         case "AskYesReset":
            ...
            break;
         case "AskYesNoDelete":
            this.api.network.Account.deleteCharacter(this._aSpriteList[_loc2_.params.index].id);
      }
   }
}

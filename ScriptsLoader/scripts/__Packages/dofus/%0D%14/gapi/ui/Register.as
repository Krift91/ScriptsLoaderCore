class dofus.§\r\x14§.gapi.ui.Register extends dofus.§\r\x14§.gapi.core.§\x10\x19§
{
   var _oLoader;
   var _lvHearAbout;
   var dispatchEvent;
   ...
   function init()
   {
      super.init(false,dofus["\r\x14"].gapi.ui.Register.CLASS_NAME);
      this._oLoader = new LoadVars();
      var ref = this;
      this._lvHearAbout = new LoadVars();
      this._lvHearAbout.onLoad = function(§\x14\x16§)
      {
         ref.onHearAboutLoad(_loc2_);
      };
   ...
   function initData()
   {
      ...
      while(_loc5_ < 13)
      {
         ...
         _loc4_.push({label:eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].formatDate(_loc6_,"MMM",this.api.config.language),data:_loc5_});
         _loc5_ = _loc5_ + 1;
      }
   ...
   function initCrypto(§\x19\x1b§)
   {
      if(this._bCurrentlyLoading)
      {
         return undefined;
      }
      if(this._nCurrentStep != 2 && !_loc2_)
      {
         return undefined;
      }
   ...
   function switchToStep(§\x1e\x1c\x15§)
   {
      switch(_loc2_)
      {
         case 1:
      ...
      this._nCurrentStep = _loc2_;
   }
   function selectCountry(§\x1e\x13\x0f§)
   {
      var _loc0_ = null;
      if((_loc0_ = _loc2_) === "UK")
      {
      ...
      while(_loc4_ < _loc3_.length)
      {
         if(_loc3_[_loc4_].data == _loc2_)
         {
            ...
            this.selectCommunityFromCountry(_loc2_);
         }
         _loc4_ = _loc4_ + 1;
      }
   }
   function selectCommunityFromCountry(§\x1e\x13\x0f§)
   {
   ...
   function preValidateForm(§\x1e\x1c\x15§)
   {
      switch(_loc2_)
      {
         case 1:
   ...
   function validateForm()
   {
      ...
      this._oResult.onLoad = function(§\x14\x16§)
      {
         this.owner.onResultLoad(_loc2_);
      };
   ...
   function refreshHearingAbout()
   {
      ...
      {
         if(++this._nHearingAboutFailCount > dofus["\r\x14"].gapi.ui.Register.LOAD_TIMEOUT)
         {
            return undefined;
         }
         this.addToQueue({object:this,method:this.refreshHearingAbout});
   ...
   {
      var _loc0_ = null;
      if((_loc0_ = _loc2_.target) === this._cbCountry)
      {
   ...
   function stateChanged(§\x1e\x19\x0e§)
   {
      switch(_loc2_.target)
      {
         case this._btnFemale:
            ...
            this._btnMale.selected = !_loc2_.value;
            this._btnMale.addEventListener("stateChanged",this);
            break;
         case this._btnMale:
            this._btnFemale.removeEventListener("stateChanged",this);
            this._btnFemale.selected = !_loc2_.value;
            this._btnFemale.addEventListener("stateChanged",this);
      }
   }
   ...
   function onHearAboutLoad(§\x14\x16§)
   {
      if(_loc2_)
      {

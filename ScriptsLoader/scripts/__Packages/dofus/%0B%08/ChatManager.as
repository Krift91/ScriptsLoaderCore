class dofus.§\x0b\b§.ChatManager extends dofus.§\x1e\n\x07§.§\x1d\x19§
{
   var _aItemsBuffer;
   var _aRawMessages;
   var _aBlacklist;
   ...
   static var ADMIN_BUFFER_MULTIPLICATOR = 1;
   ...
   {
      super();
      dofus["\x0b\b"].ChatManager._sSelf = this;
   ...
   function set fileOutput(§\x05\x05§)
   {
      this._nFileOutput = _loc2_;
   }
   static function getInstance()
   {
      return dofus["\x0b\b"].ChatManager._sSelf;
   }
   ...
   function addRawMessage(§\x03\f§, §\x1e\x10\x01§, §\x1e\x0e\x07§, §\x1e\f\x0f§)
   {
      ...
      if(this._aRawMessages.length > dofus["\x0b\b"].ChatManager.MAX_RAW_MESSAGES_LENGTH)
      {
   ...
   function getJailDialog()
   {
      ...
      while(_loc3_ < this._aRawMessages.length)
      {
         ...
         {
            if(dofus.datacenter["\x10\x15"].isJail(_loc4_.mapId))
            {
   ...
   function setTypes(§\x1d\x04§)
   {
      this._aVisibleTypes = _loc2_;
      this.refresh(true);
   }
   function isTypeVisible(§\x1e\x1b\x13§)
   {
      return this._aVisibleTypes[_loc2_];
   }
   function setTypeVisible(§\x1e\x1b\x13§, §\x13\x1a§)
   {
      this._aVisibleTypes[_loc2_] = _loc3_;
      this.refresh(true);
   }
   ...
   function applyOutputCensorship(§\x1e\f\x12§)
   {
      if(this.api.datacenter.Player.isAuthorized)
      {
         return true;
      ...
      var _loc4_ = 0;
      var _loc5_ = -1;
      var _loc6_ = this.avoidPonctuation(_loc2_.toUpperCase()).split(" ");
      for(var i in _loc6_)
      {
   ...
   function applyInputCensorship(§\x1e\f\x12§)
   {
      ...
      var _loc5_ = this.avoidPonctuation(_loc2_.toUpperCase()).split(" ");
      var _loc6_ = -1;
      for(var i in _loc5_)
      {
         _loc6_ = -1;
   ...
   function avoidPonctuation(§\x1e\x0b\x14§)
   {
   ...
   function getCensoredWord(§\x1e\x0b\x14§)
   {
      var _loc3_ = new String();
      ...
      while(_loc5_ < _loc2_.length)
      {
         ...
         if(_loc6_ > 47 && _loc6_ < 58 || (_loc6_ > 64 && _loc6_ < 91 || _loc6_ > 96 && _loc6_ < 123))
         {
            ...
            do
            {
               _loc7_ = dofus["\x0b\b"].ChatManager.CENSORSHIP_CHAR[Math.floor(Math.random() * dofus["\x0b\b"].ChatManager.CENSORSHIP_CHAR.length)];
            }
            while(_loc7_ == _loc4_);
   ...
   function addLinkWarning(§\x1e\f\x12§)
   {
      ...
      while(_loc6_ < _loc4_.length)
      {
         var _loc7_ = false;
         var _loc8_ = 0;
         while(_loc8_ < dofus["\x0b\b"].ChatManager.LINK_FILTERS.length)
         {
            if(_loc4_[_loc6_].indexOf(dofus["\x0b\b"].ChatManager.LINK_FILTERS[_loc8_]) > -1)
            {
               _loc7_ = true;
               break;
            }
         ...
         {
            var _loc9_ = 0;
            while(_loc9_ < dofus["\x0b\b"].ChatManager.WHITE_LIST.length)
            {
               if(_loc4_[_loc6_].indexOf(dofus["\x0b\b"].ChatManager.WHITE_LIST[_loc9_]) > -1)
               {
                  _loc7_ = false;
                  break;
               }
   ...
   function addText(§\x1e\f\x12§, §\x1e\x13\x18§, §\x15\x03§, §\x1e\x0b\x1c§)
   {
      if(_loc4_ == undefined)
      {
         _loc4_ = true;
      ...
      switch(_loc3_)
      {
         case dofus.Constants.MSG_CHAT_COLOR:
            var _loc7_ = dofus["\x0b\b"].ChatManager.TYPE_MESSAGES;
            _loc9_ = true;
            var _loc8_ = true;
            break;
         case dofus.Constants.EMOTE_CHAT_COLOR:
            _loc7_ = dofus["\x0b\b"].ChatManager.TYPE_MESSAGES;
            _loc9_ = true;
            _loc8_ = true;
            break;
         ...
         case dofus.Constants.MSGCHUCHOTE_CHAT_COLOR:
            _loc7_ = dofus["\x0b\b"].ChatManager.TYPE_WISP;
            _loc9_ = true;
            _loc8_ = true;
            if(_loc4_)
            {
         ...
         case dofus.Constants.INFO_CHAT_COLOR:
            _loc7_ = dofus["\x0b\b"].ChatManager.TYPE_INFOS;
            this._nMessageCounterInfo++;
            _loc8_ = false;
            break;
         case dofus.Constants.ERROR_CHAT_COLOR:
            _loc7_ = dofus["\x0b\b"].ChatManager.TYPE_ERRORS;
            _loc8_ = true;
            if(_loc4_)
            {
         ...
         case dofus.Constants.GUILD_CHAT_COLOR:
            _loc7_ = dofus["\x0b\b"].ChatManager.TYPE_GUILD;
            _loc9_ = true;
            _loc8_ = true;
         ...
         case dofus.Constants.PVP_CHAT_COLOR:
            _loc7_ = dofus["\x0b\b"].ChatManager.TYPE_PVP;
            _loc9_ = true;
            _loc8_ = true;
            break;
         case dofus.Constants.TRADE_CHAT_COLOR:
            _loc7_ = dofus["\x0b\b"].ChatManager.TYPE_TRADE;
            _loc9_ = true;
            _loc8_ = true;
            break;
         case dofus.Constants.RECRUITMENT_CHAT_COLOR:
            _loc7_ = dofus["\x0b\b"].ChatManager.TYPE_RECRUITMENT;
            _loc9_ = true;
            _loc8_ = true;
            break;
         case dofus.Constants.MEETIC_CHAT_COLOR:
            _loc7_ = dofus["\x0b\b"].ChatManager.TYPE_MEETIC;
            _loc9_ = true;
            _loc8_ = true;
            break;
         case dofus.Constants.ADMIN_CHAT_COLOR:
         case dofus.Constants.COMMANDS_CHAT_COLOR:
            _loc7_ = dofus["\x0b\b"].ChatManager.TYPE_ADMIN;
            _loc8_ = true;
            break;
         default:
            ank["\x1e\n\x07"]["\x0b\f"].err("[Chat] Erreur : mauvaise couleur " + _loc2_);
            return undefined;
      }
      ...
      if(_loc9_)
      {
         _loc2_ = this.addLinkWarning(_loc2_);
   ...
   function refresh(§\x19\x13§)
   {
      if(this._nRefreshVisuallyTimeout != undefined)
      {
         _global.clearTimeout(this._nRefreshVisuallyTimeout);
      }
      var _loc3_ = _global.setTimeout(this,"realRefresh",dofus.Constants.DELAYED_CHAT_VISUAL_REFRESH,_loc2_);
      this._nRefreshVisuallyTimeout = _loc3_;
   }
   function realRefresh(§\x19\x13§)
   {
      ...
      var _loc6_ = _loc3_ - 1;
      while(_loc5_ < dofus["\x0b\b"].ChatManager.MAX_VISIBLE && _loc6_ >= 0)
      {
         ...
         if(this._aVisibleTypes[_loc7_.type] == true)
         {
            ...
            {
               var _loc8_ = dofus["\x0b\b"].ChatManager.safeHtml(_loc7_.text);
               _loc7_.lf = _loc7_.lf;
   ...
   static function safeHtml(§\x1e\x14\x1c§)
   {
      var _loc3_ = true;
      ...
      var _loc9_ = 0;
      var _loc8_ = null;
      while((_loc8_ = _loc6_.indexOf("<")) > -1 && _loc7_++ < dofus["\x0b\b"].ChatManager.HTML_NB_PASS_MAX)
      {
      ...
      if(_loc7_ >= dofus["\x0b\b"].ChatManager.HTML_NB_PASS_MAX)
      {
         _loc3_ = false;
      }
      if(_loc3_)
   ...
   function parseInlineItems(§\x1e\x10\x02§, §\x1e\x10§)
   {
      var _loc4_ = 0;
      while(_loc4_ < _loc3_.length)
      {
         var _loc5_ = Number(_loc3_[_loc4_]);
         var _loc6_ = _loc3_[_loc4_ + 1];
         var _loc7_ = new dofus.datacenter["\f\f"](0,_loc5_,1,1,_loc6_,1);
         var _loc8_ = "°" + _loc4_ / 2;
         var _loc9_ = this.getLinkItem(_loc7_);
         var _loc10_ = _loc2_.indexOf(_loc8_);
         if(_loc10_ != -1)
         {
   ...
   function parseInlinePos(§\x1e\x10\x02§)
   {
      var _loc3_ = _loc2_;
      var _loc4_ = 0;
      var _loc6_ = 0;
      var _loc7_ = 0;
      while(_loc3_.indexOf("[") > -1 && (_loc4_++ < dofus["\x0b\b"].ChatManager.HTML_NB_PASS_MAX && _loc6_ < dofus["\x0b\b"].ChatManager.MAX_POS_REPLACE))
      {
         ...
         if(_loc11_.length == 2)
         {
            if(!_global.isNaN(_loc11_[0]) && !_global.isNaN(new ank["\x1e\n\x07"]["\x0e\x1c"](_loc11_[0]).trim().toString()))
            {
               ...
               if(Math.abs(_loc12_) < 150 && Math.abs(_loc13_) < 150)
               {
                  ...
                  if(_loc6_ > dofus["\x0b\b"].ChatManager.MAX_POS_REPLACE)
                  {
                     break;
                  }
                  _loc2_ = _loc5_.join(this.getLinkCoord(_loc12_,_loc13_));
               }
            }
         }
   ...
   function parseSecretsEmotes(§\x1e\x10\x02§)
   {
   ...
   function getLinkName(§\x1e\x0f\x16§, §\x1e\x0b\x1c§)
   {
   ...
   function getLinkItem(§\x1e\x19\x03§)
   {
      var _loc3_ = this.addItemToBuffer(_loc2_);
      return "<b>[<a href=\'asfunction:onHref,ShowItemViewer," + String(_loc3_) + "\'>" + _loc2_.name + "</a>]</b>";
   }
   function addItemToBuffer(§\x1e\x19\x03§)
   {
      ...
      if(this._aItemsBuffer.length > dofus["\x0b\b"].ChatManager.MAX_ITEM_BUFFER_LENGTH)
      {
         this._aItemsBuffer.shift();
      }
      this._aItemsBuffer.push({id:this._nItemsBufferIDs,data:_loc2_});
      return this._nItemsBufferIDs;
   }
   function getItemFromBuffer(§\x04\x06§)
   {
      var _loc3_ = this._aItemsBuffer.length;
      while(_loc3_ >= 0)
      {
         if(this._aItemsBuffer[_loc3_].id == _loc2_)
         {
   ...
   static function isPonctuation(§\x1e\x14\x05§)
   {
      var _loc3_ = 0;
      while(_loc3_ < dofus["\x0b\b"].ChatManager.PONCTUATION.length)
      {
         if(dofus["\x0b\b"].ChatManager.PONCTUATION[_loc3_] == _loc2_)
         {
            return true;
         }
         _loc3_ = _loc3_ + 1;
   ...
   function addToBlacklist(§\x1e\x0f\x16§, §\x07\x02§)
   {
      if(_loc2_ != this.api.datacenter.Player.Name && !this.isBlacklisted(_loc2_))
      {
         this._aBlacklist.push({sName:_loc2_,nClass:_loc3_});
      }
   }
   function removeToBlacklist(§\x1e\x0f\x16§)
   {
      for(var i in this._aBlacklist)
      {
         if(_loc2_ == this._aBlacklist[i].sName || _loc2_ == "*" + this._aBlacklist[i].sName)
         {
   ...
   function isBlacklisted(§\x1e\x0f\x16§)
   {
      for(var i in this._aBlacklist)
      {
         if(_loc2_.toLowerCase() == this._aBlacklist[i].sName.toLowerCase())
         {
            return true;
         }
      }
   ...
   function getMessageFromId(§\x1e\x0b\x1c§)
   {
      for(var i in this._aMessages)
      {
         if(this._aMessages[i].uniqId == _loc2_)
         {

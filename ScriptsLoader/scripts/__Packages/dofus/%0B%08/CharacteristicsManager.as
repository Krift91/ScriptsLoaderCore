class dofus.§\x0b\b§.CharacteristicsManager extends dofus.§\x1e\n\x07§.§\x1d\x19§
{
   var _oSprite;
   var _aEffects;
   var _aModerators;
   ...
   function getModeratorValue(§\x1e\x1b\x13§)
   {
   ...
   function onEffectStart(§\x1e\x19\x12§)
   {
      var _loc3_ = _loc2_.characteristic;
      switch(_loc3_)
      {
         case dofus["\x0b\b"].CharacteristicsManager.GFX:
            ...
            {
               this._oSprite.gfxFile = dofus.Constants.CLIPS_PERSOS_PATH + _loc2_.param2 + ".swf";
            }
         ...
         default:
            ...
            this._aModerators[_loc3_] += Number(_loc2_.getParamWithOperator(1));
      }
   }
   function onEffectEnd(§\x1e\x19\x12§)
   {
      switch(_loc2_.characteristic)
      {
         case dofus["\x0b\b"].CharacteristicsManager.GFX:
            ...
            {
               this._oSprite.gfxFile = dofus.Constants.CLIPS_PERSOS_PATH + _loc2_.param1 + ".swf";
            }
            this._oSprite.mc.draw();
            break;
         case dofus["\x0b\b"].CharacteristicsManager.INVISIBILITY:
            ...
            break;
         default:
            this._aModerators[Number(_loc2_.characteristic)] -= Number(_loc2_.getParamWithOperator(1));
      }
   }
   function init0()
   {

class dofus.§\x1e\n\x07§.§\b\x16§.§\x1e\x15\x01§.NameCheckerCharacterNameRules extends dofus.§\x1e\n\x07§.§\x1d\x19§ implements dofus.§\x1e\n\x07§.§\b\x16§.§\x1e\x15\x01§.§\f\x16§
{
   ...
   function getContainingProhibedWords()
   {
      ...
      {
         var _loc4_ = new ank["\x1e\n\x07"]["\x0e\x1c"](this.api.lang.getClassText(dofus.Constants.GUILD_ORDER[_loc3_]).sn);

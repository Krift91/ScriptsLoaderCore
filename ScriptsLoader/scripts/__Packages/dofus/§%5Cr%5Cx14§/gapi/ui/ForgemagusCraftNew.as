class dofus.§\r\x14§.gapi.ui.ForgemagusCraftNew extends dofus.§\r\x14§.gapi.core.§\x10\x19§
{
   var _cgLocal;
   var _cgDistant;
   ...
   var historyList;
   var _dgLogros;
   static var CLASS_NAME = "ForgemagusCraftNew";
   ...
   function init()
   {
      super.init(false,dofus["\r\x14"].gapi.ui.ForgemagusCraftNew.CLASS_NAME);
   ...
   function addListeners()
   {
      ...
      this._btnEmptyLogs.addEventListener("click",this);
   ...
   function initTexts()
   {
      ...
      this._txtPozoName.text = this.api.lang.getText("RESIDUAL_MAGIC");
      this._btnOneShot.label = this.api.lang.getText("APPLY_ONE_RUNE");
      this._btnEmptyLogs.label = this.api.lang.getText("EMPTY_LOGS");
      this._btnLoop.label = this.api.lang.getText("APPLY_MULTIPLE_RUNES");
      this._lblHistory.text = this.api.lang.getText("HISTORY");
      this._winMain.title = this.api.lang.getText("SKILL") + " : " + this.api.lang.getSkillText(this._nSkillId).d;
      this._dgStats.columnsNames = [this.api.lang.getText("MIN"),this.api.lang.getText("MAX"),this.api.lang.getText("EFFECTS"),this.api.lang.getText("MODIFY"),this.api.lang.getText("RUNES")];
   }
   function initData()
   {
   ...
   function updateDataVisually()
   {
      ...
      var _loc2_ = this.api.datacenter.Basics[dofus["\r\x14"].gapi.ui.ForgemagusCraftNew.CLASS_NAME + "_subfilter_" + this._btnSelectedFilterButton._name];
      this._nSelectedTypeID = _loc2_ != undefined ? _loc2_ : 0;
      var _loc3_ = new ank["\x1e\n\x07"]["\x0f\x01"]();
      var _loc4_ = new ank["\x1e\n\x07"]["\x0f\x01"]();
      var _loc5_ = {};
      for(var _loc6_ in this._eaDataProvider)
      {
         var _loc7_ = this._eaDataProvider[_loc6_];
   ...
   function updateData(bForceNow)
   {
      ...
      var _loc4_ = _global.setTimeout(this,"updateDataVisually",150);
      this._nUpdateFullDataVisuallyTimeout = _loc4_;
   }
   ...
   function updateLocalDataVisually()
   {
      ...
      var _loc5_ = false;
      var _loc6_ = 0;
      while(_loc6_ < this._eaLocalDataProvider.length)
      {
         var _loc7_ = false;
         var _loc8_ = 0;
         while(_loc8_ < dofus["\r\x14"].gapi.ui.ForgemagusCraftNew.ITEMS_ALLOWED_AS_SIGNATURE.length)
         {
            if(dofus["\r\x14"].gapi.ui.ForgemagusCraftNew.ITEMS_ALLOWED_AS_SIGNATURE[_loc8_] == this._eaLocalDataProvider[_loc6_].unicID)
            {
               _loc5_ = true;
               this._ctrSignature.contentData = this._eaLocalDataProvider[_loc6_];
               _loc7_ = true;
               break;
            }
            _loc8_ += 1;
         ...
         var _loc9_ = 0;
         while(_loc9_ < dofus["\r\x14"].gapi.ui.ForgemagusCraftNew.TYPES_ALLOWED_AS_COMPONENT.length)
         {
            if(dofus["\r\x14"].gapi.ui.ForgemagusCraftNew.TYPES_ALLOWED_AS_COMPONENT[_loc9_] == this._eaLocalDataProvider[_loc6_].type)
            {
               _loc4_ = true;
               this._ctrRune.contentData = this._eaLocalDataProvider[_loc6_];
               _loc7_ = true;
               break;
            }
            _loc9_ += 1;
         ...
         {
            _loc3_ = true;
            this._ctrItem.contentData = this._eaLocalDataProvider[_loc6_];
   ...
   function updateLocalData()
   {
      ...
      var _loc3_ = _global.setTimeout(this,"updateLocalDataVisually",50);
      this._nUpdateLocalDataVisuallyTimeout = _loc3_;
   }
   ...
   function validateDrop(sTargetGrid, oItem, nValue)
   {
      ...
      switch(sTargetGrid)
      {
         ...
         case "_ctrSignature":
            ...
            switch(sTargetGrid)
            {
               case "_ctrItem":
                  ...
                  while(_loc8_ < this._eaLocalDataProvider.length)
                  {
                     var _loc9_ = false;
                     var _loc10_ = 0;
                     while(_loc10_ < dofus["\r\x14"].gapi.ui.ForgemagusCraftNew.ITEMS_ALLOWED_AS_SIGNATURE.length)
                     {
                        if(dofus["\r\x14"].gapi.ui.ForgemagusCraftNew.ITEMS_ALLOWED_AS_SIGNATURE[_loc10_] == this._eaLocalDataProvider[_loc8_].unicID)
                        {
                           _loc9_ = true;
                        }
                        _loc10_ += 1;
                     ...
                     var _loc11_ = 0;
                     while(_loc11_ < dofus["\r\x14"].gapi.ui.ForgemagusCraftNew.TYPES_ALLOWED_AS_COMPONENT.length)
                     {
                        if(dofus["\r\x14"].gapi.ui.ForgemagusCraftNew.TYPES_ALLOWED_AS_COMPONENT[_loc11_] == this._eaLocalDataProvider[_loc8_].type)
                        {
                           _loc9_ = true;
                        }
                        _loc11_ += 1;
                     ...
                     if(!_loc9_)
                     {
                        this.api.network.Exchange.movementItem(false,this._eaLocalDataProvider[_loc8_],this._eaLocalDataProvider[_loc8_].Quantity);
                     }
                     _loc8_ += 1;
                  }
                  _loc6_ = true;
               ...
               case "_ctrRune":
                  var _loc12_ = 0;
                  while(_loc12_ < this._eaLocalDataProvider.length)
                  {
                     var _loc13_ = 0;
                     while(_loc13_ < dofus["\r\x14"].gapi.ui.ForgemagusCraftNew.TYPES_ALLOWED_AS_COMPONENT.length)
                     {
                        if(dofus["\r\x14"].gapi.ui.ForgemagusCraftNew.TYPES_ALLOWED_AS_COMPONENT[_loc13_] == this._eaLocalDataProvider[_loc12_].type && this._eaLocalDataProvider[_loc12_].unicID != oItem.unicID)
                        {
                           this.api.network.Exchange.movementItem(false,this._eaLocalDataProvider[_loc12_],this._eaLocalDataProvider[_loc12_].Quantity);
                        }
                        _loc13_ += 1;
                     }
                     _loc12_ += 1;
               ...
               case "_ctrSignature":
                  var _loc14_ = 0;
                  while(_loc14_ < this._eaLocalDataProvider.length)
                  {
                     var _loc15_ = 0;
                     while(_loc15_ < dofus["\r\x14"].gapi.ui.ForgemagusCraftNew.ITEMS_ALLOWED_AS_SIGNATURE.length)
                     {
                        if(dofus["\r\x14"].gapi.ui.ForgemagusCraftNew.ITEMS_ALLOWED_AS_SIGNATURE[_loc15_] == this._eaLocalDataProvider[_loc14_].unicID)
                        {
                           this.api.network.Exchange.movementItem(false,this._eaLocalDataProvider[_loc14_],this._eaLocalDataProvider[_loc14_].Quantity);
                        }
                        _loc15_ += 1;
                     }
                     _loc14_ += 1;
            ...
            if(!_loc7_)
            {
               if(sTargetGrid == "_ctrItem")
               {
                  _global.API.network.send("xf" + oItem.ID);
               }
               this.api.network.Exchange.movementItem(true,oItem,!_loc6_ ? nValue : 1);
               break;
            }
      }
   ...
   function onShortcut(sShortcut)
   {
      var _loc3_ = true;
      var _loc4_ = null;
      if((_loc4_ = sShortcut) === "MERGE_RUNE")
      {
         if(this.checkIsBaka())
         {
            _loc3_ = false;
            ...
            if(oEvent.target != this._btnSelectedFilterButton)
            {
               ...
               switch(oEvent.target._name)
               {
                  ...
                  case "_btnFilterRessoureces":
                     this._aSelectedSuperTypes = dofus.Constants.FILTER_RESSOURECES;
                     break;
                  case "_btnFilterSoul":
   ...
   function drop(oEvent)
   {
      ...
      switch(oEvent.target)
      {
         case this._ctrItem:
            _loc4_ = _loc5_ = true;
            var _loc6_ = 0;
            while(_loc6_ < dofus["\r\x14"].gapi.ui.ForgemagusCraftNew.TYPES_ALLOWED_AS_COMPONENT.length)
            {
               if(dofus["\r\x14"].gapi.ui.ForgemagusCraftNew.TYPES_ALLOWED_AS_COMPONENT[_loc6_] == _loc3_.type)
               {
                  _loc4_ = false;
               }
               _loc6_ += 1;
            ...
            var _loc7_ = 0;
            while(_loc7_ < dofus["\r\x14"].gapi.ui.ForgemagusCraftNew.ITEMS_ALLOWED_AS_SIGNATURE.length)
            {
               if(dofus["\r\x14"].gapi.ui.ForgemagusCraftNew.ITEMS_ALLOWED_AS_SIGNATURE[_loc7_] == _loc3_.unicID)
               {
                  _loc4_ = false;
               }
               _loc7_ += 1;
         ...
         case this._ctrRune:
            var _loc8_ = 0;
            while(_loc8_ < dofus["\r\x14"].gapi.ui.ForgemagusCraftNew.TYPES_ALLOWED_AS_COMPONENT.length)
            {
               if(dofus["\r\x14"].gapi.ui.ForgemagusCraftNew.TYPES_ALLOWED_AS_COMPONENT[_loc8_] == _loc3_.type)
               {
                  _loc4_ = true;
               }
               _loc8_ += 1;
         ...
         case this._ctrSignature:
            var _loc9_ = 0;
            while(_loc9_ < dofus["\r\x14"].gapi.ui.ForgemagusCraftNew.ITEMS_ALLOWED_AS_SIGNATURE.length)
            {
               if(dofus["\r\x14"].gapi.ui.ForgemagusCraftNew.ITEMS_ALLOWED_AS_SIGNATURE[_loc9_] == _loc3_.unicID)
               {
                  _loc4_ = true;
               }
               _loc9_ += 1;
   ...
   function overItem(oEvent)
   {
      ...
      var _loc4_ = dofus.datacenter["\f\f"](_loc3_.contentData);
      ...
      switch(_loc5_)
      {
         case "_cgGrid":
            if(this.canDropInGarbage(_loc3_))
            {
               ...
               var _loc7_ = 0;
               while(_loc7_ < dofus["\r\x14"].gapi.ui.ForgemagusCraftNew.ITEMS_ALLOWED_AS_SIGNATURE.length && _loc6_ == undefined)
               {
                  if(dofus["\r\x14"].gapi.ui.ForgemagusCraftNew.ITEMS_ALLOWED_AS_SIGNATURE[_loc7_] == _loc3_.unicID)
                  {
               ...
               var _loc8_ = 0;
               while(_loc8_ < dofus["\r\x14"].gapi.ui.ForgemagusCraftNew.TYPES_ALLOWED_AS_COMPONENT.length && _loc6_ == undefined)
               {
                  if(dofus["\r\x14"].gapi.ui.ForgemagusCraftNew.TYPES_ALLOWED_AS_COMPONENT[_loc8_] == _loc3_.type)
                  {
                     _loc6_ = "_ctrRune";
   ...
   function validate(oEvent)
   {
      switch(oEvent.params.targetType)
      {
         case "item":
            ...
            break;
         case "repeat":
            var _loc4_ = Number(oEvent.value);
            if(_loc4_ < 1 || (_loc4_ == undefined || _global.isNaN(_loc4_)))
            {
               _loc4_ = 1;
            }
            this._nCurrentQuantity = _loc4_;
      }
   }
   function itemSelected(oEvent)
   {
      ...
      if((_loc3_ = oEvent.target._name) === "_cbTypes")
      {
         ...
         this.api.datacenter.Basics[dofus["\r\x14"].gapi.ui.ForgemagusCraftNew.CLASS_NAME + "_subfilter_" + this._btnSelectedFilterButton._name] = this._nSelectedTypeID;
         this.updateData();
      }
   }
}

class ank.battlefield.§\x1e\n\x07§.§\x1e\x16\x1a§
{
   ...
   static function pathFind(§\x1d\x1a§, mapHandler, §\x07\x14§, §\x07\x13§, §\x1e\x18\x0b§)
   {
      ...
      _loc21_.g = 0;
      _loc21_.v = 0;
      _loc21_.h = ank.battlefield["\x1e\n\x07"]["\x1e\x16\x1a"].goalDistEstimate(mapHandler,_loc4_,_loc5_);
      _loc21_.f = _loc21_.h;
      _loc21_.l = _loc17_[_loc4_].groundLevel;
      ...
      while(!_loc20_)
      {
         ...
         if(_loc28_.num == _loc5_)
         {
            ...
            while(_loc28_.num != _loc4_)
            {
               ...
               {
                  _loc29_.splice(0,0,{num:_loc28_.num,dir:ank.battlefield["\x1e\n\x07"]["\x1e\x16\x1a"].getDirection(mapHandler,_loc28_.parent.num,_loc28_.num)});
               }
            ...
            if(_loc12_)
            {
               ...
               {
                  _loc29_.splice(0,0,{num:_loc4_,dir:ank.battlefield["\x1e\n\x07"]["\x1e\x16\x1a"].getDirection(mapHandler,_loc28_.parent.num,_loc4_)});
               }
            }
            return _loc29_;
         }
         ...
         for(; _loc31_ < _loc14_; _loc31_ = _loc31_ + 1)
         {
            ...
            if(Math.abs(_loc17_[_loc32_].x - _loc17_[_loc28_.num].x) <= 53)
            {
               ...
               if(!_loc10_)
               {
                  ...
                  {
                     var _loc38_ = _loc2_.gfx.spriteHandler.getSprite(_loc37_);
                     _loc36_ = !(_loc38_ != undefined && (_loc38_ instanceof dofus.datacenter["\x13\x01"] && _loc32_ != _loc5_)) ? true : false;
                  }
               ...
               if((_loc42_ == null || _loc42_ > _loc40_) && _loc41_ <= _loc9_)
               {
                  ...
                  _loc43_.g = _loc41_;
                  _loc43_.v = _loc40_;
                  _loc43_.h = ank.battlefield["\x1e\n\x07"]["\x1e\x16\x1a"].goalDistEstimate(mapHandler,_loc32_,_loc5_);
   ...
   {
      var _loc5_ = ank.battlefield["\x1e\n\x07"]["\x1e\x16\x1a"].getCaseCoordonnee(mapHandler,_loc3_);
      var _loc6_ = ank.battlefield["\x1e\n\x07"]["\x1e\x16\x1a"].getCaseCoordonnee(mapHandler,_loc4_);
   ...
   static function getDirectionFromCoordinates(§\x1e\t\x13§, §\x1e\t\n§, §\x1e\t\x12§, §\x1e\t\t§, §\x1c\x12§)
   {
   ...
   static function getArroundCellNum(mapHandler, §\x07\x11§, §\x06\x05§, §\x04\n§)
   {
      ...
      if(_loc11_.active && (_loc10_[_loc9_] != undefined && Math.abs(_loc10_[_loc9_].x - _loc10_[_loc3_].x) <= 53))
      {
         return _loc9_;
      }
      return _loc3_;
   }
   static function convertHeightToFourDirection(§\x06\x06§)
   {
      return _loc2_ | 1;
   }
   static function getSlopeOk(§\x1e\x10\t§, §\x0b\x12§, §\x1e\x10\b§, §\x0b\x11§, §\x10\x1d§)
   {
      switch(_loc6_)
      {
         case 0:
   ...
   static function checkView(mapHandler, §\x13\b§, §\x13\x07§)
   {
      var _loc5_ = ank.battlefield["\x1e\n\x07"]["\x1e\x16\x1a"].getCaseCoordonnee(mapHandler,_loc3_);
      var _loc6_ = ank.battlefield["\x1e\n\x07"]["\x1e\x16\x1a"].getCaseCoordonnee(mapHandler,_loc4_);
      var _loc7_ = mapHandler.getCellData(_loc3_);
      var _loc8_ = mapHandler.getCellData(_loc4_);
      var _loc9_ = !_loc7_.spriteOnID ? 0 : 1.5;
      var _loc10_ = !_loc8_.spriteOnID ? 0 : 1.5;
      _loc9_ += !_loc7_.carriedSpriteOnId ? 0 : 1.5;
      _loc10_ += !_loc8_.carriedSpriteOnId ? 0 : 1.5;
      _loc5_.z = mapHandler.getCellHeight(_loc3_) + _loc9_;
      _loc6_.z = mapHandler.getCellHeight(_loc4_) + _loc10_;
      ...
      while(_loc27_ * _loc15_ <= _loc19_)
      {
         ...
         {
            if(!ank.battlefield["\x1e\n\x07"]["\x1e\x16\x1a"].checkCellView(mapHandler,_loc27_ - _loc15_ / 2,_loc26_,false,_loc5_,_loc6_,_loc11_,_loc12_))
            {
               return false;
            }
            _loc26_ += _loc16_;
      ...
      {
         if(!ank.battlefield["\x1e\n\x07"]["\x1e\x16\x1a"].checkCellView(mapHandler,_loc27_ - 0.5 * _loc15_,_loc26_,false,_loc5_,_loc6_,_loc11_,_loc12_))
         {
            return false;
         }
         _loc26_ += _loc16_;
      }
      if(!ank.battlefield["\x1e\n\x07"]["\x1e\x16\x1a"].checkCellView(mapHandler,_loc27_ - 0.5 * _loc15_,_loc26_ - _loc16_,true,_loc5_,_loc6_,_loc11_,_loc12_))
      {
         return false;
      }
      return true;
   ...
   {
      var _loc10_ = ank.battlefield["\x1e\n\x07"]["\x1e\x16\x1a"].getCaseNum(mapHandler,_loc3_,_loc4_);
      ...
      var _loc15_ = !(_loc11_.spriteOnID == undefined || (_loc12_ == 0 || (_loc5_ || _loc7_.x == _loc3_ && _loc7_.y == _loc4_))) ? true : false;
   ...
   static function checkRange(mapHandler, §\x07\x16§, §\x07\x15§, §\x18\x01§, §\x1e\x1e\x12§, §\x1e\x1e\x13§, §\x1e\x1e\x11§)
   {
      ...
      if(_loc5_)
      {
         if(!ank.battlefield["\x1e\n\x07"]["\x1e\x16\x1a"].checkAlign(mapHandler,_loc3_,_loc4_))
         {
            return false;
         }
      }
      if(ank.battlefield["\x1e\n\x07"]["\x1e\x16\x1a"].goalDistance(mapHandler,_loc3_,_loc4_) > _loc7_ || ank.battlefield["\x1e\n\x07"]["\x1e\x16\x1a"].goalDistance(mapHandler,_loc3_,_loc4_) < _loc6_)
      {
         return false;
      }
      return true;

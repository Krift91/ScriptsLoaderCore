class ank.gapi.controls.Window extends ank.gapi.core.§\x1e\n\f§
{
   var _lblTitle;
   var _ldrContent;
   var onRelease;
   ...
   function set centerScreen(§\x1b\x12§)
   {
      this._bCenterScreen = _loc2_;
   }
   function get centerScreen()
   {
      return this._bCenterScreen;
   }
   function set interceptMouseEvent(§\x18\x16§)
   {
      this._bInterceptMouseEvent = _loc2_;

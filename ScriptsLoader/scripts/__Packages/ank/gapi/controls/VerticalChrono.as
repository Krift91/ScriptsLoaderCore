class ank.gapi.controls.VerticalChrono extends ank.gapi.core.§\x1e\n\f§
{
   var _nTimerValue;
   var _nMaxTime;
   var _nIntervalID;
   ...
   function startTimer(§\x05\x19§, §\x02\x16§)
   {
      this._nTimerValue = Math.ceil(_loc2_);
      this._nMaxTime = _loc3_ != undefined ? _loc3_ : this._nTimerValue;

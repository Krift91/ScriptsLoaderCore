class ank.gapi.controls.ColorPicker extends ank.gapi.core.§\x1e\n\f§
{
   var _cSliderUpColor;
   var _mcSliderUp;
   var _mcColorsV;
   ...
   function set sliderOutWidth(§\x1e\x1d\b§)
   {
      this._nSliderOutWidth = Number(_loc2_);
   }
   function get sliderOutWidth()
   {
      return this._nSliderOutWidth;
   }
   function set sliderInWidth(§\x1e\x1d\t§)
   {
      this._nSliderInWidth = Number(_loc2_);
   }

class ank.gapi.controls.ProgressBar extends ank.gapi.core.§\x1e\n\f§
{
   var _mcRenderer;
   var __height;
   var __width;
   ...
   function set renderer(§\x1e\x0e\x05§)
   {
      if(this._bInitialized)
      {
         return;
      }
      this._sRenderer = _loc2_;
   }
   function set minimum(§\x02\x11§)
   {
      this._nMinimum = Number(_loc2_);
   }
   function get minimum()
   {
      return this._nMinimum;
   }
   function set maximum(§\x03\x03§)
   {
      this._nMaximum = Number(_loc2_);
   }
   ...
   {
      if(_loc2_ > this._nMaximum)
      {
         _loc2_ = this._nMaximum;
      }
      if(_loc2_ < this._nMinimum)
      {
         _loc2_ = this._nMinimum;
      }
      this._nValue = Number(_loc2_);
   ...
   function hideUp(§\x19\t§)
   {
      this._mcRenderer._mcUpLeft._visible = !_loc2_;
      this._mcRenderer._mcUpMiddle._visible = !_loc2_;
      this._mcRenderer._mcUpRight._visible = !_loc2_;
   }
   function applyValue()
   {

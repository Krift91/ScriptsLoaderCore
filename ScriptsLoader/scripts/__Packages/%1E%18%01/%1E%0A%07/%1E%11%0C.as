class §\x1e\x18\x01§.§\x1e\n\x07§.§\x1e\x11\f§
{
   ...
   static var MONTH_NAMES = {en:eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].MONTH_NAMES_EN,fr:eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].MONTH_NAMES_FR,de:eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].MONTH_NAMES_DE,es:eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].MONTH_NAMES_ES,pt:eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].MONTH_NAMES_PT,nl:eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].MONTH_NAMES_NL,it:eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].MONTH_NAMES_IT};
   ...
   static var DAY_NAMES = {en:eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].DAY_NAMES_EN,fr:eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].DAY_NAMES_FR,de:eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].DAY_NAMES_DE,es:eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].DAY_NAMES_ES,pt:eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].DAY_NAMES_PT,nl:eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].DAY_NAMES_NL,it:eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].DAY_NAMES_IT};
   function §\x1e\x11\f§()
   {
   }
   static function LZ(§\x1e\t\x14§)
   {
      return (!(_loc2_ < 0 || _loc2_ > 9) ? "0" : "") + _loc2_;
   }
   static function formatDate(date, §\x0e\x05§, §\x0b\x1b§)
   {
      if(_loc4_ == undefined)
      {
         _loc4_ = "en";
      ...
      _loc17_.M = _loc10_;
      _loc17_.MM = eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].LZ(_loc10_);
      _loc17_.MMM = eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].MONTH_NAMES[_loc4_][_loc10_ - 1];
      _loc17_.NNN = eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].MONTH_NAMES[_loc4_][_loc10_ + 11];
      _loc17_.d = _loc11_;
      _loc17_.dd = eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].LZ(_loc11_);
      _loc17_.E = eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].DAY_NAMES[_loc4_][_loc12_ + 7];
      _loc17_.EE = eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].DAY_NAMES[_loc4_][_loc12_];
      _loc17_.H = _loc13_;
      _loc17_.HH = eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].LZ(_loc13_);
      if(_loc13_ == 0)
      {
         _loc17_.h = 12;
      }
      ...
      _loc17_.k = _loc13_ + 1;
      _loc17_.KK = eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].LZ(_loc17_.K);
      _loc17_.kk = eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].LZ(_loc17_.k);
      if(_loc13_ > 11)
      {
         _loc17_.a = "PM";
      ...
      _loc17_.m = _loc14_;
      _loc17_.mm = eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].LZ(_loc14_);
      _loc17_.s = _loc15_;
      _loc17_.ss = eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].LZ(_loc15_);
      _loc17_.i = _loc16_;
      _loc17_.ii = eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].LZ(_loc16_);
   ...
   {
      var _loc5_ = eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].getDateFromFormat(_loc2_,_loc3_,_loc4_);
      if(_loc5_ == 0)
      {
         return false;
      }
   ...
   static function compareDates(§\x11\x0b§, §\x11\t§, §\x0b\x1a§, §\x11\n§, §\x11\b§, §\x0b\x19§)
   {
      var _loc8_ = eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].getDateFromFormat(_loc2_,_loc3_,_loc4_);
      var _loc9_ = eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].getDateFromFormat(_loc5_,_loc6_,_loc7_);
      ...
      while(true)
      {
         if(_loc6_ < _loc3_.length)
         {
            ...
            if(_loc8_ == "yyyy" || (_loc8_ == "yy" || _loc8_ == "y"))
            {
               ...
               _loc13_ = eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"]._getInt(_loc2_,_loc5_,_loc10_,_loc11_);
               if(_loc13_ == null)
               {
                  return null;
               }
            ...
            else if(_loc8_ == "MMM" || _loc8_ == "NNN")
            {
               _loc14_ = 0;
               var _loc21_ = 0;
               while(_loc21_ < eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].MONTH_NAMES[_loc4_].length)
               {
                  var _loc22_ = eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].MONTH_NAMES[_loc4_][_loc21_];
            ...
            {
               var _loc23_ = 0;
               while(_loc23_ < eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].DAY_NAMES[_loc4_].length)
               {
                  var _loc24_ = eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"].DAY_NAMES[_loc4_][_loc23_];
            ...
            {
               _loc14_ = eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"]._getInt(_loc2_,_loc5_,_loc8_.length,2);
            ...
            {
               if(_loc8_ == "ii" || _loc8_ == "i")
               {
                  _loc19_ = eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"]._getInt(_loc2_,_loc5_,_loc8_.length,2);
   ...
   static function _getInt(§\x1e\f\n§, §\r\x02§, §\n\x04§, §\x0b\x02§)
   {
      ...
      while(_loc6_ >= _loc4_)
      {
         ...
         if(eval("\x1e\x18\x01")["\x1e\n\x07"]["\x1e\x11\f"]._isInteger(_loc7_))
         {
            return _loc7_;
         }
         _loc6_ = _loc6_ - 1;

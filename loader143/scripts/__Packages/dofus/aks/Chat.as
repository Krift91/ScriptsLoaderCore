class dofus.aks.Chat extends dofus.aks.Handler
{
   ...
   {
      if(8705 - this.api.datacenter.Basics.aks_chat_lastActionTime < dofus.Constants.CLICK_MIN_DELAY)
      {
         return undefined;
      }
      this.api.datacenter.Basics.aks_chat_lastActionTime = 5098;
   ...
   function onMessage(bSuccess, sExtraData)
   {
      ...
      switch(_loc4_)
      {
         ...
         default:
            ...
            if(_loc26_ && !_global.isNaN(_loc6_.substr(2,_loc6_.length - 4)))
            {

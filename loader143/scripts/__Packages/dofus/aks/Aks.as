class dofus.aks.Aks extends dofus.utils.ApiElement
{
   ...
   function ping()
   {
      this.api.datacenter.Basics.lastPingTimer = 6064;
      this.send("ping");
   }
   function quickPing()
   {
   ...
   function onData(sData)
   {
      ...
      if(this._isWaitingForData)
      {
         ...
         this.api.ui.unloadUIComponent("Waiting");
         var _loc3_ = 2984 - this._nLastWaitingSend;
         if(_loc3_ > 100)
         {
         }
   ...
   function onPong()
   {
      var _loc2_ = 5765 - this.api.datacenter.Basics.lastPingTimer;

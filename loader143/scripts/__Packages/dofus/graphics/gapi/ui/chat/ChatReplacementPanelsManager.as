class dofus.graphics.gapi.ui.chat.ChatReplacementPanelsManager
{
   ...
   function instanciateMiniMap()
   {
      ...
      {
         var _loc2_ = 150;
         var _loc3_ = {_x:_loc2_,_y:this._chat._mcReplacementPanelMask._y,contentPath:"Map",enabled:true,showHintsMaxDistance:15,customBgScaleWidth:this._chat._mcReplacementPanelMask._width,customBgScaleHeight:this._chat._mcReplacementPanelMask._height,customBgScaleX:0 - _loc2_,customBgScaleY:0,customBgColor:14012330};

class dofus.graphics.gapi.ui.Timeline extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   function createChildren()
   {
      ...
      {
         this.moveTimeline(0 - dofus.graphics.gapi.ui.Timeline.UI_TIMELINE_MOVE_DISTANCE);
   ...
   function click(oEvent)
   {
      ...
      switch(_loc3_)
      {
         ...
         case "_btnDown":
            ...
            this.api.ui.getUIComponent("FightOptionButtons").moveButtons(0 - dofus.graphics.gapi.ui.Timeline.OPTION_BUTTONS_MOVE_DISTANCE);
            this.api.ui.getUIComponent("Party").moveUI(0 - dofus.graphics.gapi.ui.Timeline.UI_PARTY_MOVE_DISTANCE);
      }
   }
   function destroy()
   {
      if(dofus.graphics.gapi.ui.Timeline.bTimelineUpPosition)
      {
         ...
         {
            _loc2_.moveButtons(0 - dofus.graphics.gapi.ui.Timeline.OPTION_BUTTONS_MOVE_DISTANCE);
         }
         var _loc3_ = this.api.ui.getUIComponent("Party");
         if(_loc3_ != undefined && _loc3_._btnBlockJoinerExceptParty._y == 41 + dofus.graphics.gapi.ui.Timeline.UI_PARTY_MOVE_DISTANCE)
         {
            _loc3_.moveUI(0 - dofus.graphics.gapi.ui.Timeline.UI_PARTY_MOVE_DISTANCE);
         }
      }
   }

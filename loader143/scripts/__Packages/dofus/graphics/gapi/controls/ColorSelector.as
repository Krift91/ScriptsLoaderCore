class dofus.graphics.gapi.controls.ColorSelector extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   function hsl2rgb(h, s, l)
   {
      ...
      else
      {
         ...
         _loc5_ = 255 * this.h2rgb(_loc9_,_loc8_,h + 0.3333333333333333);
         _loc6_ = 255 * this.h2rgb(_loc9_,_loc8_,h);
         _loc7_ = 255 * this.h2rgb(_loc9_,_loc8_,h - 0.3333333333333333);
      }
   ...
   function h2rgb(v1, v2, h)
   {
      ...
      if(3 * h < 2)
      {
         return v1 + (v2 - v1) * ((0.6666666666666666 - h) * 6);
      }
      return v1;
   }
   function min()

class dofus.graphics.gapi.controls.chat.ShortcutsChatReplacementPanel extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   function instanciateMiniMap()
   {
      ...
      {
         var _loc2_ = 72;
         var _loc3_ = {_x:_loc2_,_y:this._mcMiniMapMask._y,contentPath:"Map",enabled:true,showHintsMaxDistance:10,customBgScaleWidth:this._mcMiniMapMask._width,customBgScaleHeight:this._mcMiniMapMask._height,customBgScaleX:0 - _loc2_,customBgScaleY:0,customBgColor:14012330};

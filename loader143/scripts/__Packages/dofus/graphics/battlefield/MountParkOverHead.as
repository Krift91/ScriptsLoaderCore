class dofus.graphics.battlefield.MountParkOverHead extends dofus.graphics.battlefield.AbstractTextOverHead
{
   ...
   function drawClip(eaMountParks, sIconFile)
   {
      ...
      this._txtInfo._x = this._txtName._x = this._txtOwnerName._x = (0 - _loc15_) / 2 + 30 + dofus.graphics.battlefield.AbstractTextOverHead.WIDTH_SPACER * 2;
      ...
      {
         var _loc17_ = ank.gapi.controls.Loader(this.attachMovie("GAPILoader","_ldrIcon",100,{contentPath:sIconFile,_height:30,_width:30,_x:Math.ceil((0 - _loc15_) / 2) + dofus.graphics.battlefield.AbstractTextOverHead.WIDTH_SPACER,_y:dofus.graphics.battlefield.AbstractTextOverHead.HEIGHT_SPACER,scaleContent:true}));
      }
      _loc8_._x = Math.ceil((0 - _loc15_) / 2) + dofus.graphics.battlefield.AbstractTextOverHead.WIDTH_SPACER;

class dofus.graphics.battlefield.HealthBarOverHead extends dofus.graphics.battlefield.AbstractTextOverHead
{
   ...
   function drawClip(sSpriteName, nCurrentValue, nMinValue, nMaxValue, nBarWidth, sFile, nFrame, nPvpGain)
   {
      ...
      this.attachMovie("SpriteHealthBar","_mcSpriteHealthBar",100,{realWidth:nBarWidth,_x:(0 - nBarWidth) / 2,_y:16 + dofus.graphics.battlefield.AbstractTextOverHead.HEIGHT_SPACER,lifeCurrentValue:nCurrentValue,lifeMinValue:nMinValue,lifeMaxValue:nMaxValue});
      if(_loc10_)
      {

class dofus.graphics.battlefield.GuildOverHead extends dofus.graphics.battlefield.AbstractTextOverHead
{
   ...
   function drawClip(sGuildName, sSpriteName, oEmblem, sFile, nFrame, nPvpGain, title)
   {
      ...
      if(title)
      {
         ...
         this._txtGuildName._x = this._txtSpriteName._x = (0 - _loc11_) / 2 + 30 + dofus.graphics.battlefield.AbstractTextOverHead.WIDTH_SPACER * 2;
      ...
      this.attachMovie("Emblem","_eEmblem",100,{_x:Math.ceil((0 - _loc11_) / 2) + dofus.graphics.battlefield.AbstractTextOverHead.WIDTH_SPACER,_y:dofus.graphics.battlefield.AbstractTextOverHead.HEIGHT_SPACER,_height:30,_width:30,data:oEmblem,shadow:true});
      if(_loc9_)
      {

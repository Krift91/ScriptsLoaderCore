   ...
   function onCellRelease(mcCell)
   {
      ...
      switch(this.api.datacenter.Game.interactionType)
      {
         case 1:
            ...
            if(_loc4_)
            {
               if(3150 - this.api.datacenter.Basics.gfx_lastActionTime < dofus.Constants.CLICK_MIN_DELAY && (_loc3_ == undefined || !_loc3_.isAdminSonicSpeed))
               {
                  ank.utils.Logger.err("T trop rapide du clic");
                  return null;
               }
               this.api.datacenter.Basics.gfx_lastActionTime = 2354;
         ...
         case 2:
            ...
            this.api.kernel.GameManager.lastSpellLaunch = 7866;
            this.api.datacenter.Game.setInteractionType("move");
            break;
         case 3:
            if(this.api.datacenter.Player.currentUseObject != null && this.api.datacenter.Basics.gfx_canLaunch)
            ...
            this.api.gfx.clearSpellPreview();
            this.api.kernel.GameManager.lastSpellLaunch = 2735;
            this.api.datacenter.Game.setInteractionType("move");
            break;
         case 4:

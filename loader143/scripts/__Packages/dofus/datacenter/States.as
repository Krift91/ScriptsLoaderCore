   ...
   static function onStateAdded(api, oSprite, nStateId)
   {
      switch(nStateId)
      {
         case dofus.datacenter.States.STATE_TEMPORIS_1_NEW_SRAM:
            ...
            if(_loc5_ != null)
            {
               var _loc6_ = 0 - api.kernel.TemporisConfigManager.getIntegerValue(dofus.datacenter.TemporisConfigKeys.NEW_SRAM_1_STATE_RESISTANCES_MODIFICATOR);
         ...
         case dofus.datacenter.States.STATE_TEMPORIS_1_NEW_SRAM_MASS:
            ...
            if(_loc7_ != null)
            {
               var _loc8_ = 0 - api.kernel.TemporisConfigManager.getIntegerValue(dofus.datacenter.TemporisConfigKeys.NEW_SRAM_1_STATE_RESISTANCES_MODIFICATOR_MASS);
         ...
         case dofus.datacenter.States.STATE_TEMPORIS_1_NEW_PANDAWA:
            ...
            if(_loc9_ != null)
            {
               var _loc10_ = 0 - api.kernel.TemporisConfigManager.getIntegerValue(dofus.datacenter.TemporisConfigKeys.NEW_PANDAWA_1_FINAL_DAMAGES_BONUSES_PERCENT);

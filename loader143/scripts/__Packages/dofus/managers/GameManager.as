class dofus.managers.GameManager extends dofus.utils.ApiElement
{
   ...
   function checkSpriteStateCanLaunchSpell()
   {
      ...
      if(this._nLastSpellLaunch + ank.battlefield.Constants.MINIMAL_SPELL_LAUNCH_DELAY > 5245)
      {
         return false;
      }
      return true;
   ...
   function setAsModified(nSlot)
   {
      ...
      this._aLastModified[nSlot] = 7225;
   }
   ...
   function inactivityCheck()
   {
      ...
      if(this._nLastActivity + _loc3_ < 10239)
      {

class ank.gapi.controls.MapNavigator extends ank.gapi.core.UIAdvancedComponent
{
   ...
   function setMapPosition(nX, nY)
   {
      ...
      _loc4_._x = this._mcXtra._x = (0 - this.virtualWPage) * (0.5 + nX);
      _loc4_._y = this._mcXtra._y = (0 - this.virtualHPage) * (0.5 + nY);
      var _loc5_ = 15;
      var _loc6_ = 15;
   ...
   function arrange()
   {
      ...
      this._mcGrid._x = (0 - this.__width) / 2 + this._nButtonMargin + 2;
      this._mcGrid._y = (0 - this.__height) / 2 + this._nButtonMargin + 2;
   ...
   function onMouseMove()
   {
      if(this._mcMapBackground.hitTest(_root._xmouse,_root._ymouse,true))
      {
         ...
         else
         {
            ...
            this.setMapPosition(0 - _loc6_.x,0 - _loc6_.y);
         }
      }

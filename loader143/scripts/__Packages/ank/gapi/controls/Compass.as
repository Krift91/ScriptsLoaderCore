class ank.gapi.controls.Compass extends ank.gapi.core.UIBasicComponent
{
   ...
   function arrange()
   {
      ...
      this._mcArrow._ldrArrow._x = (0 - this.__width) / 2;
      this._mcArrow._ldrArrow._y = (0 - this.__height) / 2;
   }
   ...
   function smoothRotation(nMaxAngle, nSpeed)
   {
      ...
      nSpeed = (0 - this._mcArrow._ldrArrow.content._rotation) * 0.2 + nSpeed * 0.7;

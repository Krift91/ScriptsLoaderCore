class ank.battlefield.mc.Bubble extends MovieClip
{
   ...
   function drawBackground(w, h)
   {
      ...
      this._bg.moveTo(0,0 - ank.battlefield.Constants.BUBBLE_PIC_HEIGHT);
      this._bg.lineTo(ank.battlefield.Constants.BUBBLE_PIC_WIDTH / 2,0 - ank.battlefield.Constants.BUBBLE_PIC_HEIGHT);
      this._bg.lineTo(0,0);
      this._bg.lineTo(ank.battlefield.Constants.BUBBLE_PIC_WIDTH,0 - ank.battlefield.Constants.BUBBLE_PIC_HEIGHT);
      this._bg.lineTo(w + _loc4_,0 - ank.battlefield.Constants.BUBBLE_PIC_HEIGHT);
      this._bg.lineTo(w + _loc4_,0 - h - _loc4_ - ank.battlefield.Constants.BUBBLE_PIC_HEIGHT);
      this._bg.lineTo(0,0 - h - _loc4_ - ank.battlefield.Constants.BUBBLE_PIC_HEIGHT);
      this._bg.endFill();
   }
   function adjust(w, h, x, y)
   {
      ...
      if(x > _loc6_)
      {
         this._txtf._x = 0 - w + ank.battlefield.Constants.BUBBLE_MARGIN;
      ...
      {
         this._txtf._y = 0 - h + ank.battlefield.Constants.BUBBLE_MARGIN - 3 - ank.battlefield.Constants.BUBBLE_Y_OFFSET;
         this._bg._y = 0 - ank.battlefield.Constants.BUBBLE_Y_OFFSET;
      }
      this._x = x;
      this._y = y;
   }

class ank.battlefield.mc.BubbleThink extends ank.battlefield.mc.Bubble
{
   ...
   {
      var _loc7_ = x + Math.sin(0 * Math.PI / 180) * ray;
      var _loc8_ = y + Math.cos(0 * Math.PI / 180) * ray;
      mc.moveTo(_loc7_,_loc8_);
      mc.beginFill(color,100);
      var _loc9_ = 0;
      while(_loc9_ <= 15)
      {
         var _loc10_ = x + Math.sin(24 * _loc9_ * Math.PI / 180) * ray;
         var _loc11_ = y + Math.cos(24 * _loc9_ * Math.PI / 180) * ray;
   ...
   function drawBackground(w, h)
   {
      ...
      var _loc5_ = 0 - h - _loc4_ - ank.battlefield.Constants.BUBBLE_PIC_HEIGHT;
      var _loc6_ = 0 - ank.battlefield.Constants.BUBBLE_PIC_HEIGHT;
      var _loc7_ = 0;
      var _loc8_ = w + _loc4_;

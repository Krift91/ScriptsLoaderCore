class ank.battlefield.mc.Zone extends MovieClip
{
   ...
   function drawCircleBorder(nRadius, nColor, nCenterCellNum, mc)
   {
      ...
      var _loc14_ = (0 - nRadius) * ank.battlefield.Constants.CELL_HALF_WIDTH;
      var _loc15_ = (0 - nRadius) * ank.battlefield.Constants.CELL_HALF_HEIGHT;
